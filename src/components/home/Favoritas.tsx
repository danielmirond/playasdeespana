  ...
  return (
    <section className={styles.section}>
      <div className={styles.hd}>
        <span className={styles.hdTitle}><Heart size={14} weight="fill" color="var(--accent)" style={{verticalAlign:'middle',marginRight:4}}/> Mis favoritas</span>
              ...
              <Link href={`/playas/${p.slug}`} className={styles.cardLink}>
                ...
                {m && (
                  <div className={styles.datos}>
                    <span className={styles.dato}><Drop size={14} weight="bold" color="var(--accent)" style={{verticalAlign:'middle',marginRight:2}}/>{m.agua}°C</span>
