...
export default function HeroEn() {
  ...
  return (
    <section className={styles.hero}>
      ...
      <p className={styles.sub}>{m.subtitle}</p>
      ...
      <div className={styles.stats}>
        ...
        <div className={styles.stat}>
          ...
          <span className={styles.statL}>{m.stats.communities}</span>
        </div>
        <div className={styles.statDiv}/>
        <div className={styles.stat}>
          <span className={styles.statV}>1h</span>
          <span className={styles.statL}>{m.stats.update}</span>
        </div>
        <div className={styles.statDiv}/>
        <div className={styles.stat}>
          <span className={styles.statV}>∞</span>
          <span className={styles.statL}>{m.stats.free}</span>
        </div>
      </div>
    </section>
  )
