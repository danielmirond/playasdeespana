'use client'
import { Drop, MapPin, Waves } from '@phosphor-icons/react'
...
export default function Cercanas({ locale = 'es' }: Props) {
  ...
  if (estado === 'idle') return (
    <section className={styles.section}>
      <div className={styles.hd}>
        <span className={styles.hdTitle}><MapPin size={14} weight="bold" color="var(--accent)" style={{verticalAlign:'middle',marginRight:4}}/> Playas cercanas</span>
      </div>
  ...
  if (estado === 'loading') return (
    <section className={styles.section}>
      <div className={styles.hd}><span className={styles.hdTitle}><MapPin size={14} weight="bold" color="var(--accent)" style={{verticalAlign:'middle',marginRight:4}} aria-hidden="true"/> Playas cercanas</span></div>
  ...
  if (estado === 'denied') return (
    <section className={styles.section}>
      <div className={styles.hd}><span className={styles.hdTitle}><MapPin size={14} weight="bold" color="var(--accent)" style={{verticalAlign:'middle',marginRight:4}}/> Playas cercanas</span></div>
      <div className={styles.cta}>
              ...
              <div className={styles.cardBot}>
                {m ? (
                  <>
                    ...
                    <span className={styles.dato}><Drop size={14} weight="bold" color="var(--accent)" style={{verticalAlign:'middle',marginRight:2}}/>{m.agua}°</span>
                    <span className={styles.dato}><Waves size={14} weight="bold" color="var(--accent)" style={{verticalAlign:'middle',marginRight:2}}/>{m.olas}m</span>
                  </>
                ) : (
