...
export default function ParkingHoy({ playas, locale = 'es' }: Props) {
  ...
  const groups = [
    { key: 'facil', label: es ? 'Fácil aparcar' : 'Easy parking', color: 'var(--sea-buena)', playas: facil },
    { key: 'medio', label: es ? 'Parking disponible' : 'Parking available', color: 'var(--sea-aviso)', playas: medio },
    { key: 'dificil', label: es ? 'Difícil aparcar' : 'Hard to park', color: 'var(--sea-peligro)', playas: dificil },
