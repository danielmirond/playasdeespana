...
.boatCta{position:fixed;right:16px;bottom:calc(20px + env(safe-area-inset-bottom,0px));z-index:85;
 ...
 background:var(--mar-700);color:#fff;font-family:var(--font-sans);
...
.boatCta__sub{font-size:.72rem;line-height:1.3;color:var(--mar-300);margin:0 0 10px}
.boatCta__btn{display:inline-block;background:#fff;color:var(--mar-700);
...
.boatCta__close{flex-shrink:0;display:inline-flex;align-items:center;justify-content:center;
 ...
 background:rgba(255,255,255,.12);color:var(--mar-300);transition:color .15s ease,background .15s ease}
