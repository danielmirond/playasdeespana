      ...
      <main style={{ maxWidth: 750, margin: '0 auto', padding: '2rem 1.5rem 5rem' }}>
        ...
        <Section title="9. Más información">
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '.5rem', marginTop: '.5rem' }}>
            <Link href="/privacidad" style={{ display: 'inline-flex', padding: '.45rem .85rem', background: 'color-mix(in srgb, var(--accent) 14%, transparent)', color: 'var(--accent-2)', borderRadius: 100, fontSize: '.78rem', fontWeight: 600, textDecoration: 'none', border: '1px solid color-mix(in srgb, var(--accent) 30%, transparent)' }}>Política de privacidad →</Link>
