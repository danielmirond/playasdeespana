...
export const metadata: Metadata = { title: 'Accessible Beaches in Spain — PMR List', description: 'Beaches with wheelchair access, ramps, amphibious chairs and adapted facilities in Spain.', alternates: { canonical: '/en/accessible-beaches' } }
