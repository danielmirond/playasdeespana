  ...
  return (
    <main role="main" style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: '.75rem', flexWrap: 'wrap', justifyContent: 'center' }}>
        <button type="button" onClick={reset} aria-label="Retry loading town" style={{ background: '#6b400a', color: '#fff', border: 'none', borderRadius: '4px', padding: '.75rem 1.5rem', fontSize: '1rem', cursor: 'pointer', minHeight: '44px' }}>
          Retry
        </button>
