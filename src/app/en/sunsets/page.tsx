...
export const metadata: Metadata = { title: 'Best Sunset Beaches in Spain', description: 'West-facing beaches in Spain with the most beautiful sunsets. Atlantic coast, Galicia, Baleares, Canarias.', alternates: { canonical: '/en/sunsets', languages: {  'es': '/atardeceres', 'en': '/en/sunsets', 'x-default': '/atardeceres' } } }
