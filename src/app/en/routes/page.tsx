...
export const metadata: Metadata = { title: 'Beach Routes Along the Spanish Coast', description: 'Driving itineraries of the 5 best beaches on each coast of Spain with Google Maps link.', alternates: { canonical: '/en/routes', languages: {  'es': '/rutas', 'en': '/en/routes', 'x-default': '/rutas' } } }
