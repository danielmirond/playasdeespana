...
export const metadata: Metadata = { title: 'Surf Forecast Spain | Wave & Wind Conditions', description: 'Real-time surf forecast for Spain: wave height, period, wind and water temperature.', alternates: { canonical: '/en/surf', languages: {  'es': '/surf', 'en': '/en/surf', 'x-default': '/surf' } } }
export default async function Page() {
  ...
  return (<><Nav /><main style={{maxWidth:1000,margin:'0 auto',padding:'2rem 1.5rem 5rem'}}>
    ...
    {playas.length >= 6 && (
      <section aria-labelledby="top-surf-en" style={{marginBottom:'2rem'}}>
        <h2 id="top-surf-en" style={{fontFamily:'var(--font-serif)',fontSize:'1.45rem',fontWeight:700,color:'var(--ink)',marginBottom:'1rem'}}>Top 6 surf beaches</h2>
        <TopBeachCardsConHero
          ...
          limit={6}
          eyebrow={`Top 6 · ${playas.length} surf beaches in Spain`}
        />
      </section>
    )}
