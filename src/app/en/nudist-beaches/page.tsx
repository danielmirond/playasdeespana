...
export const metadata: Metadata = { title: 'Nudist Beaches in Spain | Complete List', description: 'Complete list of nudist and naturist beaches in Spain.', alternates: { canonical: '/en/nudist-beaches', languages: {  'es': '/playas-nudistas', 'en': '/en/nudist-beaches', 'x-default': '/playas-nudistas' } } }
...
export default async function Page() {
  ...
  return (<><Nav /><main style={{maxWidth:1000,margin:'0 auto',padding:'2rem 1.5rem 5rem'}}>
    ...
    {playas.filter(p => p.lat && p.lng).length >= 6 && (
      <section aria-labelledby="top-nud-en" style={{marginBottom:'2rem'}}>
        <h2 id="top-nud-en" style={{fontFamily:'var(--font-serif)',fontSize:'1.45rem',fontWeight:700,color:'var(--ink)',marginBottom:'1rem'}}>Top 6 nudist beaches</h2>
        <TopBeachCardsConHero
          ...
          limit={6}
          eyebrow={`Top 6 · ${playas.length} nudist beaches in Spain`}
        />
      </section>
    )}
