  ...
  return (
    <>
      ...
      <div className={styles.wrap}>
        {filtradas.length >= 6 && (
          <section aria-labelledby="top-com-acc" style={{ marginBottom: '2.5rem' }}>
            <h2 id="top-com-acc" className={styles.sectionTitle}>Top 6 playas accesibles en {comunidad.nombre}</h2>
            <TopBeachCardsConHero
              ...
              limit={6}
              eyebrow={`Top 6 · ${filtradas.length} playas accesibles en ${comunidad.nombre}`}
            />
          </section>
        )}
        {filtradas.length > 0 && (
