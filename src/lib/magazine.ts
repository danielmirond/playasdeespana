...
export const ARTICLES: Article[] = [
  // ───── Diario de playas · Villananitos, San Pedro del Pinatar (voz bicéfala) ─────
  {
    slug: 'playa-villananitos-san-pedro-pinatar-mar-menor-agua-somera-lodos',
    category: 'guias',
    title: 'Villananitos (Mar Menor): agua a 30°C, un metro de fondo y el aviso de la sopa verde',
    excerpt:
      'En San Pedro del Pinatar se camina sesenta metros mar adentro con el agua por la cintura y a casi 30°C en agosto, el baño más templado del litoral español. La pega es la laguna: desde 2016 arrastra episodios de eutrofización y mortandades, y su transparencia cambia de un año a otro.',
    heroAlt:
      'Playa de Villananitos, en San Pedro del Pinatar (Murcia): orilla de arena oscura del Mar Menor con agua muy somera y sin oleaje, bañistas de pie lejos de la orilla y las salinas al fondo',
    heroQuery: 'villananitos,san pedro del pinatar,mar menor,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-09-14T10:16:58Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'Desde el paseo de <strong>Lo Pagán</strong> la escena descoloca: hay gente de pie a sesenta metros de la orilla, con el agua por la cintura, charlando como quien espera el autobús. Nadie nada de verdad; se camina. Detrás, un cordón de salinas devuelve el cielo en rosa y blanco, y en los charcos rebuscan zancudas que no se inmutan por el paseante. No huele a mar abierto, huele a sal concentrada y a fango tibio, que es otra cosa.' },
      { t: 'p', html: 'Esto es <strong>Villananitos</strong>, una de las playas del <strong>Mar Menor</strong> en <strong>San Pedro del Pinatar</strong>, y conviene entenderlo antes de plantar la sombrilla: no es el Mediterráneo. Es una laguna separada del Mediterráneo por el cordón de arena de <strong>La Manga</strong>, unos veinte kilómetros de barrera que solo dejan pasar el agua por unos canales estrechos —las <strong>golas</strong>— en Marchamalo, El Estacio y Las Encañizadas. Una masa de agua encerrada, somera y caliente, con reglas propias. Todo lo bueno de este sitio y todo lo malo salen de esa misma frase.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'El Mar Menor ocupa unos <strong>135 km²</strong> y es la mayor laguna salada costera de Europa, pero lo que decide el baño no es la superficie: es el fondo. En su punto más hondo <strong>no llega a los siete metros</strong>, y la media anda por tres o cuatro; en la orilla de Villananitos hay que caminar un buen rato para que el agua pase de la cintura. De ahí sale su gran activo, que es térmico: un volumen de agua tan escaso y tan protegido se calienta como una bañera y en pleno verano ronda los <strong>30°C</strong>, el baño más templado que se puede dar en el litoral español. Históricamente también ha sido <strong>más salada que el Mediterráneo abierto</strong>, así que el cuerpo flota con menos esfuerzo. La otra cara de la misma moneda nadie la pone en el folleto: lo que se calienta rápido se enfría rápido, y en invierno esta laguna baja de temperatura mucho más que el mar de fuera.' },
      { t: 'p', html: 'Y ahora la letra pequeña, que aquí es grande. El Mar Menor lleva una década en estado crítico por <strong>eutrofización</strong>: los nitratos que bajan del <strong>Campo de Cartagena</strong> —agricultura intensiva de regadío— y que las ramblas empujan de golpe tras cada tromba disparan la producción de algas, el agua pierde transparencia y el oxígeno del fondo se desploma. El episodio de la llamada <strong>«sopa verde» de 2016</strong> fue el aviso; en <strong>octubre de 2019</strong>, tras la DANA de septiembre, y de nuevo en <strong>agosto de 2021</strong>, la falta de oxígeno provocó mortandades masivas de peces y crustáceos que aparecieron en la orilla a la vista de todo el mundo. La consecuencia práctica para quien va a bañarse es sencilla y honesta: <strong>la transparencia del agua cambia de un año a otro y de una semana a otra</strong>, y ninguna foto de archivo sirve para predecir cómo estará el día que vayas.' },
      { t: 'p', html: 'La respuesta institucional también es un dato, y de los grandes. La <strong>Ley 19/2022, de 30 de septiembre</strong>, reconoció <strong>personalidad jurídica</strong> a la laguna del Mar Menor y su cuenca: el primer ecosistema de Europa con derechos propios y con representantes legales que pueden actuar en su nombre ante los tribunales. Llegó por iniciativa legislativa popular, con más de medio millón de firmas detrás. En paralelo, el entorno inmediato de Villananitos está protegido como <strong>parque regional de las Salinas y Arenales de San Pedro del Pinatar</strong> y es <strong>humedal de importancia internacional</strong>, con flamencos y limícolas a pocos cientos de metros de la toalla. Añádase el resto de la letra pequeña estacional: el Mar Menor es zona de proliferación de medusas en verano —la <em>huevo frito</em>, inofensiva, y la <em>aguamala</em>, que sí molesta—, y por eso muchas de sus playas instalan <strong>redes antimedusas</strong> en temporada; conviene mirar si la del tramo elegido está puesta.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Con niños pequeños, pocos sitios de España compiten: hay decenas de metros de agua por la rodilla, sin oleaje, sin escalones ni resaca, y eso es un lujo objetivo que ninguna playa abierta puede ofrecer. <strong>Junio y septiembre</strong> son las fechas buenas —el agua sigue templada y el pueblo ha recuperado el tamaño normal— y la primera hora de la mañana es cuando la laguna está más quieta y mejor se ve el fondo. El paseo que une <strong>Lo Pagán</strong> con Villananitos permite llegar andando desde casi cualquier alojamiento, y al atardecer el plan que de verdad justifica el viaje no está en la arena sino detrás: los caminos de las salinas, con los flamencos recortados contra el rosa de las balsas.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> En los días siguientes a una tromba fuerte, sin discusión: es cuando las ramblas descargan en la laguna y cuando históricamente se han disparado los problemas. Tampoco si lo que se busca es refrescarse: <strong>el agua a 30°C no quita el calor</strong>, y en agosto a mediodía, con la orilla sin sombra natural, entrar en la laguna es cambiar de temperatura, no bajarla. <strong>El viento</strong> merece un párrafo propio: el Mar Menor es un clásico de la vela y del windsurf precisamente porque sopla con constancia, y en agua tan somera ese viento remueve el fondo limoso y deja el baño turbio aunque la laguna esté sana. Si el día viene ventoso, lo que se ve desde la orilla no dice nada del estado real del agua. <strong>La alternativa</strong> está a diez minutos, en el mismo municipio y al otro lado del cordón: la <strong>playa de La Llana</strong>, ya en mar abierto, con dunas, oleaje de verdad y agua que sí refresca —menos cómoda para el niño de tres años, mucho mejor para nadar—. Y un apunte de criterio sobre los célebres <strong>baños de lodo</strong> de las charcas de Lo Pagán: ese fango no es un recurso inagotable de balneario, sale del propio humedal protegido, así que lo sensato es no extraerlo ni acarrearlo, y aclararse bien después.' },
      { t: 'ul', items: [
        'Laguna de unos 135 km² y menos de siete metros en su punto más hondo: en Villananitos se camina sesenta metros con el agua por la cintura.',
        'Agua en torno a 30°C en pleno verano, el baño más templado del litoral español; en invierno, la misma escasez de fondo la enfría más que al mar abierto.',
        'Eutrofización por nitratos del Campo de Cartagena: «sopa verde» en 2016, mortandades por anoxia en octubre de 2019 y agosto de 2021.',
        'La Ley 19/2022 dio personalidad jurídica al Mar Menor: primer ecosistema de Europa con derechos propios.',
        'Medusas en verano y redes antimedusas en muchas playas; con viento, el fondo limoso se remueve y el agua se enturbia.',
        'Sin sombra natural en la orilla; la alternativa de mar abierto es La Llana, en el mismo municipio.',
      ] },
      { t: 'quote', text: 'Aquí no valen las «aguas cristalinas» del folleto: la transparencia del Mar Menor no la decide el verano, la decide lo que baja del Campo de Cartagena cuando llueve.' },
      { t: 'p', html: 'A última hora, cuando el sol se va por detrás de las salinas, la laguna se queda tan quieta que cuesta distinguir dónde acaba el agua y empieza el cielo, y las siluetas que siguen de pie mar adentro parecen suspendidas en mitad de nada. Se vuelve por el paseo con el pelo acartonado de sal y con una idea rara en la cabeza: que este charco enorme y tibio, en el que uno acaba de pasar la tarde haciendo pie, es desde hace cuatro años una figura con derechos reconocidos por ley. Ningún otro mar de España puede llevar a nadie a juicio. Este, si vuelve a ocurrir lo de 2021, sí.' },
    ],
    faq: [
      { q: '¿Se puede uno bañar en el Mar Menor en Villananitos?', a: 'Sí: el baño está permitido y la calidad del agua se controla durante toda la temporada, con los resultados accesibles en el sistema nacional de aguas de baño (NÁYADE) y en los portales de la Región de Murcia. Dicho esto, el estado de la laguna varía mucho de un año a otro y de una semana a otra por los episodios de eutrofización, así que lo razonable es mirar el parte de la temporada en curso en lugar de fiarse de fotos antiguas, y evitar los días posteriores a una lluvia torrencial, que es cuando las ramblas descargan nitratos en la laguna.' },
      { q: '¿Por qué el agua del Mar Menor está tan caliente?', a: 'Porque es una laguna cerrada y muy somera. Está separada del Mediterráneo por el cordón de La Manga y solo intercambia agua por unos canales estrechos, las golas, de modo que la masa de agua se renueva despacio. Con menos de siete metros de profundidad máxima y una media de tres o cuatro, el sol la calienta como una bañera y en pleno verano ronda los 30°C. El reverso es que en invierno se enfría bastante más que el mar abierto: poca profundidad significa mucha amplitud térmica en los dos sentidos.' },
      { q: '¿Es buena playa para ir con niños pequeños?', a: 'Es de las mejores de España en ese aspecto concreto. No hay oleaje, no hay resaca y no hay escalón: se camina decenas de metros con el agua por la rodilla, con un fondo de arena y limo sin piedras. Los dos matices honestos son que no hay sombra natural en la orilla, así que hace falta sombrilla y evitar las horas centrales, y que en verano pueden aparecer medusas —por eso muchas playas del Mar Menor colocan redes en temporada—; conviene comprobar si el tramo elegido tiene la red instalada.' },
    ],
    en: {
      title: 'Villananitos (Mar Menor): water at 30°C, a metre deep — and the green-soup warning',
      excerpt:
        'At San Pedro del Pinatar you can wade sixty metres out with the water at your waist and close to 30°C in August, the warmest bathing on the Spanish coast. The catch is the lagoon itself: eutrophication episodes since 2016 mean its clarity changes from one year to the next.',
      related: [
        { href: '/en/magazine', label: 'More from the Magazine' },
        { href: '/en/blue-flag', label: 'Blue Flag beaches in Spain' },
      ],
      body: [
        { t: 'p', html: 'From the promenade at <strong>Lo Pagán</strong> the scene takes a moment to parse: people are standing sixty metres offshore, water at their waists, chatting like commuters at a bus stop. Nobody is really swimming; they are walking. Behind them a belt of salt pans throws the sky back in pink and white, and long-legged birds work the shallows without so much as glancing at the passers-by. It does not smell of open sea. It smells of concentrated salt and warm mud, which is a different thing altogether.' },
        { t: 'p', html: 'This is <strong>Villananitos</strong>, one of the <strong>Mar Menor</strong> beaches at <strong>San Pedro del Pinatar</strong>, and it pays to understand it before the parasol goes up: this is not the Mediterranean. It is a lagoon cut off from the Mediterranean by the sand bar of <strong>La Manga</strong> — some twenty kilometres of barrier that lets water through only at a few narrow channels, the <em>golas</em>, at Marchamalo, El Estacio and Las Encañizadas. An enclosed body of water, shallow and hot, running on its own rules. Everything good about this place and everything wrong with it comes out of that single sentence.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'The Mar Menor covers around <strong>135 km²</strong> and is the largest coastal saltwater lagoon in Europe, but what decides your swim is not the surface area — it is the floor. At its deepest point it <strong>does not reach seven metres</strong>, and the average runs to three or four; on the shoreline at Villananitos you have to walk a good while before the water clears your waist. That is where its real asset comes from, and it is thermal: so little water, so well sheltered, heats like a bath and sits at roughly <strong>30°C</strong> at the height of summer — the warmest swim available anywhere on the Spanish coast. Historically it has also been <strong>saltier than the open Mediterranean</strong>, so the body floats with less effort. The flip side never makes the brochure: what heats quickly cools quickly, and in winter this lagoon drops well below the temperature of the sea outside.' },
        { t: 'p', html: 'Now the small print, which here is anything but small. The Mar Menor has spent a decade in a critical state through <strong>eutrophication</strong>: nitrates draining off the <strong>Campo de Cartagena</strong> — intensive irrigated farming — and flushed down the ramblas after every downpour drive algal growth, the water loses clarity and oxygen at the bottom collapses. The so-called <strong>«green soup» of 2016</strong> was the warning shot; in <strong>October 2019</strong>, after the September storms, and again in <strong>August 2021</strong>, oxygen loss caused mass die-offs of fish and crustaceans that washed up on the shoreline in full public view. The practical consequence for a bather is simple and worth saying plainly: <strong>the water’s clarity varies from year to year and week to week</strong>, and no stock photograph will tell you how it will look on the day you go.' },
        { t: 'p', html: 'The institutional response is a fact in its own right, and a remarkable one. <strong>Law 19/2022, of 30 September</strong>, granted <strong>legal personhood</strong> to the Mar Menor lagoon and its catchment: the first ecosystem in Europe with rights of its own and legal guardians able to act on its behalf in court. It arrived through a popular legislative initiative backed by more than half a million signatures. Alongside that, the ground immediately behind Villananitos is protected as the <strong>Salinas y Arenales de San Pedro del Pinatar regional park</strong> and listed as a <strong>wetland of international importance</strong>, with flamingos and waders a few hundred metres from your towel. Then the seasonal footnotes: the Mar Menor is prime jellyfish territory in summer — the harmless <em>fried egg</em> jellyfish and the barrel jellyfish, which does sting — which is why many of its beaches install <strong>jellyfish nets</strong> in season. Check whether the stretch you have picked has one.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> With small children, few places in Spain compete: tens of metres of knee-deep water, no swell, no shore break, no drop-off and no undertow — an objective luxury no open beach can offer. <strong>June and September</strong> are the windows to aim for: the water is still warm and the town has shrunk back to its normal size. First thing in the morning is when the lagoon is stillest and the bottom is easiest to see. The promenade linking <strong>Lo Pagán</strong> with Villananitos means you can walk in from almost any lodging, and at dusk the thing that really justifies the trip is not on the sand but behind it: the tracks through the salt pans, with flamingos cut out against the pink of the evaporation ponds.' },
        { t: 'p', html: '<strong>When not to?</strong> In the days after heavy rain, without argument: that is when the ramblas discharge into the lagoon, and when the trouble has historically started. Nor if what you want is to cool down — <strong>water at 30°C does not take the heat off</strong>, and at midday in August, with no natural shade on the shoreline, getting in changes your temperature rather than lowering it. <strong>Wind</strong> deserves its own paragraph: the Mar Menor is a sailing and windsurfing fixture precisely because it blows steadily here, and in water this shallow that wind stirs the silty bottom and leaves the swim murky even when the lagoon is in good health. On a windy day, what you see from the shore tells you nothing about the real state of the water. <strong>The alternative</strong> is ten minutes away, in the same municipality and on the far side of the bar: <strong>La Llana</strong>, open sea, dunes, proper swell and water that genuinely refreshes — less convenient with a three-year-old, far better for swimming. And a word of judgement on the celebrated <strong>mud baths</strong> in the pools at Lo Pagán: that mud is not a spa’s bottomless supply, it comes out of the protected wetland itself, so the sensible course is to leave it where it is and rinse off properly afterwards.' },
        { t: 'ul', items: [
          'A lagoon of roughly 135 km² and under seven metres at its deepest: at Villananitos you wade sixty metres with the water at your waist.',
          'Around 30°C at the height of summer, the warmest swim on the Spanish coast; in winter the same shallowness cools it below the open sea.',
          'Eutrophication from Campo de Cartagena nitrates: «green soup» in 2016, anoxic die-offs in October 2019 and August 2021.',
          'Law 19/2022 granted the Mar Menor legal personhood: the first ecosystem in Europe with rights of its own.',
          'Jellyfish in summer and nets on many beaches; in wind, the silty bottom is stirred up and the water turns murky.',
          'No natural shade on the shoreline; the open-sea alternative is La Llana, in the same municipality.',
        ] },
        { t: 'quote', text: 'Forget the brochure’s «crystal-clear water»: clarity in the Mar Menor is not decided by the summer, it is decided by what comes down off the Campo de Cartagena when it rains.' },
        { t: 'p', html: 'Late in the day, once the sun has gone behind the salt pans, the lagoon goes so still it is hard to tell where the water ends and the sky begins, and the figures still standing far out look suspended in the middle of nothing. You walk back along the promenade with your hair stiff with salt and an odd thought in your head: that this vast, tepid pool you have just spent an afternoon standing up in has, for four years now, been a legal person with rights recognised in statute. No other sea in Spain can take anyone to court. This one, if 2021 happens again, can.' },
      ],
      faq: [
        { q: 'Can you swim in the Mar Menor at Villananitos?', a: 'Yes: bathing is permitted and water quality is monitored throughout the season, with results published through Spain’s national bathing-water system (NÁYADE) and the Region of Murcia’s own portals. That said, the lagoon’s condition varies a great deal from year to year and week to week because of the eutrophication episodes, so the sensible approach is to check the current season’s readings rather than trust old photographs — and to avoid the days immediately after torrential rain, when the ramblas flush nitrates into the lagoon.' },
        { q: 'Why is the water in the Mar Menor so warm?', a: 'Because it is an enclosed, very shallow lagoon. It is cut off from the Mediterranean by the La Manga sand bar and exchanges water only through a few narrow channels, the golas, so it renews itself slowly. With a maximum depth of under seven metres and an average of three or four, the sun heats it like a bath and it sits around 30°C in high summer. The reverse is that it cools far more than the open sea in winter: shallow water means a wide temperature swing in both directions.' },
        { q: 'Is it a good beach for young children?', a: 'On that specific count it is among the best in Spain. There is no swell, no undertow and no drop-off: you walk out tens of metres in knee-deep water over a bottom of sand and silt, with no stones. The two honest caveats are that there is no natural shade on the shoreline, so you need a parasol and should avoid the middle of the day, and that jellyfish can appear in summer — which is why many Mar Menor beaches put nets up in season. Check whether the stretch you choose has one installed.' },
      ],
    },
  },
  // ───── Diario de playas · Caños de Meca, Barbate (voz bicéfala) ─────
  {
    slug: 'playa-canos-de-meca-barbate-manantiales-acantilado-marea',
    category: 'curiosidades',
    title: '¿Por qué se llama Caños de Meca? Manantiales en el acantilado y calas que borra la marea',
    excerpt:
      'Los «caños» son surgencias de agua dulce que rezuman por el acantilado de arenisca y caen sobre la arena, a un paso del cabo donde se libró Trafalgar en 1805. La pega: con marea alta buena parte de esas calas desaparece y el tramo bajo la pared se queda sin paso.',
    heroAlt:
      'Playa de los Caños de Meca, en Barbate (Cádiz): acantilado de arenisca con pinar encima, arena atlántica al pie y el faro de Trafalgar cerrando el horizonte al oeste',
    heroQuery: 'faro de trafalgar,canos de meca,barbate,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-09-10T09:41:39Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'El pinar de La Breña se termina de golpe en un borde de arenisca dorada y, cien metros más abajo, empieza la arena. Desde arriba, el litoral de <strong>Barbate</strong> se lee como una sucesión de entrantes al pie de la pared, con el <strong>faro de Trafalgar</strong> cerrando el horizonte por el oeste sobre una lengua de arena tan estrecha que parece provisional. Y abajo, en la base de la roca, hay un ruido que no viene del mar: un goteo constante, casi de grifo mal cerrado, que sale del propio acantilado.' },
      { t: 'p', html: 'Eso son los caños. De ahí el nombre —<strong>Caños de Meca</strong>— y de ahí también el malentendido: mucha gente llega buscando cascadas y lo que encuentra son surgencias que rezuman por la piedra, unas veces un hilo, otras un chorro, según lo que haya llovido el invierno anterior. El acuífero del pinar drena hacia el mar y encuentra salida justo donde la arenisca se corta a pico. Es <strong>agua dulce cayendo sobre arena atlántica</strong>, a poco más de un kilómetro del cabo frente al que, en octubre de 1805, se hundió media flota franco-española.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'El conjunto está protegido por partida doble. El <strong>tómbolo de Trafalgar</strong> —la lengua de arena que une el faro con tierra firme— está catalogado como <strong>Monumento Natural</strong> por la Junta de Andalucía, y el acantilado y el pinar que se extienden hacia Barbate forman el <strong>Parque Natural de La Breña y Marismas del Barbate</strong>, declarado en <strong>1989</strong>. Un tómbolo no es una playa cualquiera: es una barra de arena entre una isla y el continente, y solo existe mientras las corrientes la sigan alimentando; los temporales de poniente la remodelan cada invierno. Arriba, sobre el acantilado, el sendero del pinar lleva hasta la <strong>Torre del Tajo</strong>, torre almenara del siglo XVI plantada a un centenar de metros sobre el agua.' },
      { t: 'p', html: 'Y aquí llega lo que de verdad decide el día: <strong>la marea</strong>. Esto es el Atlántico, no el Mediterráneo. En el <strong>golfo de Cádiz</strong> la carrera de marea en mareas vivas ronda los dos o tres metros, con dos bajamares y dos pleamares cada día, y en una playa encajada al pie de un acantilado eso no es un matiz: es la diferencia entre tener doscientos metros de arena o no tener ninguno. Con la marea llena, los tramos bajo la pared —las calas del sector del faro, los recovecos donde mejor se ven los caños goteando— se reducen a nada y en algunos puntos el paso lateral se corta. Nadie lo avisa con un cartel luminoso: o se mira la tabla de mareas antes de salir de casa, o se improvisa mal.' },
      { t: 'p', html: 'El viento es el segundo mando. Con <strong>poniente</strong> entra oleaje de fuera y el agua se enturbia contra la arena; con <strong>levante</strong> el mar se queda más plano, pero sopla sin descanso y, si insiste varios días seguidos, el afloramiento de agua profunda <strong>baja la temperatura del mar</strong> de forma bien perceptible: la Costa de la Luz no da en agosto los registros templados del Mediterráneo, y hay días en los que el primer baño corta la respiración. Añádase la letra pequeña: el acantilado es de <strong>arenisca blanda</strong> y tiene tramos señalizados por <strong>riesgo de desprendimiento</strong> donde no conviene poner la toalla pegada a la pared; la vigilancia no cubre las calas del extremo; y el pueblo, con fama de refugio alternativo desde los años setenta, multiplica su población en la primera quincena de agosto hasta convertir el aparcamiento en la actividad principal de la jornada.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Con la marea bajando, siempre. El plan que funciona es entrar un par de horas antes de la bajamar y salir cuando el agua ya está girando: se camina por la orilla hacia el faro, se ven los caños rezumando en la base de la roca y se vuelve sin prisa por donde se vino, con arena de sobra todo el rato. <strong>Junio y septiembre</strong> superan a agosto por lo evidente —en septiembre el agua sigue templada de todo el verano y el pueblo vuelve a respirar— y las primeras horas de la mañana son las únicas en que aparcar no es un deporte de contacto. Para las horas centrales, la sombra buena no está en la arena: está arriba, en el pinar de La Breña, que además regala el mirador del acantilado.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Con pleamar y poniente a la vez, que es cuando la playa se encoge y el agua llega revuelta; con niños pequeños si el plan es el sector de calas bajo el acantilado, porque el margen de arena cambia bajo los pies en cuestión de una hora; y en el puente de agosto, salvo que la idea de las vacaciones incluya dar tres vueltas al pueblo buscando hueco. <strong>La alternativa</strong> está al oeste y a cinco minutos: <strong>Zahora</strong>, arenal abierto sin pared detrás, con espacio para todos y viento franco —ideal si el día viene de levante fuerte y lo que se busca es kilómetro de orilla, no cuevas—. Y si la marea ha ganado la partida, el plan B es de tierra: el sendero hasta la <strong>Torre del Tajo</strong>, que enseña desde arriba el mismo acantilado que abajo no se deja pisar.' },
      { t: 'ul', items: [
        'Los caños son surgencias de agua dulce del acuífero, no cascadas: llevan más caudal tras un invierno lluvioso.',
        'Marea atlántica de dos a tres metros en vivas: con pleamar, las calas bajo el acantilado se reducen o se cortan.',
        'Con levante persistente el agua se enfría por afloramiento; con poniente, entra oleaje y se enturbia.',
        'Acantilado de arenisca blanda con tramos señalizados por desprendimientos: toalla lejos de la pared.',
        'Sombra útil solo arriba, en el pinar de La Breña; abajo, ninguna. Aparcamiento crítico en agosto.',
      ] },
      { t: 'quote', text: 'Aquí el mar no manda: manda la tabla de mareas. La estampa del acantilado con la arena a sus pies dura unas horas, y luego se la lleva el Atlántico hasta la tarde siguiente.' },
      { t: 'p', html: 'A media tarde, cuando el agua empieza a retirarse otra vez, la arena vuelve a aparecer mojada y espejada y el acantilado se pone de color miel contra el sol bajo. La gente camina hacia el faro en fila suelta, parándose donde el goteo se oye mejor, y el olor a pino baja desde arriba y se mezcla con el del alga. Enfrente, sobre esa misma línea de agua, hace más de dos siglos ardió una batalla que cambió el mapa de Europa; hoy el único ruido serio es el de un hilo de agua dulce cayendo sobre la arena, puntual como un reloj y a merced de un horario que no lo escribe nadie del pueblo.' },
    ],
    faq: [
      { q: '¿Qué son exactamente los caños de Caños de Meca?', a: 'Son surgencias de agua dulce que brotan del propio acantilado. El acuífero del pinar de La Breña drena hacia el mar y encuentra salida donde la arenisca se corta a pico, así que el agua rezuma por la pared y cae sobre la arena. No son cascadas de gran caudal: unas veces es un hilo y otras un chorro, y depende directamente de lo que haya llovido el invierno anterior. Se ven mejor con la marea baja, cuando queda arena para acercarse a la base de la roca.' },
      { q: '¿Hay que mirar la marea antes de ir a Caños de Meca?', a: 'Sí, y es el consejo más útil de todos. En el golfo de Cádiz la carrera de marea en mareas vivas ronda los dos o tres metros y hay dos pleamares y dos bajamares al día. En una playa al pie de un acantilado eso cambia por completo el sitio: con marea baja quedan cientos de metros de arena firme para caminar hacia el faro de Trafalgar; con marea llena, los tramos bajo la pared se reducen y en algunos puntos el paso lateral se corta. Lo razonable es entrar con la marea bajando y salir cuando empieza a subir.' },
      { q: '¿El agua está fría en verano en Caños de Meca?', a: 'Está más fría que en el Mediterráneo, y con levante persistente puede bajar bastante. El viento de levante favorece el afloramiento de agua profunda en esta costa atlántica, así que hay días de julio y agosto en los que el primer baño corta la respiración. Con poniente el agua suele estar algo más templada, pero entra oleaje de fuera y se enturbia. Septiembre es de las mejores fechas: el mar guarda el calor acumulado del verano y el pueblo está mucho menos lleno.' },
    ],
    en: {
      title: 'Why Caños de Meca is called that: freshwater springs in the cliff, coves the tide erases',
      excerpt:
        'The «caños» are freshwater springs seeping out of the sandstone cliff and falling onto the sand, a short walk from the cape where Trafalgar was fought in 1805. The catch: at high tide much of that shoreline vanishes and the stretch under the cliff is cut off.',
      related: [
        { href: '/en/magazine', label: 'More from the Magazine' },
        { href: '/en/crystal-clear-water-beaches', label: 'Beaches with the clearest water' },
      ],
      body: [
        { t: 'p', html: 'The pine wood of La Breña stops dead at an edge of golden sandstone and, a hundred metres below, the sand begins. From up there the coast of <strong>Barbate</strong> reads as a run of inlets at the foot of the wall, with the <strong>Trafalgar lighthouse</strong> closing the horizon to the west on a spit of sand so narrow it looks temporary. And down at the base of the rock there is a sound that does not come from the sea: a steady drip, like a tap left half-closed, coming out of the cliff itself.' },
        { t: 'p', html: 'Those are the <em>caños</em>. Hence the name — <strong>Caños de Meca</strong> — and hence the misunderstanding: plenty of people arrive expecting waterfalls and find seepage instead, a trickle some years and a proper spout others, depending entirely on the previous winter’s rain. The aquifer under the pine wood drains seawards and finds its way out exactly where the sandstone is cut sheer. This is <strong>fresh water falling onto Atlantic sand</strong>, barely a kilometre from the cape off which half a Franco-Spanish fleet went down in October 1805.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'The area carries two layers of protection. The <strong>Trafalgar tombolo</strong> — the sand bar tying the lighthouse to the mainland — is listed as a <strong>Natural Monument</strong> by the Andalusian government, and the cliff and pine wood running towards Barbate make up the <strong>La Breña y Marismas del Barbate natural park</strong>, designated in <strong>1989</strong>. A tombolo is not an ordinary beach: it is a sand bar between an island and the shore, and it exists only as long as the currents keep feeding it; westerly storms reshape it every winter. Above the cliff, the woodland path leads to the <strong>Torre del Tajo</strong>, a 16th-century watchtower set a hundred metres above the water.' },
        { t: 'p', html: 'And now what actually decides your day: <strong>the tide</strong>. This is the Atlantic, not the Mediterranean. In the <strong>Gulf of Cádiz</strong> the spring tidal range runs to two or three metres, with two low waters and two high waters a day, and on a beach wedged under a cliff that is not a detail — it is the difference between two hundred metres of sand and none at all. At high water the sections beneath the wall — the coves towards the lighthouse, the recesses where the springs are best seen — shrink to nothing, and in places the way along the shore closes altogether. Nothing warns you: you either check the tide table before leaving or you improvise badly.' },
        { t: 'p', html: 'Wind is the second control. A <strong>westerly</strong> brings in swell from offshore and clouds the water; an <strong>easterly</strong> — the <em>levante</em> — flattens the sea but blows relentlessly, and if it settles in for several days the resulting upwelling <strong>drops the sea temperature</strong> noticeably: the Costa de la Luz does not deliver Mediterranean readings in August, and there are days when the first swim takes your breath away. Then the small print: the cliff is <strong>soft sandstone</strong>, with sections signed for <strong>rockfall risk</strong> where laying your towel against the wall is a poor idea; supervision does not reach the far coves; and the village, an alternative bolthole since the 1970s, multiplies its population in the first half of August until parking becomes the day’s main activity.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> On a falling tide, always. The plan that works is arriving a couple of hours before low water and leaving once it turns: you walk the shoreline towards the lighthouse, watch the springs seeping at the base of the rock, and stroll back the way you came with sand underfoot the whole time. <strong>June and September</strong> beat August for obvious reasons — in September the sea is still holding the summer’s warmth and the village breathes again — and early morning is the only window in which parking is not a contact sport. For the middle of the day, the useful shade is not on the sand but up in the La Breña pine wood, which throws in the clifftop viewpoint as well.' },
        { t: 'p', html: '<strong>When not to?</strong> High water and a westerly together, which is when the beach shrinks and the water arrives churned up; with small children if the plan involves the coves under the cliff, since the margin of sand changes underfoot within the hour; and in the peak August week, unless the holiday idea includes three laps of the village hunting for a space. <strong>The alternative</strong> is five minutes west: <strong>Zahora</strong>, an open strand with no wall behind it, room for everyone and clean wind — the right call on a hard <em>levante</em> day if what you want is a long shoreline rather than caves. And if the tide has won, the fallback is inland: the path to the <strong>Torre del Tajo</strong>, which shows you from above the same cliff you cannot walk beneath.' },
        { t: 'ul', items: [
          'The caños are freshwater seepage from the aquifer, not waterfalls: stronger after a wet winter.',
          'Atlantic range of two to three metres on springs: at high water the coves under the cliff shrink or close.',
          'A settled easterly cools the sea through upwelling; a westerly brings swell and murky water.',
          'Soft sandstone cliff with signed rockfall sections: keep the towel away from the wall.',
          'Real shade only up in the La Breña pine wood; none on the sand. Parking is critical in August.',
        ] },
        { t: 'quote', text: 'The sea is not in charge here — the tide table is. The picture of the cliff with sand at its feet lasts a few hours, then the Atlantic takes it back until the following afternoon.' },
        { t: 'p', html: 'By mid-afternoon, as the water pulls back again, the sand returns wet and mirrored and the cliff turns honey-coloured against the low sun. People walk towards the lighthouse in a loose line, stopping where the dripping is loudest, and the smell of pine comes down from above and mixes with the weed on the tideline. Out on that same stretch of water, more than two centuries ago, a battle burned that redrew the map of Europe. Today the only serious noise is a thread of fresh water falling onto sand, punctual as a clock and ruled by a timetable nobody in the village gets to write.' },
      ],
      faq: [
        { q: 'What exactly are the caños at Caños de Meca?', a: 'They are freshwater springs emerging from the cliff itself. The aquifer beneath the La Breña pine wood drains towards the sea and finds its way out where the sandstone is cut sheer, so the water seeps through the wall and falls onto the sand. They are not high-volume waterfalls: sometimes a trickle, sometimes a spout, depending directly on the previous winter’s rainfall. They are easiest to see at low tide, when there is sand enough to walk up to the base of the rock.' },
        { q: 'Do I need to check the tide before going to Caños de Meca?', a: 'Yes, and it is the single most useful piece of advice. In the Gulf of Cádiz the spring tidal range is around two to three metres, with two high and two low waters a day. On a beach at the foot of a cliff that changes the place completely: at low water there are hundreds of metres of firm sand to walk towards the Trafalgar lighthouse; at high water the sections under the wall shrink and in places the way along the shore closes. The sensible approach is to arrive on a falling tide and leave as it starts to rise.' },
        { q: 'Is the water cold in summer at Caños de Meca?', a: 'Colder than the Mediterranean, and a settled easterly can bring it down sharply. The levante drives upwelling of deeper water along this Atlantic coast, so there are July and August days when the first swim takes your breath away. With a westerly the water tends to be a little warmer, but swell comes in from offshore and it turns murky. September is one of the best windows: the sea still holds the accumulated warmth of the summer and the village is far quieter.' },
      ],
    },
  },
  // ───── Diario de playas · Ribamar, Serra d'Irta (voz bicéfala) ─────
  {
    slug: 'playa-de-ribamar-alcossebre-castellon-guijarros-parque-irta',
    category: 'rutas',
    title: 'Guijarros, no arena: Ribamar (Alcossebre), la playa sin urbanizar del parque de Irta',
    excerpt:
      'Entre Alcossebre y Peñíscola queda el único tramo de costa de Castellón sin un solo edificio, protegido como parque natural desde 2002. La pega: Ribamar es de canto rodado, no tiene sombra ni chiringuito y el último tramo de acceso se hace por camino.',
    heroAlt:
      'Playa de Ribamar, en Alcalà de Xivert (Castellón): orilla de canto rodado dentro del parque natural de la Serra d’Irta, con la sierra de matorral bajando hasta el mar',
    heroQuery: 'ribamar,alcossebre,castellon,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-08-24T15:29:46Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'Se acaban los bloques de Alcossebre, se acaba el paseo marítimo, se acaban las farolas, y de pronto la carretera se estrecha y empieza a subir entre pinos carrascos y matas de palmito. Durante los siguientes kilómetros no aparece nada: ni una urbanización, ni una grúa, ni un cartel de promoción inmobiliaria. Solo la <strong>Serra d’Irta</strong> cayendo hacia el mar en lomas de monte bajo, alguna torre vigía del siglo XVI recortada contra el cielo y, abajo, una franja de piedras redondas donde rompe el Mediterráneo.' },
      { t: 'p', html: 'Esa franja es la <strong>playa de Ribamar</strong>, en el término de <strong>Alcalà de Xivert</strong> (Castellón). Quien llegue esperando el arenal familiar de la Costa del Azahar se va a llevar un chasco inmediato: aquí no hay arena. Hay guijarro, canto rodado que cruje al pisarlo y que a mediodía quema. También hay algo que en esta costa se ha vuelto rarísimo: <strong>doce kilómetros largos de litoral sin urbanizar</strong> entre Alcossebre y Peñíscola, lo que queda del Mediterráneo antes del ladrillo.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'La <strong>Serra d’Irta</strong> fue declarada <strong>parque natural en 2002</strong> por la Generalitat Valenciana, junto con una <strong>reserva marina</strong> que protege la franja de mar contigua. Esa doble figura es la razón de todo lo que se ve —y de todo lo que no se ve— desde Ribamar: la sierra llega al agua sin urbanizar porque la protección frenó los planes que ya se dibujaban en el litoral de Alcalà de Xivert. En el monte crece el <strong>palmito</strong>, la única palmera silvestre de la península, y por la costa pasa el <strong>GR-92</strong>, el sendero que recorre el Mediterráneo español y que aquí une cala con cala a pie.' },
      { t: 'p', html: 'El patrimonio de alrededor tampoco es decorado: la <strong>Torre Ebrí</strong>, del siglo XVI, formaba parte del sistema de vigilancia contra la piratería berberisca, y sierra adentro está el <strong>castillo de Xivert</strong>, fortaleza de origen andalusí que la Orden del Temple reconstruyó tras la conquista. Todo eso se ve desde la orilla o desde el camino, sin entrada ni horario.' },
      { t: 'p', html: 'Ahora la letra pequeña. <strong>No es una playa de arena y no lo va a ser</strong>: entrar al agua sin escarpines es un ejercicio de equilibrio, y la orilla de canto pierde pie antes que un arenal, así que el fondo baja rápido a pocos metros. <strong>No hay sombra</strong> en la orilla —el pino y el palmito se quedan arriba, en la ladera— ni chiringuito, ni duchas, ni papeleras: lo que se trae, se lleva. <strong>Tampoco hay socorrista</strong>. Y hay un detalle que sorprende a quien mira las listas: <strong>Ribamar no tiene bandera azul</strong>, pero eso no dice nada de su agua. El distintivo de <strong>ADEAC</strong> exige servicios, vigilancia, accesibilidad y equipamiento; una playa de parque natural sin nada de eso <em>no puede optar</em> por definición. Lo mismo pasa con los análisis: la red oficial de aguas de baño controla los puntos con uso declarado, y las calas del parque suelen quedar fuera de ese muestreo. Ausencia de dato no es mala nota, pero conviene saber que aquí uno se baña sin boletín y sin nadie mirando.' },
      { t: 'p', html: 'Sumemos lo que estropea el día: con <strong>levante</strong> entra oleaje corto y sucio contra la piedra, y el agua se enturbia; con la brisa de la tarde, el mar se riza y el fondo pierde la visibilidad que hace interesante el <strong>snorkel</strong> sobre las praderas de <strong>posidonia</strong> de la reserva. Y el aparcamiento es una explanada de tierra de capacidad ridícula para un fin de semana de agosto.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Con mar en calma y de mañana temprano, que es cuando el agua está transparente sobre la posidonia y el sol todavía no ha convertido la piedra en una plancha. Mayo, junio y sobre todo <strong>septiembre y octubre</strong> son la temporada real de este sitio: el mar sigue templado, el aparcamiento existe y el camino no se convierte en una fila de coches maniobrando. El truco de quien viene mucho es no quedarse en la primera piedra: desde Ribamar salen tramos del sendero litoral hacia el norte y el sur —la <strong>playa del Pebret</strong>, las calas bajo la Torre Ebrí— y en veinte minutos andando se pasa de compartir orilla a estar solo. Escarpines o cangrejeras, sombrilla propia con algo para clavarla en la piedra, agua de sobra y neopreno fino si el plan es bucear un rato: en canto rodado, tumbarse sin colchoneta es penitencia.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Con niños pequeños que quieran castillos y orilla mansa —esto es lo contrario—, con levante anunciado, en pleno mediodía de agosto o si la idea del día incluye cerveza fría a diez metros de la toalla. <strong>La alternativa</strong> está a un cuarto de hora: las playas urbanas de <strong>Alcossebre</strong> (Romana, El Carregador, Las Fuentes) tienen arena, servicios, socorrista y bandera azul en varias de ellas; y hacia el norte, Peñíscola ofrece el arenal grande con toda la infraestructura. Ribamar no compite con eso: compite con la idea de que en esta costa ya no queda nada sin construir.' },
      { t: 'ul', items: [
        'Canto rodado en toda la orilla: escarpines, y el fondo baja pronto.',
        'Sin sombra, sin bar, sin duchas y sin socorrista; lo que entra, sale contigo.',
        'Sin bandera azul porque no hay servicios que certificar, no por la calidad del agua.',
        'Mejor con mar en calma y de mañana; con levante, el agua se enturbia contra la piedra.',
        'El sendero litoral (GR-92) enlaza calas: veinte minutos andando cambian por completo el aforo.',
      ] },
      { t: 'quote', text: 'La costa sin urbanizar de Castellón no es un premio del paisaje: es lo que queda cuando alguien firmó a tiempo un decreto de protección.' },
      { t: 'p', html: 'A última hora de la tarde la sierra se pone por delante del sol y la playa entra en sombra de golpe, media hora antes que el resto de la costa. El agua se queda quieta, la piedra devuelve el calor del día y el ruido de fondo pasa a ser el de la resaca arrastrando guijarros, ese sonido de cascada seca que no hace ninguna playa de arena. Enfrente no hay una sola luz encendida en kilómetros de costa, solo la silueta de la torre y, muy al norte, el resplandor lejano de Peñíscola recordando lo que este tramo pudo llegar a ser.' },
    ],
    faq: [
      { q: '¿La playa de Ribamar es de arena?', a: 'No. Es de canto rodado y grava en toda su orilla, como casi todo el litoral del parque natural de la Serra d’Irta. Conviene llevar escarpines o cangrejeras para entrar al agua y algún tipo de colchoneta o esterilla gruesa: tumbarse directamente sobre la piedra es incómodo y a mediodía quema. El fondo también pierde pie antes que en un arenal, así que cubre a pocos metros de la orilla.' },
      { q: '¿Por qué Ribamar no tiene bandera azul si el entorno está protegido?', a: 'Porque la bandera azul de ADEAC no mide solo la calidad del agua: exige servicios, socorrismo, accesibilidad, limpieza y equipamiento. Una playa dentro de un parque natural, sin duchas, sin bar y sin vigilancia, no puede optar al distintivo por definición. Que no aparezca en la lista no es un demérito de su agua; sencillamente juega en otra categoría, la de playa natural sin urbanizar.' },
      { q: '¿Cuál es la mejor época y qué hay cerca para caminar?', a: 'Mayo, junio, septiembre y octubre, con mar en calma y a primera hora: el agua está clara sobre las praderas de posidonia de la reserva marina y el aparcamiento de tierra, que es pequeño, todavía tiene sitio. Desde Ribamar salen tramos del GR-92 por el litoral del parque hacia la playa del Pebret y las calas bajo la Torre Ebrí, torre vigía del siglo XVI; sierra adentro está el castillo de Xivert, de origen andalusí y reconstruido por los templarios.' },
    ],
    en: {
      title: 'Pebbles, not sand: Ribamar (Alcossebre), the undeveloped beach in Irta natural park',
      excerpt:
        'Between Alcossebre and Peñíscola lies the only stretch of the Castellón coast without a single building, protected as a natural park since 2002. The catch: Ribamar is shingle, there is no shade and no beach bar, and the last stretch of the approach is an unmade track.',
      related: [
        { href: '/en/magazine', label: 'More from the Magazine' },
        { href: '/en/crystal-clear-water-beaches', label: 'Beaches with the clearest water' },
      ],
      body: [
        { t: 'p', html: 'The apartment blocks of Alcossebre run out, then the promenade, then the street lights, and the road narrows and climbs through Aleppo pines and clumps of dwarf fan palm. For the next few kilometres nothing appears: no development, no crane, no billboard advertising flats off-plan. Only the <strong>Serra d’Irta</strong> dropping to the sea in low scrubby ridges, the odd 16th-century watchtower against the sky and, below, a band of round stones where the Mediterranean breaks.' },
        { t: 'p', html: 'That band is the <strong>playa de Ribamar</strong>, in the municipality of <strong>Alcalà de Xivert</strong>, Castellón. Anyone arriving in search of the usual family strand of the Costa del Azahar will be disappointed within seconds: there is no sand here. There is shingle — rounded pebbles that shift underfoot and, by midday, burn. There is also something that has become genuinely rare along this coast: <strong>a good twelve kilometres of undeveloped shoreline</strong> between Alcossebre and Peñíscola, what is left of the Mediterranean before the concrete.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'The <strong>Serra d’Irta</strong> was declared a <strong>natural park in 2002</strong> by the Valencian government, together with a <strong>marine reserve</strong> covering the water alongside it. That double designation explains everything you can see from Ribamar — and everything you cannot: the range reaches the water unbuilt because protection stopped the schemes already being drawn up for this stretch of coast. The scrub is full of <strong>dwarf fan palm</strong>, the only palm native to mainland Spain, and the <strong>GR-92</strong>, the long-distance path along the Spanish Mediterranean, threads the coast here, linking cove to cove on foot.' },
        { t: 'p', html: 'The heritage nearby is not set dressing either: the 16th-century <strong>Torre Ebrí</strong> was part of the lookout system against Barbary raiders, and inland stands the <strong>castle of Xivert</strong>, an Andalusi fortress rebuilt by the Knights Templar after the conquest. All of it is visible from the shore or the path, with no ticket and no opening hours.' },
        { t: 'p', html: 'Now the small print. <strong>This is not a sandy beach and never will be</strong>: getting into the water without swim shoes is a balancing act, and a shingle shore drops away faster than a sandy one, so it is out of your depth within a few metres. <strong>There is no shade</strong> at the waterline — the pines and palms stay up on the slope — and no beach bar, no showers, no bins: whatever you bring, you carry out. <strong>There is no lifeguard</strong>. And here is the detail that puzzles people scanning the lists: <strong>Ribamar has no Blue Flag</strong>, which says nothing at all about its water. The <strong>ADEAC</strong> award requires facilities, supervision, accessibility and equipment; a beach inside a natural park with none of those cannot qualify by definition. The same goes for testing: the official bathing-water network samples designated bathing points, and the park’s coves typically fall outside it. Absence of data is not a bad grade, but it is worth knowing that you swim here without a bulletin and without anyone watching.' },
        { t: 'p', html: 'Add what spoils a day. An easterly, the <strong>levante</strong>, pushes short, dirty waves against the stone and clouds the water; the afternoon sea breeze ripples the surface and takes away the visibility that makes <strong>snorkelling</strong> over the reserve’s <strong>Posidonia</strong> meadows worthwhile. And the car park is a patch of bare earth with a capacity that is frankly absurd for an August weekend.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> On a calm sea, early: that is when the water is clear over the Posidonia and the sun has not yet turned the shingle into a hotplate. May, June and above all <strong>September and October</strong> are this place’s real season — the sea is still warm, the car park exists, and the track is not a queue of cars reversing past each other. The trick regulars use is not to stop at the first stone: sections of the coastal path run north and south from Ribamar — the <strong>playa del Pebret</strong>, the coves below the Torre Ebrí — and twenty minutes on foot turns a shared shoreline into an empty one. Swim shoes, your own parasol with something to wedge it into the stones, more water than you think, and a thin wetsuit if the plan involves a long snorkel: on shingle, lying down without a mat is penance.' },
        { t: 'p', html: '<strong>When not to?</strong> With small children who want sandcastles and a gentle shoreline — this is the opposite — with a levante forecast, in the middle of an August afternoon, or if the day’s plan involves a cold beer ten metres from the towel. <strong>The alternative</strong> is a quarter of an hour away: the town beaches of <strong>Alcossebre</strong> (Romana, El Carregador, Las Fuentes) have sand, facilities, lifeguards and Blue Flags on several of them, and Peñíscola to the north offers the big strand with the full infrastructure. Ribamar does not compete with that. It competes with the assumption that nothing on this coast was left unbuilt.' },
        { t: 'ul', items: [
          'Shingle all along the shore: bring swim shoes, and expect the bottom to drop away quickly.',
          'No shade, no bar, no showers, no lifeguard; everything you bring leaves with you.',
          'No Blue Flag because there are no facilities to certify — not because of the water.',
          'Best on a calm sea and early; a levante clouds the water against the stones.',
          'The coastal GR-92 links the coves: twenty minutes on foot changes the crowd entirely.',
        ] },
        { t: 'quote', text: 'The undeveloped coast of Castellón is not a gift of the landscape: it is what survives because somebody signed a protection order in time.' },
        { t: 'p', html: 'Late in the day the ridge moves in front of the sun and the beach falls into shadow all at once, half an hour before the rest of the coast. The water goes still, the stones give back the day’s heat, and the background noise becomes the backwash dragging pebbles down the slope — that dry-waterfall sound no sandy beach ever makes. Opposite, not one light is on across kilometres of shoreline, only the outline of the tower and, far to the north, the distant glow of Peñíscola as a reminder of what this stretch might have become.' },
      ],
      faq: [
        { q: 'Is Ribamar a sandy beach?', a: 'No. It is shingle and coarse gravel along its whole shoreline, like most of the coast inside the Serra d’Irta natural park. Bring swim shoes to get into the water and a thick mat or lilo to lie on: bare pebbles are uncomfortable and burn by midday. The bottom also shelves more steeply than on a sandy beach, so it is out of your depth within a few metres of the shore.' },
        { q: 'Why does Ribamar have no Blue Flag if the area is protected?', a: 'Because ADEAC’s Blue Flag does not measure water quality alone: it requires facilities, lifeguards, accessibility, cleaning services and equipment. A beach inside a natural park with no showers, no bar and no supervision cannot qualify by definition. Its absence from the list is not a mark against the water; it simply belongs to a different category — undeveloped natural beach.' },
        { q: 'When is the best time to go, and what is nearby to walk?', a: 'May, June, September and October, on a calm sea and first thing: the water is clear over the marine reserve’s Posidonia meadows and the small dirt car park still has space. Sections of the GR-92 coastal path run from Ribamar towards the playa del Pebret and the coves below the Torre Ebrí, a 16th-century watchtower; inland stands the castle of Xivert, Andalusi in origin and rebuilt by the Templars.' },
      ],
    },
  },
  // ───── Diario de playas · Praia de Carnota (voz bicéfala) ─────
  {
    slug: 'praia-de-carnota-a-coruna-siete-kilometros-marea-nordes',
    category: 'guias',
    title: 'Carnota (A Coruña): 7 km de arena, la marea descubre un llano enorme y sopla el nordés',
    excerpt:
      'La playa más larga de Galicia deja al descubierto cientos de metros de arena firme cuando baja la marea, con el Monte Pindo detrás y una marisma protegida al lado. La contrapartida: viento del nordeste casi todas las tardes de verano, agua fría y socorristas solo en un par de accesos.',
    heroAlt:
      'Praia de Carnota, A Coruña: arenal larguísimo de la Costa da Morte con el Monte Pindo de granito al fondo y la marisma tras el cordón de dunas',
    heroQuery: 'praia de carnota,carnota,a coruna,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-08-12T12:50:32Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'Hay un momento, bajando desde la carretera hacia el arenal, en que la escala del sitio deja de tener sentido. La arena sigue hacia el sur sin interrupción, la línea del agua se ha ido tan lejos que cuesta calcular cuánto hay que andar, y por encima de todo se levanta una mole de granito redondeado, el <strong>Monte Pindo</strong>, que los románticos gallegos bautizaron como olimpo celta y que aquí funciona simplemente como referencia: mires donde mires, está ahí. Detrás del cordón de dunas no hay paseo marítimo ni bloques, sino una marisma con juncos y garzas.' },
      { t: 'p', html: 'Es la <strong>praia de Carnota</strong>, en la <strong>Costa da Morte</strong>, y la primera impresión que produce no es de playa sino de estuario. Cuando la marea está baja, el agua queda a varios centenares de metros del cordón dunar y entre medias queda un llano de arena firme, brillante, con canales de agua dulce que bajan de los montes y se pierden hacia el mar. La gente camina por ahí a la altura de los tobillos como si fuera lo normal. Y a media tarde, sin avisar, empieza a soplar el nordeste.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Carnota está en el municipio del mismo nombre, en la provincia de <strong>A Coruña</strong>, entre Muros y Fisterra, y se cita habitualmente como <strong>la playa más larga de Galicia</strong>: en torno a <strong>siete kilómetros</strong> de arena continua si se cuenta el arenal completo hasta la desembocadura de la marisma, unos cuatro y medio si se mide solo el tramo principal. Lo importante no es la cifra exacta sino lo que implica: aquí no hay una playa, hay <strong>un sistema</strong>. Cordón de dunas móviles, marisma trasera, esteros que desaguan en la arena y un tramo de costa incluido en la <strong>Red Natura 2000</strong> junto al Monte Pindo, con protección específica para el conjunto dunar. Por eso hay pasarelas de madera y cuerdas: la duna que se pisa se pierde, y aquí es la que sostiene la marisma.' },
      { t: 'p', html: 'A cinco minutos en coche, junto a la iglesia de <strong>Santa Comba</strong>, está el <strong>hórreo de Carnota</strong>, del siglo XVIII y con casi <strong>35 metros de largo</strong>: uno de los más largos de Galicia, construido cuando el maíz americano llegó al agro gallego y hubo que secar cosechas enteras. Vale como termómetro del sitio: esto es una comarca agrícola y marinera con una playa gigante al lado, no un destino de playa con pueblo detrás.' },
      { t: 'p', html: 'Y ahora lo que conviene saber antes de conducir hasta aquí. <strong>El agua está fría</strong>: es Atlántico abierto de la Costa da Morte, y en pleno agosto el baño largo es cosa de neopreno o de mucha convicción. <strong>El viento manda</strong>: la <strong>nortada</strong> o nordés es un patrón dominante del verano gallego y suele arreciar por la tarde, así que la toalla que a las once estaba perfecta a las cinco es un chorro de arena a media pierna. <strong>Sombra natural no hay</strong> —el pinar queda atrás, no en la arena— y <strong>los servicios están concentrados en un par de accesos</strong>: el resto del arenal, que es la mayor parte, no tiene socorrista, ni bar, ni papelera. Con mar de fondo se forman corrientes de retorno en los canales que se abren en la orilla, el fenómeno que en Galicia se lleva por delante a bañistas cada verano; si hay bandera y hay socorrista, se hace caso, y si no hay ninguna de las dos cosas, se entra con más cabeza todavía. Súmese que la marea baja aleja el agua tanto que la vuelta al coche con niños cansados es una caminata real, no un paseo.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Por la mañana, antes de que entre el nordés, y con la marea subiendo: es cuando el agua se acerca, se templa un poco sobre la arena caliente del llano y el baño deja de ser una expedición. Para caminar, en cambio, lo bueno es justo lo contrario, la <strong>marea baja</strong>, porque descubre el arenal entero y se puede recorrer kilómetros con el Pindo de frente y sin cruzarse con nadie. El truco de quien viene mucho es no quedarse en el primer aparcamiento: los accesos del norte concentran a casi todo el mundo, y basta con seguir unos cientos de metros hacia el sur para tener la arena vacía. Se agradecen cortavientos, sudadera para la caída de la tarde y calzado para las pasarelas.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Con temporal o mar de fondo anunciado, con niños pequeños que quieran bañarse a sus anchas sin vigilancia, o esperando servicios de playa urbana. Tampoco es el sitio para un día de sombrilla y siesta: aquí la sombrilla vuela. <strong>La alternativa</strong> está a un cuarto de hora: la <strong>praia de Lariño</strong>, más recogida y con menos rompiente, o los arenales interiores de la ría de Muros y Noia si lo que se busca es agua tranquila y un chiringuito cerca. Carnota se visita por el paisaje y por la caminata; el baño cómodo se busca en otra parte.' },
      { t: 'ul', items: [
        'Marea baja para andar el arenal; marea subiendo para bañarse.',
        'Cortavientos y algo de manga larga: el nordés entra por la tarde casi a diario.',
        'Socorrista y servicios solo en un par de accesos; el resto del arenal está solo.',
        'Por las pasarelas, siempre: la duna que se pisa desaparece y aquí sostiene la marisma.',
        'A cinco minutos, el hórreo de Carnota, de casi 35 metros y del siglo XVIII.',
      ] },
      { t: 'quote', text: 'La playa más larga de Galicia no se mide en metros de arena, sino en minutos andando hasta el agua cuando baja la marea.' },
      { t: 'p', html: 'Al final de la tarde el viento afloja de golpe, como si alguien cerrara una puerta. El llano mojado se queda liso y devuelve el cielo entero, los canales de agua dulce dibujan sus ramas sobre la arena y el granito del Pindo pasa del gris al naranja en cuestión de minutos. Entonces aparecen los que llevaban todo el día esperando: dos personas con un perro, alguien buscando navajas, un par de surfistas cruzando el llano con la tabla bajo el brazo porque el agua les ha quedado lejísimos. No hay chiringuito que ponga música ni sombrilla que recoger. Hay siete kilómetros de arena vacía y un frío que empieza a notarse en los pies.' },
    ],
    faq: [
      { q: '¿Cuánto mide la playa de Carnota y por qué se dice que es la más larga de Galicia?', a: 'Se cita habitualmente en torno a siete kilómetros contando el arenal completo hasta la desembocadura de la marisma, y unos cuatro kilómetros y medio si se mide solo el tramo principal de arena. Con esas cifras figura como el arenal más largo de Galicia. Más que la longitud, lo que la define es el conjunto: cordón de dunas móviles, marisma trasera y esteros, un sistema protegido dentro de la Red Natura 2000 junto al Monte Pindo.' },
      { q: '¿Se puede uno bañar tranquilo en Carnota?', a: 'Es Atlántico abierto de la Costa da Morte: agua fría todo el año, rompiente y, con mar de fondo, corrientes de retorno en los canales que se abren en la orilla. Solo un par de accesos tienen socorrista y servicios en temporada; el resto del arenal, que es la mayor parte, no está vigilado. Lo razonable es bañarse por la mañana, con la marea subiendo y cerca de un acceso vigilado, y respetar la bandera cuando la haya.' },
      { q: '¿Cuál es la mejor hora para ir y qué hay cerca?', a: 'Por la mañana, antes de que entre el nordés, que en verano suele arreciar por la tarde y levanta arena. Para caminar el arenal conviene la marea baja, cuando el agua se retira cientos de metros y queda un llano firme enorme. A cinco minutos en coche está el hórreo de Carnota, junto a la iglesia de Santa Comba: siglo XVIII y casi 35 metros de largo, uno de los más largos de Galicia.' },
    ],
    en: {
      title: 'Carnota (A Coruña): 7 km of sand, a tide that bares a huge flat and the nordés wind',
      excerpt:
        'Galicia’s longest beach uncovers hundreds of metres of firm sand at low tide, with the granite Monte Pindo behind it and a protected marsh alongside. The trade-off: a north-easterly on most summer afternoons, cold water and lifeguards at only a couple of access points.',
      related: [
        { href: '/en/magazine', label: 'More from the Magazine' },
        { href: '/en/crystal-clear-water-beaches', label: 'Beaches with the clearest water' },
      ],
      body: [
        { t: 'p', html: 'There is a moment, walking down from the road towards the sand, when the scale of the place stops making sense. The beach runs south without a break, the waterline has retreated so far that it is hard to judge how long the walk would take, and above it all rises a mass of rounded granite, <strong>Monte Pindo</strong>, which Galician romantics christened a Celtic Olympus and which functions here simply as a reference point: wherever you look, it is there. Behind the dune ridge there is no promenade and no apartment blocks, but a marsh of reeds and herons.' },
        { t: 'p', html: 'This is <strong>praia de Carnota</strong>, on the <strong>Costa da Morte</strong>, and the first impression is less beach than estuary. At low tide the water sits several hundred metres out from the dunes, and in between lies a flat of firm, gleaming sand crossed by freshwater channels running down off the hills and out to sea. People wade across it ankle-deep as though that were perfectly normal. And by mid-afternoon, without warning, the north-easterly gets up.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'Carnota sits in the municipality of the same name in <strong>A Coruña</strong> province, between Muros and Fisterra, and is routinely described as <strong>the longest beach in Galicia</strong>: around <strong>seven kilometres</strong> of continuous sand if you count the whole strand as far as the marsh outflow, roughly four and a half if you measure only the main stretch. The exact figure matters less than what it implies: this is not a beach but <strong>a system</strong>. Mobile dunes, a marsh behind them, creeks draining across the sand, and a stretch of coast included in the <strong>Natura 2000</strong> network alongside Monte Pindo, with specific protection for the dune complex. Hence the boardwalks and the ropes: a trodden dune is a lost dune, and here the dunes hold the marsh in place.' },
        { t: 'p', html: 'Five minutes away by car, next to the church of <strong>Santa Comba</strong>, stands the <strong>hórreo de Carnota</strong>, an 18th-century granary almost <strong>35 metres long</strong> and one of the largest in Galicia, built when American maize reached Galician farms and whole harvests needed drying. It reads as a thermometer for the area: this is farming and fishing country that happens to have an enormous beach beside it, not a beach resort with a village attached.' },
        { t: 'p', html: 'Now what is worth knowing before driving out here. <strong>The water is cold</strong>: this is open Atlantic on the Costa da Morte, and in mid-August a long swim is a matter of wetsuits or sheer conviction. <strong>The wind rules</strong>: the <strong>nortada</strong>, or north-easterly, is the dominant summer pattern in Galicia and typically strengthens in the afternoon, so the towel that was fine at eleven is a shin-high sandblast by five. <strong>There is no natural shade</strong> — the pine wood is behind, not on the sand — and <strong>facilities are concentrated at a couple of access points</strong>: the rest of the strand, which is most of it, has no lifeguard, no bar and no bins. With a swell running, rip currents form in the channels that open along the shoreline, the phenomenon that catches out bathers in Galicia every summer; if there is a flag and a lifeguard, heed them, and if there is neither, use more caution still. Add that low tide pushes the water so far out that the walk back to the car with tired children is a genuine hike rather than a stroll.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> In the morning, before the nordés arrives, and on a rising tide: that is when the water comes closer, warms a degree or two over the hot flat and swimming stops being an expedition. For walking, the opposite applies — <strong>low tide</strong>, which uncovers the whole strand and lets you cover kilometres with the Pindo ahead and nobody in the way. The trick regulars use is not to stop at the first car park: the northern accesses collect almost everyone, and a few hundred metres south the sand is empty. A windproof layer, something long-sleeved for the late afternoon and shoes for the boardwalks all earn their place.' },
        { t: 'p', html: '<strong>When not to?</strong> With a storm or a big swell forecast, with small children who want to swim freely without supervision, or if you expect the services of a town beach. It is not the place for a parasol-and-nap day either: parasols take flight here. <strong>The alternative</strong> is a quarter of an hour away: <strong>praia de Lariño</strong>, more sheltered and with less shorebreak, or the beaches inside the ría de Muros e Noia if calm water and a bar nearby are the point. Carnota is for the landscape and the walk; comfortable swimming is found elsewhere.' },
        { t: 'ul', items: [
          'Low tide for walking the strand; a rising tide for swimming.',
          'Windproof layer: the north-easterly arrives most afternoons.',
          'Lifeguards and facilities at only a couple of accesses; the rest of the beach is on its own.',
          'Stick to the boardwalks — a trodden dune is a lost dune, and these hold the marsh together.',
          'Five minutes away, the 18th-century hórreo de Carnota, almost 35 metres long.',
        ] },
        { t: 'quote', text: 'Galicia’s longest beach isn’t measured in metres of sand but in minutes of walking to reach the water when the tide is out.' },
        { t: 'p', html: 'Late in the day the wind drops all at once, as if someone had shut a door. The wet flat goes smooth and hands back the whole sky, the freshwater channels draw their branches across the sand, and the granite of the Pindo turns from grey to orange in a matter of minutes. Then the people who had been waiting all day appear: two of them with a dog, someone digging for razor clams, a couple of surfers crossing the flat with boards under their arms because the sea has ended up a very long way off. There is no beach bar playing music and no parasol to fold away. There are seven kilometres of empty sand and a cold that starts in your feet.' },
      ],
      faq: [
        { q: 'How long is Carnota beach, and why is it called Galicia’s longest?', a: 'It is usually given as around seven kilometres counting the whole strand as far as the marsh outflow, or roughly four and a half if you measure only the main stretch of sand. On those figures it ranks as the longest beach in Galicia. What defines it, though, is the whole system: mobile dunes, a marsh and creeks behind them, protected within the Natura 2000 network alongside Monte Pindo.' },
        { q: 'Is Carnota a relaxed place to swim?', a: 'It is open Atlantic on the Costa da Morte: cold water year-round, a shorebreak and, with any swell, rip currents in the channels that open along the shoreline. Only a couple of access points have lifeguards and facilities in season; the rest of the strand, which is most of it, is unpatrolled. The sensible approach is to swim in the morning, on a rising tide, near a patrolled access, and to respect the flag where there is one.' },
        { q: 'What is the best time to visit, and what else is nearby?', a: 'Mornings, before the nordés sets in — in summer it usually strengthens in the afternoon and picks up the sand. For walking the strand, low tide is best, when the water withdraws hundreds of metres and leaves a vast firm flat. Five minutes away by car is the hórreo de Carnota, next to the church of Santa Comba: 18th century, almost 35 metres long, one of the largest granaries in Galicia.' },
      ],
    },
  },
  // ───── Diario de playas · As Furnas, Porto do Son (voz bicéfala) ─────
  {
    slug: 'praia-das-furnas-porto-do-son-mar-adentro-corrientes',
    category: 'curiosidades',
    title: '«Mar adentro» se rodó en As Furnas (Porto do Son): rompiente de surf y corrientes',
    excerpt:
      'El arenal donde Amenábar rodó buena parte de «Mar adentro» es una playa abierta al Atlántico, sin paseo ni edificios, con bolos de granito y una rompiente que la ha convertido en spot de surf. Lo que la película no explica: el fondo cambia con la marea y la mayor parte del arenal no tiene vigilancia.',
    heroAlt:
      'Praia das Furnas, en Porto do Son (A Coruña): arenal abierto al Atlántico con grandes bolos de granito redondeado en los extremos y rompiente de olas',
    heroQuery: 'praia das furnas,porto do son,a coruna,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-08-12T12:49:32Z',
    readingMin: 4,
    related: [
      { href: '/comunidad/galicia', label: 'Playas de Galicia' },
      { href: '/playas-secretas', label: 'Playas y calas poco masificadas' },
    ...
    body: [
      { t: 'p', html: 'A As Furnas no se llega por casualidad. La carretera de la costa del Barbanza va por encima, entre eucaliptos y curvas, y el arenal aparece de golpe un poco más abajo: una lengua de arena clara encajada entre dos brazos de <strong>bolos de granito redondeado</strong>, esas bolas enormes que en gallego dan nombre a las <em>furnas</em>, los huecos y cuevas que el mar abre en la roca. No hay paseo marítimo, ni bloques, ni palmeras plantadas. Hay monte, roca, arena y un Atlántico que llega entero, sin nada delante que lo frene.' },
      { t: 'p', html: 'Mucha gente llega hasta aquí por una película. En este arenal de <strong>Porto do Son (A Coruña)</strong> rodó <strong>Alejandro Amenábar</strong> parte de <strong>«Mar adentro» (2004)</strong>, la historia de <strong>Ramón Sampedro</strong>, que quedó tetrapléjico en 1968 tras tirarse de cabeza al agua en esta misma playa siendo un chaval. Es una visita con doble fondo: el paisaje es magnífico y la razón por la que suena su nombre es un accidente. Conviene saberlo antes de llegar, porque cambia la manera de mirar la orilla.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'As Furnas está en el municipio de <strong>Porto do Son</strong>, en la vertiente atlántica de la <strong>península del Barbanza</strong>, entre la ría de Muros e Noia y la de Arousa. Es un arenal de en torno a un kilómetro, orientado al oeste y <strong>completamente expuesto al oleaje del Atlántico</strong>, sin isla ni cabo que lo proteja. Esa exposición es exactamente lo que lo ha convertido en <strong>spot de surf</strong> conocido de la costa gallega: funciona con casi cualquier mar y aguanta viento del este. Lo que es virtud para una tabla es un problema para un baño despreocupado.' },
      { t: 'p', html: 'El contra hay que decirlo con todas las letras: <strong>es una playa de oleaje, con fondo que cambia según la marea y corrientes de retorno cuando hay mar de fondo</strong>, y la vigilancia —cuando la hay— se limita a la temporada alta y a la parte central del arenal. No hay socorrista en septiembre, ni a primera hora, ni en los extremos rocosos, que es donde el agua parece más tentadora y donde peor está. Tampoco hay sombra natural, ni chiringuito a pie de arena, ni papeleras que aguanten un fin de semana de agosto. Y hay un detalle que la película no cuenta y que aquí es literal: <strong>en marea baja el agua descubre bajos de arena y roca cerca de la orilla</strong>, de modo que la profundidad a dos metros de donde rompe la ola no es la misma a las once que a las cinco. Zambullirse de cabeza en un sitio así, sin haber comprobado antes el fondo con los pies, es la peor idea posible en cualquier playa del Atlántico gallego, y en esta más.' },
      { t: 'p', html: 'A pocos kilómetros hacia el sur está el <strong>castro de Baroña</strong>, un poblado fortificado de la Edad del Hierro construido sobre una península rocosa que se mete en el mar, con murallas y plantas circulares de piedra todavía legibles. Es una de las visitas arqueológicas más espectaculares del litoral gallego —y una de las más ventosas—, así que la combinación lógica de la jornada es castro por la mañana, arenal después.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Con mar plana y marea media, mejor por la mañana, y para bañarse en el tercio central del arenal, no junto a las rocas. Si el plan es surf, este es de los sitios que rara vez fallan en la costa da Morte-Barbanza y en verano funciona sobre todo con las primeras horas del día, antes de que entre la nortada. Para pasear, la marea baja abre una franja firme entre bolos de granito que merece la caminata hasta el extremo sur.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Con bandera roja o mar de fondo anunciado; con niños pequeños que se metan solos; fuera de temporada esperando encontrar vigilancia; o buscando servicios de playa urbana, que no los hay. <strong>La alternativa</strong>, si lo que se quiere es agua tranquila, está dentro de las rías: los arenales de la ría de Muros e Noia o los del interior de Arousa dan baño calmado y bar cerca. As Furnas se visita por el paisaje, por el surf y por la memoria de una historia difícil; para chapotear sin pensar hay sitios mejores a media hora.' },
      { t: 'ul', items: [
        'Nunca tirarse de cabeza: el fondo cambia con la marea y hay bajos de arena y roca.',
        'Bañarse en el tercio central, lejos de los bolos de granito de los extremos.',
        'Vigilancia solo en temporada alta y en el tramo central: fuera de ahí, nadie.',
        'Sin sombra ni chiringuito a pie de arena: agua y comida, de casa.',
        'A pocos kilómetros, el castro de Baroña, poblado de la Edad del Hierro sobre una península rocosa.',
      ] },
      { t: 'quote', text: 'No es la playa de una película: es la playa donde ocurrió lo que luego contó una película. La diferencia se nota al mirar el agua.' },
      { t: 'p', html: 'Al caer la tarde el arenal se ordena solo. Los surfistas se quedan hasta que la última serie deja de ser aprovechable, alguien recoge una toalla llena de arena y el granito de los extremos se pone del color del pan. El mar sigue trabajando las <em>furnas</em>, esos huecos que lleva siglos abriendo en la roca, y hace exactamente el mismo ruido que hacía en 1968. Es un sitio precioso y es un sitio serio, y las dos cosas caben en la misma tarde.' },
    ],
    faq: [
      { q: '¿Dónde se rodó «Mar adentro» y qué relación tiene con la praia das Furnas?', a: 'Parte de «Mar adentro» (Alejandro Amenábar, 2004) se rodó en la praia das Furnas, en Porto do Son (A Coruña). La película cuenta la historia de Ramón Sampedro, que quedó tetrapléjico en 1968 tras tirarse de cabeza al agua en esa misma playa. El arenal se ha convertido en visita habitual por ese motivo, aunque el sitio interesa por sí mismo: costa abierta del Barbanza, bolos de granito y una rompiente que lo ha hecho conocido entre surfistas.' },
      { q: '¿Es segura para bañarse la playa das Furnas?', a: 'Es una playa abierta al Atlántico, sin protección de cabos ni islas, con oleaje habitual, fondo que cambia con la marea y corrientes de retorno cuando entra mar de fondo. La vigilancia se limita a la temporada alta y al tramo central del arenal. Lo prudente es bañarse por la mañana con mar plana, en la parte central y lejos de las zonas rocosas, y no zambullirse nunca de cabeza sin haber comprobado el fondo.' },
      { q: '¿Qué se puede visitar cerca de As Furnas?', a: 'A pocos kilómetros está el castro de Baroña, un poblado fortificado de la Edad del Hierro levantado sobre una península rocosa que entra en el mar, con murallas y viviendas circulares aún visibles. Es una de las visitas arqueológicas más llamativas del litoral gallego y también de las más expuestas al viento, así que conviene ir abrigado aunque haga sol.' },
    ],
    en: {
      title: 'Amenábar filmed «The Sea Inside» at As Furnas (Porto do Son): surf break and rips',
      excerpt:
        'The beach where much of «The Sea Inside» was filmed is wide open to the Atlantic, with no promenade, no buildings, granite boulders at either end and a break that has made it a surf spot. What the film doesn’t explain: the seabed shifts with the tide and most of the strand is unpatrolled.',
      related: [
        { href: '/en/magazine', label: 'More from the Magazine' },
        { href: '/en/crystal-clear-water-beaches', label: 'Beaches with the clearest water' },
      ],
      body: [
        { t: 'p', html: 'Nobody arrives at As Furnas by accident. The Barbanza coast road runs above it, through eucalyptus and bends, and the beach appears abruptly below: a tongue of pale sand wedged between two arms of <strong>rounded granite boulders</strong>, the huge spheres that give the <em>furnas</em> their name — the hollows and caves the sea carves into the rock. There is no promenade, no apartment blocks, no imported palm trees. There is hillside, rock, sand and an Atlantic that arrives whole, with nothing in front of it.' },
        { t: 'p', html: 'Many people come because of a film. It was on this beach at <strong>Porto do Son (A Coruña)</strong> that <strong>Alejandro Amenábar</strong> shot part of <strong>«The Sea Inside» (2004)</strong>, the story of <strong>Ramón Sampedro</strong>, left tetraplegic in 1968 after diving head-first into the water here as a young man. It is a visit with a double bottom: the landscape is superb, and the reason the name is known is an accident. Worth knowing before you arrive, because it changes how you look at the shoreline.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'As Furnas lies in the municipality of <strong>Porto do Son</strong>, on the Atlantic flank of the <strong>Barbanza peninsula</strong>, between the rías of Muros e Noia and Arousa. It is around a kilometre of sand, west-facing and <strong>fully exposed to Atlantic swell</strong>, with no island or headland shielding it. That exposure is precisely what has made it a well-known <strong>surf spot</strong> on the Galician coast: it works with almost any swell and holds an easterly wind. What is a virtue for a board is a problem for a casual swim.' },
        { t: 'p', html: 'The downside deserves plain words: <strong>this is a wave beach, with a seabed that shifts with the tide and rip currents whenever a swell is running</strong>, and supervision — where it exists — is limited to high season and the central section. There is no lifeguard in September, none first thing in the morning, and none at the rocky ends, which is where the water looks most inviting and behaves worst. There is no natural shade either, no beach bar on the sand, and no bins that survive an August weekend. And there is a detail the film does not cover, literal here: <strong>at low tide the water reveals sand and rock banks close to the shore</strong>, so the depth two metres beyond the breaking wave is not what it was at eleven in the morning. Diving head-first in a place like this, without checking the bottom with your feet first, is the worst idea available on any Galician Atlantic beach, and more so on this one.' },
        { t: 'p', html: 'A few kilometres south stands the <strong>castro de Baroña</strong>, an Iron Age fortified settlement built on a rocky peninsula jutting into the sea, its walls and circular stone houses still legible. It is one of the most striking archaeological sites on the Galician coast — and one of the windiest — so the logical shape of the day is the castro in the morning and the beach afterwards.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> On a flat sea and a mid tide, ideally in the morning, and swim in the middle third of the beach rather than near the rocks. If surfing is the plan, this is among the more reliable spots on the Costa da Morte–Barbanza stretch, and in summer it works best early, before the nortada fills in. For walking, low tide opens a firm strip between granite boulders that makes the trek to the southern end worthwhile.' },
        { t: 'p', html: '<strong>When not to?</strong> With a red flag or a forecast swell; with small children swimming unsupervised; out of season while expecting supervision; or in search of town-beach facilities, which do not exist. <strong>The alternative</strong>, if calm water is the goal, lies inside the rías: the beaches of the ría de Muros e Noia or the inner shores of Arousa offer quiet swimming and a bar nearby. As Furnas is visited for the landscape, for the surf and for the memory of a difficult story; for thoughtless paddling there are better places half an hour away.' },
        { t: 'ul', items: [
          'Never dive head-first: the bottom changes with the tide and there are sand and rock banks.',
          'Swim in the middle third, away from the granite boulders at either end.',
          'Supervision only in high season and only on the central stretch; beyond that, nobody.',
          'No shade and no bar on the sand: bring water and food.',
          'A few kilometres away, the castro de Baroña, an Iron Age settlement on a rocky peninsula.',
        ] },
        { t: 'quote', text: 'This is not the beach from a film: it is the beach where the thing the film recounts actually happened. You notice the difference when you look at the water.' },
        { t: 'p', html: 'Towards evening the beach sorts itself out. The surfers stay until the last set stops being worth it, someone shakes the sand off a towel, and the granite at either end turns the colour of bread. The sea carries on working the <em>furnas</em>, the hollows it has been opening in the rock for centuries, and makes exactly the same noise it made in 1968. It is a beautiful place and a serious one, and both fit into the same afternoon.' },
      ],
      faq: [
        { q: 'Where was «The Sea Inside» filmed, and what is its link to praia das Furnas?', a: 'Part of «The Sea Inside» (Alejandro Amenábar, 2004) was shot at praia das Furnas in Porto do Son, A Coruña. The film tells the story of Ramón Sampedro, left tetraplegic in 1968 after diving head-first into the water at that same beach. The strand has become a regular stop for that reason, though it stands up on its own merits: exposed Barbanza coastline, granite boulders and a break well known among surfers.' },
        { q: 'Is it safe to swim at praia das Furnas?', a: 'It is a beach wide open to the Atlantic, with no headland or island for shelter, regular swell, a seabed that shifts with the tide and rip currents whenever a swell runs. Supervision is limited to high season and the central stretch. The prudent approach is to swim in the morning on a flat sea, in the middle of the beach and well away from the rocky ends, and never to dive head-first without checking the bottom first.' },
        { q: 'What is worth visiting near As Furnas?', a: 'A few kilometres away is the castro de Baroña, an Iron Age fortified settlement built on a rocky peninsula reaching into the sea, with walls and circular dwellings still visible. It is one of the most striking archaeological sites on the Galician coast and also one of the most wind-exposed, so take a layer even on a sunny day.' },
      ],
    },
  },
  // ───── Diario de playas · Sa Calobra (voz bicéfala) ─────
  {
    slug: 'sa-calobra-escorca-mallorca-tuneles-torrent-de-pareis',
    category: 'guias',
    title: 'Dos túneles a pie hasta Sa Calobra (Mallorca): 12 km de curvas y cantos, no arena',
    excerpt:
      'A la desembocadura del Torrent de Pareis se llega bajando doce kilómetros de curvas y cruzando después dos túneles excavados en la roca. Lo que no sale en la foto: el suelo es de canto rodado, la pared quita el sol a media tarde y a mediodía comparten la grava los autocares y los barcos de línea.',
    heroAlt:
      'Desembocadura del Torrent de Pareis en Sa Calobra, Mallorca: una lengua de cantos rodados entre dos paredes de roca de cientos de metros que se abren al mar',
    heroQuery: 'sa calobra,torrent de pareis,escorca,mallorca',
    author: 'Equipo Playas de España',
    datePublished: '2026-08-12T12:09:38Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'La carretera empieza en lo alto, en el Coll dels Reis, y desde el primer metro deja claro que no va a ninguna parte más: baja hacia el mar por una ladera de la Serra de Tramuntana que no tiene pueblo, ni cruce, ni salida. En una de las primeras curvas el asfalto se muerde a sí mismo, gira trescientos sesenta grados por debajo de su propio trazado y sigue bajando; los mallorquines la llaman <em>el nus de sa corbata</em>, el nudo de la corbata, y no hay mejor descripción. Detrás vienen kilómetros de peraltes, ciclistas que suben a su ritmo, algún autocar maniobrando en una curva estrecha y, entre pino y pino, el azul que aparece y desaparece cuatrocientos metros más abajo.' },
      { t: 'p', html: 'Abajo espera un aparcamiento, cuatro terrazas y un pequeño puerto. Pero la playa que todo el mundo ha venido a ver no está ahí: hay que seguir por un paseo de hormigón pegado al acantilado y cruzar <strong>dos túneles excavados en la roca</strong>, oscuros, húmedos y con eco de gente. Al salir del segundo, el paisaje cambia de golpe. Dos paredes de cientos de metros se abren como un tajo, el fondo del barranco se ensancha, y en la boca hay una lengua de cantos rodados —blancos, redondos, del tamaño de un puño— sobre la que rompe un mar muy quieto. Es la desembocadura del <strong>Torrent de Pareis</strong>, y llegar hasta aquí ha costado doce kilómetros de curvas y dos agujeros en la montaña.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Sa Calobra pertenece al municipio de <strong>Escorca</strong>, el más despoblado de Mallorca, y está dentro de la <strong>Serra de Tramuntana</strong>, que la <strong>UNESCO</strong> declaró Patrimonio Mundial en <strong>2011</strong> como paisaje cultural. El barranco que desemboca aquí, el <strong>Torrent de Pareis</strong>, está protegido como <strong>Monumento Natural</strong> por el Govern balear desde <strong>2003</strong>: es una de las gargantas más profundas del Mediterráneo occidental y en algunos tramos las paredes se estrechan hasta dejar pasar poco más que el cauce. La carretera de acceso, la <strong>MA-2141</strong>, es obra del ingeniero <strong>Antonio Parietti</strong> y se abrió en los años treinta con un criterio que hoy sería impensable: en vez de perforar la montaña, dibujó el descenso pegado al terreno. De ahí el lazo del <em>nus de sa corbata</em> y de ahí también que sea una de las subidas más conocidas de Europa para el ciclismo, con casi diez kilómetros de rampa continua para volver arriba.' },
      { t: 'p', html: 'Y ahora lo que la postal no enseña. <strong>Esto no es una playa de arena</strong>: el suelo es canto rodado que ha bajado el torrente, incómodo para andar descalzo y peor para plantar una sombrilla, que aquí sencillamente no se clava. <strong>No hay sombra natural</strong> en las horas centrales y, en cambio, <strong>la pared del barranco tapa el sol pronto por la tarde</strong>, así que la cala se queda en penumbra fría antes que ninguna otra de la isla. El agua se hace honda enseguida y suele estar <strong>varios grados más fría</strong> que en el sur de Mallorca, por profundidad y por los aportes de agua dulce del subsuelo. Los servicios —bar, aseos, aparcamiento— están en el núcleo del puerto, al otro lado de los túneles, no en la grava del torrente. Y el aforo es el problema serio: a mediodía coinciden los autocares que bajan la carretera y los <strong>barcos de línea desde el Port de Sóller, Alcúdia y Can Picafort</strong>, de manera que un sitio que a las nueve de la mañana está casi vacío puede tener cientos de personas a las doce y media, con los túneles funcionando como cuello de botella en los dos sentidos.' },
      { t: 'p', html: 'Un aviso más, porque cada verano hay que repetirlo: <strong>bajar el Torrent de Pareis por dentro, desde Escorca, no es una excursión de playa</strong>. Es un descenso de barranco de varias horas con destrepes, saltos de roca pulida y tramos donde no se puede dar la vuelta; genera rescates todos los años y ha costado vidas. No se hace con calzado de playa, ni improvisando, ni —bajo ningún concepto— con previsión de lluvia, porque un torrente estrecho concentra en minutos el agua de toda la cuenca. Quien quiere ver el barranco sin asumir eso lo ve exactamente igual desde abajo, andando doscientos metros desde el segundo túnel.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> A primera hora, antes de las diez, o a partir de las cinco y media de la tarde, cuando los autocares ya han emprendido la subida y los barcos han hecho su último viaje. La luz de la mañana entra por la boca del barranco y es cuando el sitio se parece a lo que promete. El truco de quien conoce la carretera es doble: <strong>bajar temprano y volver tarde</strong>, para no cruzarse con la caravana en las curvas, y llevar <strong>escarpines o sandalias que se puedan mojar</strong>, porque los cantos rodados hacen daño al entrar y resbalan al salir. Si alguien se marea en coche, la vuelta de doce kilómetros en zigzag pide asiento delantero y ventanilla abierta. Y conviene mirar el parte de viento: con la mar del norte levantada, la entrada al agua entre piedras deja de ser agradable y pasa a ser mala idea.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Un día de agosto a mediodía, con prisa, con carrito de bebé —el paseo de los túneles tiene escalones y desniveles— o esperando un día de playa clásico con toalla, sombrilla y chiringuito a pie de agua: nada de eso encaja aquí. Tampoco con previsión de tormenta en la Serra, aunque abajo haga sol. <strong>La alternativa</strong> la tiene casi todo el mundo delante y casi nadie la coge: unos kilómetros antes, un desvío de la misma carretera baja a <strong>Cala Tuent</strong>, mucho más tranquila, con más arena entre la grava, bajo la mole del Puig Major y sin túneles ni colas. Quien busque bañarse más que fotografiar el barranco, sale ganando con el desvío.' },
      { t: 'ul', items: [
        'Escarpines o sandalias de agua: el canto rodado castiga la planta del pie al entrar y al salir.',
        'La sombrilla sobra —no se clava en piedra— y a media tarde la pared ya da sombra gratis.',
        'Agua y algo de comer: los bares están en el puerto, antes de los túneles.',
        'Nada de barranquismo improvisado por el Torrent de Pareis, y menos con lluvia prevista.',
        'Si la carretera intimida, hay barco desde el Port de Sóller, Alcúdia y Can Picafort.',
      ] },
      { t: 'quote', text: 'Sa Calobra no es una cala escondida: es una cala perfectamente señalizada a la que cuesta llegar. Lo raro no es encontrarla, es encontrarla vacía.' },
      { t: 'p', html: 'Hacia el final del día pasa algo que compensa el viaje. Los últimos barcos se van hacia Sóller, los autocares vuelven a enfilar el nudo de la corbata y la boca del torrente se queda con cuatro personas sentadas sobre las piedras. Entonces se oye lo que llevaba horas tapado: el agua moviendo cantos, un vencejo que entra y sale del tajo, el eco raro que devuelve la pared. Una vez al año, a principios de julio, ese mismo hueco entre paredes se llena de sillas y de un coro que canta sin megafonía, porque la acústica del barranco no la necesita. El resto del verano, la única manera de escucharlo es quedarse hasta que la sombra suba por la roca y el aparcamiento de arriba se vacíe.' },
    ],
    faq: [
      { q: '¿Cómo se llega a la playa del Torrent de Pareis en Sa Calobra?', a: 'Por carretera, bajando la MA-2141 desde el Coll dels Reis: unos doce kilómetros de curvas cerradas, incluida la vuelta completa conocida como el nus de sa corbata. Se aparca en el núcleo de Sa Calobra y desde allí se continúa a pie por un paseo pegado al acantilado que atraviesa dos túneles excavados en la roca hasta la desembocadura del torrente. La otra opción es el barco de línea desde el Port de Sóller, Alcúdia o Can Picafort, que evita la carretera pero también llega a las horas de más gente.' },
      { q: '¿Es una playa de arena y hay servicios?', a: 'No es de arena: el suelo es canto rodado bajado por el torrente, incómodo para caminar descalzo y donde no se clava una sombrilla. Conviene llevar escarpines. Los bares, aseos y el aparcamiento están en el núcleo del puerto, al otro lado de los túneles, no en la desembocadura. El agua se hace honda pronto y suele estar más fría que en el sur de la isla, y la pared del barranco tapa el sol a media tarde.' },
      { q: '¿Se puede bajar caminando por el Torrent de Pareis hasta la playa?', a: 'El descenso del barranco desde Escorca no es un paseo, sino una ruta de barranquismo de varias horas con destrepes y tramos sin retorno, que provoca rescates cada temporada y ha causado accidentes mortales. Requiere experiencia, material y previsión meteorológica: nunca con lluvia prevista, porque la garganta concentra el agua de toda la cuenca en poco tiempo. Para ver el interior del barranco sin ese riesgo basta con caminar unos metros hacia dentro desde la desembocadura.' },
    ],
    en: {
      title: 'Two tunnels on foot to reach Sa Calobra, Mallorca: 12 km of hairpins and pebbles',
      excerpt:
        'Getting to the mouth of the Torrent de Pareis means twelve kilometres of hairpin bends and then two tunnels cut through the rock. What the photo leaves out: the ground is cobbles, the cliff takes the sun away by mid-afternoon, and at midday the coach parties and the scheduled boats arrive together.',
      related: [
        { href: '/en/islands', label: 'Island beaches' },
        { href: '/en/magazine', label: 'More from the Magazine' },
      ],
      body: [
        { t: 'p', html: 'The road starts high up, at the Coll dels Reis, and makes it clear from the first metre that it goes nowhere else: it drops towards the sea down a flank of the Serra de Tramuntana with no village, no junction and no way out. On one of the early bends the tarmac bites its own tail, loops a full circle underneath itself and carries on down; Mallorcans call it <em>el nus de sa corbata</em>, the tie knot, and no better description exists. After that come kilometres of banked curves, cyclists grinding uphill at their own pace, the odd coach shuffling round a tight corner and, between the pines, a blue that appears and vanishes four hundred metres below.' },
        { t: 'p', html: 'At the bottom there is a car park, a few terraces and a small harbour. But the beach everyone came for isn’t there: you carry on along a concrete walkway glued to the cliff and pass through <strong>two tunnels bored into the rock</strong> — dark, damp and echoing with other people. Step out of the second one and the scenery changes at once. Two walls hundreds of metres high open like a cut, the floor of the gorge widens, and at its mouth lies a tongue of cobbles — white, round, fist-sized — with a very still sea breaking over it. This is the mouth of the <strong>Torrent de Pareis</strong>, and reaching it has cost twelve kilometres of bends and two holes drilled through a mountain.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'Sa Calobra belongs to <strong>Escorca</strong>, the least populated municipality on Mallorca, and sits inside the <strong>Serra de Tramuntana</strong>, listed by <strong>UNESCO</strong> as a World Heritage cultural landscape in <strong>2011</strong>. The gorge that ends here, the <strong>Torrent de Pareis</strong>, has been protected as a <strong>Natural Monument</strong> by the Balearic government since <strong>2003</strong>: it is one of the deepest canyons in the western Mediterranean and in places the walls narrow to little more than the width of the streambed. The access road, the <strong>MA-2141</strong>, is the work of engineer <strong>Antonio Parietti</strong> and opened in the 1930s on a principle that would be unthinkable today: rather than tunnel through the mountain, he drew the descent along the contours of the ground. Hence the loop of the <em>nus de sa corbata</em>, and hence too its status as one of Europe’s best-known cycling climbs, with nearly ten kilometres of continuous gradient to get back up.' },
        { t: 'p', html: 'Now for what the postcard omits. <strong>This is not a sandy beach</strong>: the ground is cobble brought down by the torrent, awkward to walk on barefoot and worse for a parasol, which simply will not go in. <strong>There is no natural shade</strong> in the middle of the day, and yet <strong>the canyon wall takes the sun away early in the afternoon</strong>, so the cove drops into cool shadow sooner than anywhere else on the island. The water deepens quickly and tends to run <strong>several degrees colder</strong> than in the south of Mallorca, thanks to depth and to freshwater seeping in. The facilities — bar, toilets, car park — are in the harbour settlement on the far side of the tunnels, not on the torrent’s gravel. And numbers are the real problem: at midday the coaches coming down the road coincide with the <strong>scheduled boats from Port de Sóller, Alcúdia and Can Picafort</strong>, so a place that is close to empty at nine in the morning can hold hundreds by half past twelve, with the tunnels acting as a bottleneck in both directions.' },
        { t: 'p', html: 'One more warning, because it bears repeating every summer: <strong>descending the Torrent de Pareis from Escorca is not a walk to the beach</strong>. It is a canyoning route of several hours with down-climbs, polished rock and sections where turning back isn’t an option; it generates rescues every year and it has killed people. It is not done in beach shoes, not improvised, and never — under any circumstances — with rain in the forecast, because a narrow gorge concentrates the runoff of an entire catchment within minutes. Anyone who wants to see the canyon without taking that on sees it just as well from below, walking two hundred metres in from the second tunnel.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> Early, before ten, or from half past five in the afternoon, once the coaches have started back up and the boats have made their last run. Morning light comes straight in through the mouth of the gorge, and that is when the place looks like what it promises. Regulars work the road two ways: <strong>go down early and come back late</strong>, so you don’t meet the convoy on the bends, and bring <strong>water shoes or sandals you can soak</strong>, because the cobbles hurt going in and are slippery coming out. Anyone prone to car sickness should claim the front seat and an open window for twelve kilometres of zigzag. And check the wind: with a northerly swell running, getting in and out over stones stops being pleasant and becomes a bad idea.' },
        { t: 'p', html: '<strong>When not to?</strong> Midday in August, in a hurry, with a pushchair — the tunnel walkway has steps and changes of level — or expecting a conventional beach day with towel, parasol and a beach bar at the water’s edge: none of that fits here. Nor with storms forecast over the Serra, however sunny it looks at sea level. <strong>The alternative</strong> is in plain sight and almost nobody takes it: a few kilometres earlier, a turning off the same road drops to <strong>Cala Tuent</strong>, far quieter, with more sand among the shingle, under the bulk of the Puig Major and with no tunnels and no queues. If the plan is swimming rather than photographing the gorge, the turning wins.' },
        { t: 'ul', items: [
          'Water shoes: the cobbles punish bare feet both getting in and getting out.',
          'Leave the parasol behind — it won’t go into stone, and the wall shades the cove by mid-afternoon anyway.',
          'Bring water and food: the bars are back in the harbour, before the tunnels.',
          'No improvised canyoning down the Torrent de Pareis, least of all with rain forecast.',
          'If the road puts you off, boats run from Port de Sóller, Alcúdia and Can Picafort.',
        ] },
        { t: 'quote', text: 'Sa Calobra is not a hidden cove: it is a thoroughly signposted one that is hard to reach. The trick isn’t finding it — it’s finding it empty.' },
        { t: 'p', html: 'Towards the end of the day something happens that repays the journey. The last boats pull away for Sóller, the coaches line up again for the tie knot, and the mouth of the torrent is left with four people sitting on the stones. Then you hear what had been buried for hours: water shifting cobbles, a swift darting in and out of the cleft, the odd echo the wall throws back. Once a year, in early July, that same gap between walls fills with chairs and a choir that sings without amplification, because the acoustics of the gorge make it unnecessary. For the rest of the summer, the only way to hear it is to stay until the shadow climbs the rock and the car park up top has emptied.' },
      ],
      faq: [
        { q: 'How do you get to the Torrent de Pareis beach at Sa Calobra?', a: 'By road, dropping down the MA-2141 from the Coll dels Reis: some twelve kilometres of tight bends, including the full loop known as the nus de sa corbata. You park in the Sa Calobra settlement and continue on foot along a walkway hugging the cliff that passes through two tunnels cut into the rock to reach the mouth of the torrent. The alternative is the scheduled boat from Port de Sóller, Alcúdia or Can Picafort, which avoids the road but also arrives at the busiest hours.' },
        { q: 'Is it a sandy beach, and are there facilities?', a: 'It is not sand: the ground is cobble washed down by the torrent, awkward barefoot and impossible for a parasol, so water shoes are worth packing. The bars, toilets and car park are in the harbour settlement on the far side of the tunnels, not at the river mouth. The water deepens quickly and tends to be colder than in the south of the island, and the canyon wall blocks the sun by mid-afternoon.' },
        { q: 'Can you walk down the Torrent de Pareis to the beach?', a: 'The descent of the gorge from Escorca is not a stroll but a canyoning route of several hours, with down-climbs and stretches where you cannot turn back. It produces rescues every season and has caused fatal accidents. It needs experience, proper kit and a weather check: never with rain forecast, because the gorge concentrates the runoff of the whole catchment in a short time. To see inside the canyon without that risk, simply walk a short way in from the river mouth.' },
      ],
    },
  },
  // ───── Diario de playas · Punta del Fangar (voz bicéfala) ─────
  {
    slug: 'punta-del-fangar-delta-ebro-eclipse-total-12-agosto-2026',
    category: 'guias',
    title: 'El Fangar (Delta del Ebro): el eclipse total de las 20:30 a ras de arrozal, y mosquitos',
    excerpt:
      'La franja de totalidad del eclipse del 12 de agosto de 2026 cruza el Delta del Ebro, una llanura a menos de un metro sobre el mar donde nada tapa el horizonte del oeste. La letra pequeña: el Sol se eclipsa muy bajo, los mosquitos salen justo a esa hora y la vuelta por la barra de arena se hace de noche.',
    heroAlt:
      'Punta del Fangar, en el Delta del Ebro: lengua de arena con dunas bajas y el faro al fondo, con la bahía del Fangar a un lado y el Mediterráneo al otro bajo un cielo despejado',
    heroQuery: 'punta del fangar,deltebre,tarragona,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-08-12T08:21:55Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'Desde la barra del Fangar no se ve una sola montaña cerca. Hay arena, dunas que el viento cambia de sitio cada temporada, un faro pequeño al final de la lengua, mejilloneras alineadas en la bahía y, hacia el interior, kilómetros de arrozal en su punto verde de agosto. El suelo está tan bajo que la línea del horizonte se confunde con el agua de los campos. Es un paisaje sin relieve, sin altura y casi sin edificios, y eso —que cualquier otro día es solo una rareza geográfica— hoy es exactamente lo que hace falta.' },
      { t: 'p', html: 'Porque el <strong>12 de agosto de 2026</strong> la Luna tapa el Sol por completo sobre el norte y el nordeste de España, y la franja donde la totalidad se ve entera pasa por el <strong>Delta del Ebro</strong>. Es el primer eclipse total visible desde la España peninsular desde <strong>1905</strong>. Y no ocurre a mediodía, con el Sol cómodo en lo alto, sino <strong>al final de la tarde, con el Sol a un puñado de grados sobre el horizonte</strong>: en un valle, detrás de una sierra o entre bloques de apartamentos, el espectáculo se lo queda el obstáculo. En una llanura deltaica, no hay obstáculo.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'La <strong>Punta del Fangar</strong> es el extremo norte del Delta, en el término de <strong>Deltebre (Tarragona)</strong>: una flecha de arena de varios kilómetros que se curva hacia el oeste y cierra la <strong>bahía del Fangar</strong>, con el Mediterráneo abierto por la cara exterior y agua somera y templada por dentro. Todo el conjunto está dentro del <strong>Parc Natural del Delta de l’Ebre</strong>, declarado en <strong>1983</strong>, y del área que la <strong>UNESCO</strong> reconoció como <strong>Reserva de la Biosfera de las Terres de l’Ebre en 2013</strong>. La cifra que explica el resto: el Delta es una plataforma de sedimento del río con una <strong>altitud media inferior a un metro sobre el nivel del mar</strong>. No hay un cerro, ni un talud, ni un pinar alto. Lo más parecido a un accidente del terreno son las dunas de la propia punta.' },
      { t: 'p', html: 'Sobre el eclipse conviene manejar tres datos y ninguna suposición. Primero: <strong>la franja de totalidad no cubre toda España</strong>, es una banda que atraviesa el país en diagonal, y unos pocos kilómetros de más te dejan con un eclipse parcial —que no se parece en nada— en lugar de con la totalidad. El <strong>Instituto Geográfico Nacional</strong> y el <strong>Observatorio Astronómico Nacional</strong> publican el mapa oficial con el trazado y los horarios municipio a municipio: es la única fuente que hay que mirar antes de elegir sitio, y conviene hacerlo con el dedo sobre el punto exacto, no sobre la provincia. Segundo: aquí la totalidad cae <strong>en torno a las 20:30 (hora peninsular)</strong>, con las fases parciales empezando más de una hora antes, y <strong>dura menos de dos minutos</strong> en cualquier punto de España. Tercero, el que decide dónde plantarse: <strong>el Sol estará muy bajo</strong>, a unos pocos grados de altura. Una sierra a diez kilómetros, un edificio de cuatro plantas o una hilera de eucaliptos bastan para tapar el momento entero.' },
      { t: 'p', html: 'Ahora lo incómodo, que aquí es abundante. <strong>El Delta es tierra de mosquitos</strong>, con arrozales inundados a pocos metros y un servicio público de control específico —el del <strong>Consorci de Polítiques Ambientals de les Terres de l’Ebre</strong>— precisamente porque la molestia es estructural, no anecdótica. Su hora punta es el crepúsculo: la misma en la que ocurre el eclipse. Segundo aviso: <strong>en la punta no hay nada</strong>, ni bar, ni fuente, ni baños, ni socorrista, ni farola para la vuelta. Tercero: parte del Fangar es <strong>zona de nidificación de aves</strong> y hay tramos acordonados o cerrados según la temporada, además de regulación del paso de vehículos; la arena es fina y blanda y allí se quedan clavados coches todos los veranos, así que lo sensato es aparcar donde esté señalizado y andar. Cuarto: el nivel del agua en el Delta lo mueven el viento y la presión más que la marea astronómica, que aquí es de centímetros, y con levante entra el mar por donde quiere. Y quinto, el que no se negocia: <strong>para mirar el Sol hacen falta gafas de eclipse certificadas según la norma ISO 12312-2</strong>. Las gafas de sol, las radiografías, los cristales ahumados y la pantalla del móvil no sirven y hacen daño. Solo durante los segundos de totalidad —y solo entonces— se mira a simple vista.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Hoy, llegando con luz y con margen. La barra del Fangar se recorre andando y la arena cansa, así que estar colocado dos horas antes evita el error clásico de buscar sitio con el Sol ya mordido. El criterio para elegir el punto es uno solo: <strong>mirar al oeste y comprobar que no hay nada delante</strong>, ni una caseta ni una fila de cañas. Y antes de salir, dos consultas: el mapa de <strong>IGN</strong> para confirmar que el punto está dentro de la franja, y la previsión de nubosidad de <strong>AEMET</strong>, porque el enemigo real de este eclipse no es la lluvia sino <strong>una simple banda de nubes bajas o de calima pegada al horizonte del oeste</strong>, invisible a mediodía y suficiente para tapar el Sol a las 20:30. Con el Sol tan bajo, la meteorología del último grado de cielo importa más que la del resto del día.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Si se pretende añadir baño y jornada de playa, mal plan: la bahía es somera, con fondo de fango y mejilloneras, y el interés del sitio hoy no es el agua. Tampoco si se va con niños muy pequeños sin repelente y sin ropa larga, o si se piensa volver de noche por la arena sin linterna. Y hay una alternativa perfectamente legítima que conviene decir en voz alta: <strong>estar dentro de la franja importa mucho más que estar en la playa</strong>. Un rastrojo llano del interior de las Terres de l’Ebre, un mirador con el oeste despejado o cualquier campo abierto de la banda de totalidad valen igual o más que una arena bonita con una sierra delante. La playa aporta el horizonte limpio; si el horizonte está limpio, la arena es opcional.' },
      { t: 'ul', items: [
        'Gafas certificadas ISO 12312-2, una por cabeza y compradas antes: hoy no se encuentran.',
        'Repelente de mosquitos y manga larga fina para el crepúsculo.',
        'Linterna o frontal para la vuelta, con luz roja si es posible.',
        'Agua y comida: en la punta no hay ningún servicio.',
        'Calzado cerrado para caminar sobre arena blanda, y nada de meter el coche donde no toca.',
      ] },
      { t: 'quote', text: 'El Delta no es un mirador porque tenga altura, sino justo por lo contrario: porque no tiene ninguna. Durante dos minutos, la tierra más baja de Cataluña será el mejor palco que hay.' },
      { t: 'p', html: 'Lo que ocurre después no lo cuentan bien las fotos. La luz de la última media hora se vuelve metálica, la temperatura baja de golpe, los pájaros de la bahía se callan y las mejilloneras se quedan quietas sobre un agua que ya no refleja nada. Y entonces, sobre los arrozales, aparece un agujero negro con un anillo alrededor a la altura de un tejado. Dura poco más de un minuto. Luego el Sol vuelve por el borde, las gafas se ponen otra vez, los mosquitos siguen a lo suyo y toca desandar la arena con la linterna en la mano. Merece la pena comprobar el mapa antes de salir: lo que separa el eclipse de la vida de un atardecer raro son unos pocos kilómetros de mapa.' },
    ],
    faq: [
      { q: '¿Se ve el eclipse total del 12 de agosto de 2026 desde el Delta del Ebro?', a: 'El Delta del Ebro queda dentro de la franja de totalidad que cruza el norte y el nordeste peninsular, pero la banda es estrecha en comparación con el país y unos kilómetros deciden entre ver la totalidad o un eclipse parcial. Antes de elegir sitio hay que comprobar el punto exacto en el mapa oficial del Instituto Geográfico Nacional y del Observatorio Astronómico Nacional, que además publican la hora para cada municipio. En esta zona la totalidad cae en torno a las 20:30 hora peninsular y dura menos de dos minutos.' },
      { q: '¿Por qué una playa llana es mejor sitio que un mirador alto para este eclipse?', a: 'Porque este eclipse ocurre con el Sol muy bajo, a unos pocos grados sobre el horizonte, y no en lo alto del cielo. Lo que importa no es la altura desde la que se mira, sino que no haya nada en la dirección oeste: una sierra a diez kilómetros, un bloque de pisos o una hilera de árboles pueden tapar el momento completo. El Delta del Ebro tiene una altitud media inferior a un metro sobre el nivel del mar y apenas construcción, así que el horizonte queda limpio.' },
      { q: '¿Qué hace falta llevar a la Punta del Fangar y qué precauciones hay?', a: 'Gafas de eclipse certificadas según la norma ISO 12312-2 (las gafas de sol, las radiografías o la cámara del móvil no protegen; solo durante los segundos de totalidad se puede mirar a simple vista), repelente de mosquitos y manga larga, porque el crepúsculo en los arrozales es su hora punta, linterna para la vuelta, agua y comida. En la punta no hay bar, fuente, baños ni socorrista. Está dentro del Parc Natural del Delta de l’Ebre, con zonas de nidificación acordonadas y paso de vehículos regulado: conviene aparcar donde esté señalizado y continuar a pie, porque la arena es blanda y atrapa coches.' },
    ],
    en: {
      title: 'El Fangar (Ebro Delta): the total eclipse at 20:30 over a flat horizon, and mosquitoes',
      excerpt:
        'The path of totality on 12 August 2026 crosses the Ebro Delta, a plain sitting less than a metre above sea level where nothing blocks the western horizon. The small print: the Sun is eclipsed very low down, the mosquitoes come out at exactly that hour, and the walk back along the sand spit happens in the dark.',
      related: [
        { href: '/en/magazine', label: 'More from the Magazine' },
        { href: '/en/crystal-clear-water-beaches', label: 'Beaches with the clearest water' },
      ],
      body: [
        { t: 'p', html: 'From the Fangar spit there isn’t a mountain in sight. There is sand, low dunes the wind rearranges every season, a small lighthouse at the tip, mussel beds lined up across the bay and, inland, mile after mile of rice paddy at its August green. The ground lies so low that the horizon blurs into the water standing in the fields. It is a landscape with no relief, no height and almost no buildings — which on any other day is a geographical curiosity, and today is precisely what is needed.' },
        { t: 'p', html: 'Because on <strong>12 August 2026</strong> the Moon covers the Sun completely over northern and north-eastern Spain, and the band where totality is visible in full runs across the <strong>Ebro Delta</strong>. It is the first total eclipse visible from mainland Spain since <strong>1905</strong>. And it doesn’t happen at midday with the Sun conveniently overhead, but <strong>late in the evening, with the Sun a handful of degrees above the horizon</strong>: in a valley, behind a ridge or among blocks of flats, the obstacle gets the show. On a delta plain there is no obstacle.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: '<strong>Punta del Fangar</strong> is the northern tip of the delta, in the municipality of <strong>Deltebre (Tarragona)</strong>: an arrow of sand several kilometres long that curves west and encloses the <strong>bahía del Fangar</strong>, with the open Mediterranean on the outer face and shallow, warm water inside. The whole area lies within the <strong>Parc Natural del Delta de l’Ebre</strong>, designated in <strong>1983</strong>, and within the zone <strong>UNESCO</strong> recognised as the <strong>Terres de l’Ebre Biosphere Reserve in 2013</strong>. One figure explains the rest: the delta is a platform of river sediment with an <strong>average elevation of under one metre above sea level</strong>. There is no hill, no bank, no tall pine wood. The closest thing to a feature in the terrain is the dune field on the spit itself.' },
        { t: 'p', html: 'Three facts about the eclipse are worth holding on to, and no assumptions. First: <strong>the path of totality does not cover the whole country</strong>. It is a band crossing Spain diagonally, and a few kilometres too far leaves you with a partial eclipse — nothing like the real thing — instead of totality. Spain’s <strong>Instituto Geográfico Nacional</strong> and its <strong>Observatorio Astronómico Nacional</strong> publish the official map with the track and municipality-by-municipality timings: it is the only source worth checking before picking a spot, and you should check the exact point, not the province. Second: here totality falls <strong>at around 20:30 (mainland Spanish time)</strong>, with the partial phases starting over an hour earlier, and it <strong>lasts under two minutes</strong> anywhere in Spain. Third, the one that decides where you stand: <strong>the Sun will be very low</strong>, only a few degrees up. A ridge ten kilometres away, a four-storey building or a line of eucalyptus is enough to swallow the whole event.' },
        { t: 'p', html: 'Now the awkward part, and there is plenty of it. <strong>The delta is mosquito country</strong>, with flooded rice fields metres away and a dedicated public control service — run by the <strong>Consorci de Polítiques Ambientals de les Terres de l’Ebre</strong> — precisely because the nuisance is structural rather than occasional. Their peak hour is dusk: the same hour as the eclipse. Second warning: <strong>there is nothing out on the spit</strong> — no bar, no drinking water, no toilets, no lifeguard, no lighting for the walk back. Third: parts of the Fangar are <strong>bird nesting grounds</strong>, with sections roped off or closed depending on the season and vehicle access regulated; the sand is fine and soft, and cars get properly stuck out there every summer, so the sensible move is to park where signposted and walk. Fourth: water levels here are driven by wind and pressure rather than by the astronomical tide, which amounts to centimetres, and an easterly pushes the sea wherever it likes. And fifth, the non-negotiable one: <strong>looking at the Sun requires eclipse glasses certified to ISO 12312-2</strong>. Sunglasses, X-ray film, smoked glass and a phone screen do not work and will hurt you. Only during the seconds of totality — and only then — do you look with the naked eye.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> Today, arriving in daylight and with time to spare. The Fangar spit is walked, not driven, and soft sand is tiring, so being in position two hours ahead avoids the classic mistake of hunting for a spot with the Sun already bitten into. There is only one criterion for choosing where to stand: <strong>face west and check nothing is in the way</strong>, not a hut, not a row of reeds. Two things to check before leaving: the <strong>IGN</strong> map, to confirm the spot sits inside the band, and the cloud forecast from <strong>AEMET</strong> — because the real enemy of this eclipse isn’t rain but <strong>a thin band of low cloud or haze sitting on the western horizon</strong>, invisible at midday and quite enough to hide the Sun at 20:30. With the Sun this low, the weather in the last degree of sky matters more than the weather all day.' },
        { t: 'p', html: '<strong>When not to?</strong> If the plan is to add a swim and a full beach day, this is the wrong place: the bay is shallow, the bottom is muddy and dotted with mussel beds, and the water is not the point today. Nor if you are bringing small children without repellent and long sleeves, or planning to walk back across the sand in the dark without a torch. And there is a perfectly legitimate alternative worth saying out loud: <strong>being inside the band matters far more than being on a beach</strong>. A flat stubble field inland in the Terres de l’Ebre, a viewpoint with a clear western aspect or any open ground within the path of totality will serve as well or better than handsome sand with a ridge in front of it. The beach supplies a clean horizon; if the horizon is clean, the sand is optional.' },
        { t: 'ul', items: [
          'ISO 12312-2 certified glasses, one per person, bought in advance — today they sell out.',
          'Mosquito repellent and thin long sleeves for dusk.',
          'A torch or head-lamp for the walk back, red light if you have it.',
          'Water and food: there are no facilities on the spit.',
          'Closed shoes for soft sand — and don’t drive the car where it isn’t allowed.',
        ] },
        { t: 'quote', text: 'The delta works as a viewing platform not because it has height but for the opposite reason: because it has none. For two minutes, the lowest ground in Catalonia will be the best seat going.' },
        { t: 'p', html: 'What happens next doesn’t photograph well. The light in the final half hour turns metallic, the temperature drops sharply, the birds across the bay fall quiet and the mussel beds sit still on water that has stopped reflecting anything. And then, above the rice fields, a black hole with a ring around it appears at roughly roof height. It lasts a little over a minute. Then the Sun returns at the edge, the glasses go back on, the mosquitoes carry on regardless and you walk back across the sand with a torch in your hand. Check the map before you set off: a few kilometres on it are all that separates the eclipse of a lifetime from a strange-looking sunset.' },
      ],
      faq: [
        { q: 'Can you see the total eclipse of 12 August 2026 from the Ebro Delta?', a: 'The Ebro Delta lies within the path of totality crossing northern and north-eastern Spain, but the band is narrow relative to the country and a few kilometres decide between totality and a partial eclipse. Before choosing a spot, check the exact location on the official map published by Spain’s Instituto Geográfico Nacional and Observatorio Astronómico Nacional, which also gives timings for each municipality. In this area totality falls at around 20:30 mainland Spanish time and lasts under two minutes.' },
        { q: 'Why is a flat beach a better bet than a high viewpoint for this eclipse?', a: 'Because this eclipse happens with the Sun very low, a few degrees above the horizon, rather than high in the sky. What matters is not how high you stand but that nothing sits in the western direction: a ridge ten kilometres off, a block of flats or a line of trees can hide the whole event. The Ebro Delta has an average elevation of under a metre above sea level and barely any building, so the horizon stays clear.' },
        { q: 'What should you take to Punta del Fangar, and what precautions apply?', a: 'Eclipse glasses certified to ISO 12312-2 (sunglasses, X-ray film or a phone camera offer no protection; only during the seconds of totality can you look with the naked eye), mosquito repellent and long sleeves, because dusk over the rice fields is peak biting hour, a torch for the walk back, plus water and food. There is no bar, drinking water, toilet or lifeguard out on the spit. It sits inside the Parc Natural del Delta de l’Ebre, with roped-off nesting areas and regulated vehicle access, so park where signposted and continue on foot — the sand is soft and traps cars.' },
      ],
    },
  },
  // ───── Diario de playas · Playa de Nogales (voz bicéfala) ─────
  {
    slug: 'playa-de-nogales-puntallana-la-palma-sendero-arena-negra',
    category: 'guias',
    title: '20 minutos de bajada a Nogales (La Palma): arena negra, mar de fondo y cuesta al volver',
    excerpt:
      'Una de las pocas playas grandes de la vertiente este de La Palma, al pie de un acantilado y con arena de basalto. La letra pequeña: se llega por un sendero empinado que hay que desandar cuesta arriba, el suelo negro quema a mediodía y no hay socorrista al que recurrir.',
    heroAlt:
      'Playa de Nogales, en Puntallana (La Palma): orilla de arena volcánica negra con una ola del Atlántico rompiendo en espuma y mar de fondo llegando desde el horizonte, sin nadie en la playa',
    heroQuery: 'nogales,puntallana,la palma,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-31T07:48:05Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'El coche se queda arriba, en una explanada al borde del cantil, y desde ahí la playa se ve entera: una franja oscura encajada entre la pared del acantilado y el Atlántico, con las olas llegando en líneas paralelas y ni un edificio en kilómetros. Parece cerca. Lo está, en línea recta. Lo que no se aprecia desde el mirador es el desnivel que hay entre ese borde y la arena, ni que el camino de vuelta se hace con el sol ya alto.' },
      { t: 'p', html: 'Esto es <strong>Puntallana</strong>, en la vertiente este de <strong>La Palma</strong>, una isla que emergió del Atlántico hace relativamente poco en términos geológicos y que todavía se nota joven: barrancos profundos, costa cortada a pico y muy pocas playas amplias. Toda la isla es <strong>Reserva de la Biosfera de la UNESCO desde 2002</strong>, y su cielo está protegido por ley desde <strong>1988</strong> para no estropear los telescopios del Roque de los Muchachos. La <strong>Playa de Nogales</strong> queda ahí abajo, al pie del barranco del mismo nombre, y es de las poquísimas de este lado de la isla donde hay arena de verdad y no un callao imposible.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Nogales pertenece al municipio de <strong>Puntallana (La Palma)</strong> y está a una decena de kilómetros de <strong>Santa Cruz de La Palma</strong> por la LP-1. Se llega en coche hasta un <strong>aparcamiento en lo alto del acantilado</strong>, con mirador incluido, y a partir de ahí <strong>solo se continúa a pie</strong>: un sendero de tierra y escalones de piedra que baja pegado a la ladera y que se hace en <strong>quince o veinte minutos</strong> según el paso. La bajada es cómoda; el problema es que la única salida es la misma cuesta, y de subida cambia bastante de carácter. Abajo <strong>no hay absolutamente nada</strong>: ni chiringuito, ni duchas, ni papeleras, ni socorrista, ni una fuente. Tampoco tiene <strong>Bandera Azul</strong> ni puede optar a ella, porque el distintivo de <strong>ADEAC</strong> exige servicios y vigilancia; las de la isla se concentran en playas urbanas como <strong>Los Cancajos</strong>.' },
      { t: 'p', html: 'El segundo dato es el que sorprende a quien llega de una playa peninsular: <strong>la arena de Nogales es negra</strong>, de basalto molido por el mar, y eso no es solo una cuestión de foto. Un suelo oscuro absorbe mucha más radiación solar que una arena clara, así que <strong>a mediodía quema de verdad</strong> —caminar descalzo del agua a la toalla en agosto es un ejercicio de fe— y el calor que devuelve se nota tumbado encima. Las chanclas o los escarpines dejan de ser un accesorio. El segundo matiz es de tamaño: es una playa de <strong>marea viva atlántica</strong>, con un rango de un par de metros largos, y <strong>con la marea alta la franja de arena seca se reduce mucho</strong>. Y el tercero, contraintuitivo: mira al este, de modo que el sol pega de frente a primera hora pero <strong>desaparece pronto por detrás del acantilado</strong>. Aquí no hay atardecer sobre el mar; hay sombra brusca a media tarde.' },
      { t: 'p', html: 'El tercero es el que conviene tomarse en serio. Nogales está <strong>abierta al Atlántico norte</strong>, sin nada que la resguarde. Domina el <strong>alisio del nordeste</strong>, que sopla de costado y levanta ola corta, y de tanto en tanto llega el <strong>mar de leva</strong>: el mar de fondo del norte que se genera a miles de kilómetros y rompe aquí con fuerza aunque el día amanezca en calma. El fondo baja rápido, hay corrientes de salida y <strong>no hay ni socorrista ni bandera</strong> que avise de nada. No es una advertencia retórica: los informes anuales de la <strong>Real Federación Española de Salvamento y Socorrismo</strong> sitúan a Canarias, año tras año, a la cabeza de ahogamientos en España, y la inmensa mayoría ocurren en <strong>espacios sin vigilancia</strong> como este. Añade un detalle que casi nadie menciona: se está al pie de una pared de roca alta, así que <strong>no conviene instalarse pegado al cantil</strong>, sobre todo después de lluvias.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Con el mar en calma y <strong>temprano</strong>. El plan que funciona es bajar sobre las nueve, aprovechar el agua tranquila y las primeras horas, y <strong>emprender la subida antes de que apriete el sol</strong>: la cuesta con treinta grados y la arena negra irradiando detrás es otra historia. <strong>Mayo, junio y octubre</strong> salen mejor que agosto: el Atlántico canario se mantiene templado casi todo el año y hay menos gente en el sendero y en el aparcamiento, que es pequeño. Antes de salir de casa merece la pena mirar la <strong>predicción de oleaje y los avisos por fenómenos costeros de AEMET</strong> y el parte de <strong>Puertos del Estado</strong>; si hay aviso, se cambia de plan sin discutirlo. Y como no hay dónde comprar nada: agua de sobra, comida, calzado con suela decente, sombrilla propia si se quiere sombra antes de que la ponga el acantilado, y una bolsa para bajar la basura de vuelta.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Con <strong>mar de leva</strong> o alisio fuerte, cuando la orilla se convierte en un sitio donde ni acercarse a mojarse los pies: las olas suben mucho más de lo que parece desde arriba y no hay nadie mirando. Tampoco con <strong>niños pequeños</strong>, con carrito, con movilidad reducida o con problemas de rodilla: el sendero no admite negociación, no hay acceso rodado y no existe un plan B para subir. Y si se duda de la cuesta, mejor no bajarla. ¿La alternativa? <strong>Los Cancajos</strong>, junto a Santa Cruz, resuelve el día de arena negra con socorrista, servicios y aparcamiento a pie de playa. Y cuando el norte está movido, la respuesta canónica de la isla no es otra playa sino las <strong>piscinas naturales</strong>: <strong>La Fajana</strong>, en Barlovento, o <strong>Charco Azul</strong>, en San Andrés y Sauces, permiten bañarse con el mar bravo justo al otro lado del muro de roca.' },
      { t: 'quote', text: 'No está intacta porque nadie la haya encontrado —lleva décadas en todas las guías de la isla—, sino porque construir aquí abajo exigiría partir el acantilado. La incomodidad del sendero es lo único que la mantiene así.' },
      { t: 'p', html: 'A media tarde, cuando la sombra del acantilado cae de golpe sobre la arena y el calor se va con ella, Nogales se queda en lo que es: una muesca negra al pie de una pared verde, el Atlántico entrando en líneas ordenadas y el murmullo del barranco detrás. Luego toca la cuesta, que se sube despacio y parando, y desde el mirador de arriba la playa vuelve a verse pequeña y limpia, como si no acabaras de estar en ella. Mira el parte, baja pronto y súbete la basura. Esta playa no da facilidades: da una de las pocas orillas de arena que le quedan a este lado de la isla, y la cobra en desnivel.' },
    ],
    faq: [
      { q: '¿Cómo se llega a la Playa de Nogales y se puede bajar en coche?', a: 'No. Se conduce hasta un aparcamiento en lo alto del acantilado, en Puntallana, a unos diez kilómetros de Santa Cruz de La Palma por la LP-1, y desde ahí el único acceso es un sendero de tierra y escalones de piedra que baja en unos quince o veinte minutos. La bajada es sencilla; la subida es exigente, sobre todo con calor. No hay acceso rodado ni alternativa para carritos o movilidad reducida.' },
      { q: '¿Es segura para bañarse?', a: 'Depende del día y hay que decidirlo con información. Es una playa abierta al Atlántico norte, sin resguardo, con fondo que baja rápido, corrientes de salida y episodios de mar de fondo (el llamado mar de leva) que rompen con fuerza aunque el día parezca tranquilo. No hay socorrista ni banderas. Conviene consultar antes la predicción de oleaje y los avisos por fenómenos costeros de AEMET o Puertos del Estado, y renunciar al baño si el mar está movido.' },
      { q: '¿Por qué la arena es negra y qué implica en la práctica?', a: 'Porque procede de roca basáltica volcánica erosionada por el mar, como en buena parte de Canarias. En la práctica implica que el suelo absorbe mucha más radiación solar que una arena clara y a mediodía quema: conviene llevar chanclas o escarpines. Además no hay sombra natural sobre la arena hasta que el propio acantilado la proyecta a media tarde, así que hay que llevar sombrilla, agua y comida, porque abajo no hay ningún servicio.' },
    ],
    en: {
      title: 'Nogales (La Palma): a 20-minute path down to black sand — and a climb back up',
      excerpt:
        'One of the few sizeable beaches on the eastern side of La Palma, at the foot of a cliff and made of basalt sand. The small print: a steep path in that you have to walk back up, black sand that burns by midday, and no lifeguard to call on.',
      related: [
        { href: '/en/islands', label: 'Island beaches' },
        { href: '/en/magazine', label: 'More from the Magazine' },
      ],
      body: [
        { t: 'p', html: 'The car stays up top, on a levelled patch at the cliff edge, and from there you can see the whole beach: a dark strip wedged between the cliff face and the Atlantic, waves arriving in parallel lines, not a building for miles. It looks close. In a straight line, it is. What the viewpoint doesn’t convey is the drop between that edge and the sand — or that the walk back happens with the sun already high.' },
        { t: 'p', html: 'This is <strong>Puntallana</strong>, on the eastern flank of <strong>La Palma</strong>, an island that rose out of the Atlantic fairly recently in geological terms and still shows it: deep ravines, a coast cut sheer, and very few broad beaches. The whole island has been a <strong>UNESCO Biosphere Reserve since 2002</strong>, and its night sky has been protected by law since <strong>1988</strong> to keep the telescopes on the Roque de los Muchachos working. <strong>Playa de Nogales</strong> lies down there, at the mouth of the ravine of the same name, and it is one of the very few places on this side of the island with actual sand rather than unwalkable cobbles.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'Nogales belongs to the municipality of <strong>Puntallana (La Palma)</strong> and sits about ten kilometres from <strong>Santa Cruz de La Palma</strong> along the LP-1. You drive as far as a <strong>car park on top of the cliff</strong>, viewpoint included, and from there it is <strong>on foot only</strong>: a path of packed earth and stone steps hugging the slope, fifteen to twenty minutes depending on your pace. Going down is easy; the catch is that the only way out is that same slope, and uphill it is a different proposition. Down on the sand there is <strong>nothing at all</strong>: no beach bar, no showers, no bins, no lifeguard, no drinking water. Nor does it hold a <strong>Blue Flag</strong>, and it cannot — the <strong>ADEAC</strong> award requires facilities and supervision, which is why the island’s flags cluster on town beaches such as <strong>Los Cancajos</strong>.' },
        { t: 'p', html: 'The second fact catches out anyone arriving from a mainland beach: <strong>the sand at Nogales is black</strong>, basalt ground down by the sea, and that is more than a photogenic detail. Dark ground absorbs far more solar radiation than pale sand, so <strong>by midday it genuinely burns</strong> — crossing from the water to your towel barefoot in August is an act of faith — and you feel the heat coming back up through the towel. Flip-flops or water shoes stop being optional. The second wrinkle is size: this is an <strong>Atlantic tidal beach</strong> with a range of a good couple of metres, and <strong>at high water the band of dry sand shrinks considerably</strong>. The third is counter-intuitive: it faces east, so the sun is straight ahead first thing but <strong>vanishes early behind the cliff</strong>. There is no sunset over the sea here — there is an abrupt block of shade by mid-afternoon.' },
        { t: 'p', html: 'The third is the one to take seriously. Nogales is <strong>wide open to the north Atlantic</strong>, with nothing to shelter it. The <strong>north-easterly trade wind</strong> dominates, blowing across the bay and kicking up a short chop, and every so often the <strong>mar de leva</strong> arrives: north Atlantic ground swell generated thousands of kilometres away that breaks hard here even when the day dawns calm. The bottom shelves quickly, there are outgoing currents, and <strong>there is no lifeguard and no flag</strong> to warn you of any of it. This is not rhetorical: the annual reports of Spain’s <strong>lifesaving federation (RFESS)</strong> put the Canaries at the top of the national drowning figures year after year, with the great majority occurring at <strong>unsupervised spots</strong> exactly like this one. One more thing few people mention: you are sitting beneath a tall rock face, so <strong>it is unwise to settle right against the cliff</strong>, particularly after rain.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> On a calm sea, and <strong>early</strong>. The plan that works is to walk down around nine, take the quiet water and the first hours of the day, and <strong>start back up before the sun bites</strong>: that climb at thirty degrees, with black sand radiating behind you, is another matter entirely. <strong>May, June and October</strong> beat August: the Canary Atlantic stays mild almost year-round, and there are fewer people on the path and in the small car park. Before leaving, it is worth checking the <strong>swell forecast and coastal warnings from AEMET</strong> and the <strong>Puertos del Estado</strong> bulletin; if there is a warning, change the plan and don’t argue with it. And since there is nowhere to buy anything: plenty of water, food, footwear with a proper sole, your own parasol if you want shade before the cliff provides it, and a bag to carry your rubbish back up.' },
        { t: 'p', html: '<strong>When not to?</strong> With <strong>mar de leva</strong> running or a stiff trade wind, when the shoreline becomes somewhere you shouldn’t even paddle: the waves run much further up than they appear from above, and nobody is watching. Nor with <strong>small children</strong>, a pushchair, restricted mobility or dodgy knees — the path is non-negotiable, there is no vehicle access and no plan B for getting out. If you doubt the climb, don’t make the descent. The alternative? <strong>Los Cancajos</strong>, beside Santa Cruz, delivers the black-sand day with lifeguards, facilities and parking at beach level. And when the north is up, the island’s standard answer isn’t another beach but the <strong>natural sea pools</strong>: <strong>La Fajana</strong> at Barlovento, or <strong>Charco Azul</strong> at San Andrés y Sauces, where you can swim with a rough sea breaking just the other side of the rock wall.' },
        { t: 'quote', text: 'It isn’t untouched because nobody has found it — it has been in every island guide for decades — but because building down here would mean cutting into the cliff. The inconvenience of that path is the only thing keeping it as it is.' },
        { t: 'p', html: 'By mid-afternoon, when the cliff’s shadow drops over the sand all at once and the heat goes with it, Nogales settles into what it is: a black notch at the foot of a green wall, the Atlantic arriving in orderly lines, the ravine murmuring behind. Then comes the climb, taken slowly and with stops, and from the viewpoint at the top the beach looks small and tidy again, as if you hadn’t just been standing on it. Check the forecast, go down early, carry your rubbish out. This beach offers no comfort: it offers one of the few sand shorelines left on this side of the island, and it charges for it in vertical metres.' },
      ],
      faq: [
        { q: 'How do you get to Playa de Nogales — can you drive down?', a: 'No. You drive to a car park on top of the cliff in Puntallana, about ten kilometres from Santa Cruz de La Palma on the LP-1, and from there the only way in is a path of packed earth and stone steps that takes fifteen to twenty minutes. Going down is straightforward; coming back up is demanding, especially in the heat. There is no vehicle access and no alternative route for pushchairs or reduced mobility.' },
        { q: 'Is it safe to swim there?', a: 'It depends on the day, and it is a decision to make with information in hand. The beach is wide open to the north Atlantic with no shelter, the bottom shelves quickly, there are outgoing currents, and episodes of ground swell — the local mar de leva — break hard even when the day looks calm. There is no lifeguard and there are no flags. Check the swell forecast and coastal warnings from AEMET or Puertos del Estado beforehand, and skip the swim if the sea is up.' },
        { q: 'Why is the sand black, and what does that mean in practice?', a: 'Because it comes from eroded volcanic basalt, as across much of the Canaries. In practice it means the ground absorbs far more solar radiation than pale sand and genuinely burns by midday, so bring flip-flops or water shoes. There is also no natural shade on the sand until the cliff itself casts it in mid-afternoon, so bring a parasol, water and food — there are no facilities whatsoever down there.' },
      ],
    },
  },
  // ───── Diario de playas · Praia do Rostro (voz bicéfala) ─────
  {
    slug: 'praia-do-rostro-fisterra-a-coruna-resaca-agua-fria',
    category: 'curiosidades',
    title: 'Praia do Rostro (Fisterra): 2 km de arena con resaca atlántica y agua bajo 18°C',
    excerpt:
      'Dos kilómetros de arena abierta al Atlántico en plena Costa da Morte, a un paso del faro de Fisterra. La letra pequeña do Rostro: corrientes de resaca serias, agua enfriada por el afloramiento del nordés, cero servicios y ningún socorrista al que llamar.',
    heroAlt:
      'Praia do Rostro, en Fisterra (A Coruña): arenal largo y vacío abierto al Atlántico en la Costa da Morte, con oleaje rompiendo y dunas bajas cubiertas de vegetación',
    heroQuery: 'praia do rostro,fisterra,galicia,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-27T12:08:21Z',
    readingMin: 5,
    related: [
      { href: '/comunidad/galicia', label: 'Playas de Galicia' },
      { href: '/playas-secretas', label: 'Playas y calas poco masificadas' },
    ...
    body: [
      { t: 'p', html: 'La pista sale de la carretera que sube de Fisterra hacia Cee, se hunde entre tojos y eucaliptos y, mucho antes de que aparezca el mar, ya se oye. Es un ruido continuo, grave, que no se parece al de una playa de verano. Cuando el camino se abre por fin, abajo hay dos kilómetros largos de arena sin una sola sombrilla, sin una sola casa, sin nada: solo el Atlántico entrando en líneas blancas hasta perderse en el otro extremo del arenal.' },
      { t: 'p', html: 'Estamos en la <strong>Costa da Morte</strong>, a menos de media hora andando del cabo que durante siglos se tuvo por el final de la tierra conocida, y el topónimo no es literatura: esta costa se ganó el nombre a base de naufragios. Por encima de la playa pasa el <strong>Camiño dos Faros</strong>, el sendero que une Malpica con Fisterra, y buena parte de quienes pisan Rostro lo hacen de paso, con la mochila puesta. Conviene saber una cosa antes de bajar: aquí el mar no invita, avisa.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Praia do Rostro pertenece al concello de <strong>Fisterra (A Coruña)</strong> y ocupa la fachada oeste de la península fisterrana, mirando al <strong>océano abierto</strong> sin una isla, un cabo ni un dique que la resguarden. Son unos <strong>dos kilómetros de arena gruesa y dorada</strong> con dunas bajas detrás, a los que se llega por una <strong>pista de tierra</strong> que sale de la carretera AC-445 y muere en una explanada sin asfaltar. De servicios, ninguno: <strong>ni chiringuito, ni duchas, ni papeleras, ni socorrista</strong>. Tampoco tiene <strong>Bandera Azul</strong> ni puede tenerla, porque el distintivo de ADEAC exige instalaciones y vigilancia que aquí no existen.' },
      { t: 'p', html: 'El segundo dato es el que descoloca a quien llega en pleno agosto con la toalla bajo el brazo: <strong>el agua está fría, y no por casualidad</strong>. En verano domina el <strong>nordés</strong>, el viento seco del noreste que en esta costa sopla días enteros. Ese viento empuja el agua superficial mar adentro y deja subir agua profunda en su lugar —el <strong>afloramiento costero</strong> que hace tan rica la pesca gallega—, de modo que la temperatura de superficie se queda muy por debajo de la de otras costas españolas: en la Costa da Morte lo normal en agosto es moverse en la <strong>franja de los 14 a los 17°C</strong>, no en los 24°C del Mediterráneo. Los partes de <strong>MeteoGalicia y Puertos del Estado</strong> lo confirman verano tras verano.' },
      { t: 'p', html: 'Y el tercero es el serio. Rostro está expuesta de lleno al <strong>mar de fondo del noroeste</strong>, el que llega hecho y derecho desde el Atlántico norte y rompe en la orilla con fuerza incluso en días de calma aparente. Eso genera <strong>corrientes de resaca</strong> —canales de agua que salen hacia fuera entre las rompientes— y un fondo que cambia con cada temporal. Es un arenal apreciado por surfistas con experiencia y desaconsejado para el baño recreativo: aquí <strong>no hay bandera que te avise ni nadie a quien pedir ayuda</strong>, y el móvil no siempre tiene cobertura decente. Añade que <strong>no hay una sola sombra natural</strong> y que el nordés levanta la arena y la lanza a ras de suelo: un día de viento apretado, la playa se vuelve incómoda hasta para estar tumbado.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Cuando se va a lo que de verdad ofrece: caminar, mirar y hacer fotos. Rostro se disfruta a pie, con <strong>marea bajando</strong> —que deja una franja ancha de arena firme para recorrerla entera— y a última hora de la tarde, porque mira al oeste y el sol se pone justo enfrente. Antes de salir, mira el <strong>parte de oleaje y viento</strong> (MeteoGalicia, Puertos del Estado o cualquier app de olas): con menos de un metro de mar de fondo y nordés flojo, el arenal está en su mejor versión. <strong>Septiembre y octubre</strong> son los mejores meses; el agua no ha bajado aún y el viento suele aflojar. Y si vienes andando la última etapa del Camiño dos Faros, calzado agarrado y agua encima: no hay dónde comprar nada.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Cualquier día con <strong>mar de fondo del noroeste</strong> por encima de metro y medio, que es media temporada de invierno y bastantes días de verano: entonces la orilla es un lugar donde ni siquiera conviene acercarse a mojarse los pies, porque las olas suben mucho más de lo que parece desde la arena seca. Tampoco es plan con niños pequeños que quieran bañarse, ni con la idea de pasar un día de playa clásico de sombrilla y nevera. ¿La alternativa? A cinco minutos en coche, la <strong>praia da Langosteira</strong>, en el otro lado de la península, mira a la ría de Corcubión y está resguardada del oleaje del oeste: allí sí hay arena tranquila, servicios y paseo. Sardiñeiro cumple el mismo papel. Deja Rostro para el atardecer, cuando ya no toca bañarse.' },
      { t: 'quote', text: 'No es una playa virgen que hayas descubierto tú: es una playa que ningún ayuntamiento se ha atrevido a domesticar. La diferencia está en que aquí, si te pasa algo en el agua, no hay nadie mirando.' },
      { t: 'p', html: 'Al caer la tarde, con el sol metiéndose en el mismo horizonte al que los romanos pusieron nombre de final, Rostro se queda en lo que siempre ha sido: dos kilómetros de arena barrida por el viento, un rumor que no para y las huellas de cuatro caminantes borrándose solas. Mira el parte, baja con la marea saliendo, camina hasta el otro extremo y quédate a ver ponerse el sol. Pero entra en el agua solo si sabes exactamente lo que estás haciendo, porque esta playa no promete un baño: promete el Atlántico entero, que no es lo mismo.' },
    ],
    faq: [
      { q: '¿Se puede uno bañar en Praia do Rostro?', a: 'Con muchísima precaución y solo si nadas bien y el mar está en calma. Es una playa abierta al Atlántico, con oleaje de fondo del noroeste, corrientes de resaca y sin socorrista ni bandera de aviso. Los días de mar de fondo el baño está claramente desaconsejado: es un arenal para caminar y para surfistas con experiencia, no para un chapuzón familiar.' },
      { q: '¿Por qué está el agua tan fría en verano en la Costa da Morte?', a: 'Por el afloramiento costero. El nordés, el viento del noreste que domina el verano gallego, empuja el agua de superficie mar adentro y deja subir agua profunda y fría en su lugar. Eso mantiene la temperatura del mar en la franja aproximada de los 14 a los 17°C incluso en agosto, muy por debajo de la del Mediterráneo. Es el mismo fenómeno que hace tan rica la pesca en Galicia.' },
      { q: '¿Cómo se llega y qué servicios hay?', a: 'Se accede por una pista de tierra que sale de la carretera AC-445 entre Fisterra y Cee, y que termina en una explanada sin asfaltar junto a las dunas. También pasa por encima el Camiño dos Faros. No hay chiringuito, duchas, papeleras ni socorrista, ni Bandera Azul, así que hay que llevar agua, comida y sombra, y devolver la basura.' },
    ],
    en: {
      title: 'Praia do Rostro (Fisterra): 2km of sand, Atlantic rips and water below 18°C',
      excerpt:
        'Two kilometres of sand wide open to the Atlantic on the Costa da Morte, a short walk from the Fisterra lighthouse. The small print at Rostro: serious rip currents, water chilled by wind-driven upwelling, no services at all and no lifeguard to call on.',
      related: [
        { href: '/en/crystal-clear-water-beaches', label: 'Crystal-clear water beaches' },
        { href: '/en/magazine', label: 'More from the Magazine' },
      ],
      body: [
        { t: 'p', html: 'The track leaves the road climbing from Fisterra towards Cee, sinks between gorse and eucalyptus and, long before the sea appears, you can hear it. A steady, low roar, nothing like the sound of a summer beach. When the path finally opens out, below you lie a good two kilometres of sand without a single parasol, without a single house, without anything at all: just the Atlantic coming in in white lines until it fades at the far end.' },
        { t: 'p', html: 'This is the <strong>Costa da Morte</strong>, the coast of death, less than half an hour on foot from the cape long taken to be the end of the known world — and the name isn’t literature: this shoreline earned it through shipwrecks. The <strong>Camiño dos Faros</strong>, the waymarked path linking Malpica to Fisterra, runs above the beach, and many of those who set foot on Rostro are simply passing through with a rucksack on. Worth knowing before you walk down: here the sea doesn’t invite you in, it warns you off.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'Praia do Rostro sits in the municipality of <strong>Fisterra (A Coruña)</strong>, along the western face of the Fisterra peninsula, facing the <strong>open ocean</strong> with no island, headland or breakwater to shelter it. It is some <strong>two kilometres of coarse golden sand</strong> backed by low dunes, reached by a <strong>dirt track</strong> off the AC-445 that ends in an unsurfaced clearing. Services: none. <strong>No beach bar, no showers, no bins, no lifeguard.</strong> Nor does it hold a <strong>Blue Flag</strong>, and it can’t — the ADEAC award requires facilities and supervision that simply don’t exist here.' },
        { t: 'p', html: 'The second fact is the one that throws anyone arriving in August with a towel under their arm: <strong>the water is cold, and not by accident</strong>. Summer here is ruled by the <strong>nordés</strong>, the dry north-easterly that blows for days on end along this coast. It pushes surface water out to sea and lets deep water rise in its place — the <strong>coastal upwelling</strong> that makes Galician fishing so rich — so sea surface temperatures stay well below those elsewhere in Spain: on the Costa da Morte, August typically means <strong>somewhere between 14 and 17°C</strong>, not the 24°C of the Mediterranean. <strong>MeteoGalicia and Puertos del Estado</strong> data bear this out summer after summer.' },
        { t: 'p', html: 'And the third is the serious one. Rostro is fully exposed to <strong>north-westerly ground swell</strong>, the sort that arrives fully formed from the north Atlantic and breaks hard on the shore even on apparently calm days. That sets up <strong>rip currents</strong> — channels of water running back out between the breakers — over a bottom that shifts with every storm. It’s a beach prized by experienced surfers and a poor bet for casual swimming: there is <strong>no flag to warn you and no one to call for help</strong>, and mobile coverage is patchy. Add that there is <strong>not a scrap of natural shade</strong>, and that the nordés picks the sand up and fires it along the ground: on a stiff windy day, this beach is uncomfortable even lying down.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> When you come for what it actually offers: walking, looking and photographs. Rostro works on foot, with a <strong>falling tide</strong> — which leaves a broad band of firm sand to walk end to end — and late in the day, since it faces west and the sun sets straight ahead. Before setting off, check the <strong>swell and wind forecast</strong> (MeteoGalicia, Puertos del Estado or any surf app): under a metre of ground swell and a light nordés, the beach is at its best. <strong>September and October</strong> are the pick of the year; the water hasn’t cooled further yet and the wind tends to ease. And if you arrive walking the final stage of the Camiño dos Faros, bring proper footwear and water: there is nowhere to buy anything.' },
        { t: 'p', html: '<strong>When not to?</strong> Any day with <strong>north-westerly ground swell</strong> over a metre and a half, which covers half the winter and plenty of summer days too: the shoreline then is no place to so much as paddle, because the waves run far further up than they look from the dry sand. Nor is it one for small children hoping to swim, or for a classic day of parasol and cool box. The alternative? Five minutes away by car, <strong>Praia da Langosteira</strong>, on the other side of the peninsula, faces the Corcubión estuary and is sheltered from the westerly swell: calm sand, services and a promenade. Sardiñeiro does the same job. Save Rostro for the evening, when swimming isn’t the point anyway.' },
        { t: 'quote', text: 'It isn’t an untouched beach you discovered: it’s a beach no council has dared to tame. The difference is that here, if something goes wrong in the water, nobody is watching.' },
        { t: 'p', html: 'As the afternoon fades, with the sun dropping into the very horizon the Romans named as the end of things, Rostro settles back into what it has always been: two kilometres of wind-scoured sand, a roar that never stops, and the prints of four walkers erasing themselves. Check the forecast, walk down on a falling tide, go the length of it and stay for the sunset. But get in the water only if you know exactly what you’re doing, because this beach doesn’t promise a swim: it promises the whole Atlantic, which is not the same thing.' },
      ],
      faq: [
        { q: 'Can you swim at Praia do Rostro?', a: 'Only with great care, and only if you are a strong swimmer and the sea is calm. It is wide open to the Atlantic, with north-westerly ground swell, rip currents and no lifeguard or warning flags. On days with ground swell running, swimming is clearly inadvisable: this is a beach for walking and for experienced surfers, not for a family dip.' },
        { q: 'Why is the sea so cold in summer on the Costa da Morte?', a: 'Because of coastal upwelling. The nordés, the north-easterly wind that dominates the Galician summer, pushes surface water out to sea and allows cold, deep water to rise in its place. That keeps sea temperatures roughly between 14 and 17°C even in August, far below the Mediterranean. It is the same process that makes Galician fishing so productive.' },
        { q: 'How do you get there and what facilities are on site?', a: 'Access is by a dirt track off the AC-445 between Fisterra and Cee, ending in an unsurfaced clearing beside the dunes. The Camiño dos Faros also passes above the beach. There is no beach bar, no showers, no bins, no lifeguard and no Blue Flag, so bring water, food and shade — and take your rubbish away with you.' },
      ],
    },
  },
  // ───── Diario de playas · Saturrarán (voz bicéfala) ─────
  {
    slug: 'playa-de-saturraran-mutriku-gipuzkoa-marea-alta-desaparece',
    category: 'curiosidades',
    title: 'Con la marea alta, Saturrarán (Mutriku) casi desaparece: ve con la mar bajando',
    excerpt:
      'Dos farallones de roca custodian un arenal de arena oscura en el límite entre Gipuzkoa y Bizkaia. La letra pequeña de Saturrarán: con pleamar el mar se come casi toda la playa, el Cantábrico ronda los 20°C, el aparcamiento es escaso y detrás estuvo una de las mayores cárceles de mujeres del franquismo.',
    heroAlt:
      'Playa de Saturrarán, en Mutriku (Gipuzkoa): arenal de arena oscura entre laderas verdes con dos grandes farallones de roca emergiendo del Cantábrico frente a la orilla',
    heroQuery: 'saturraran,mutriku,gipuzkoa,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-25T09:43:44Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'Se llega por la carretera que enlaza Mutriku con Ondarroa, un tramo de curvas colgado entre laderas verdes y el mar abierto, y en una revuelta el paisaje se abre: abajo, dos grandes farallones de roca clavados en el agua, y entre ellos y el pie del monte una lengua de arena oscura. No es un arenal cualquiera del norte; son esas dos rocas gemelas, plantadas frente a la orilla como dos centinelas, las que le dan la silueta que reconoce cualquiera que haya bajado alguna vez a Saturrarán.' },
      { t: 'p', html: 'Estamos en el <strong>límite exacto entre Gipuzkoa y Bizkaia</strong>, en el borde de la costa vasca del flysch, esa sucesión de acantilados en láminas de roca que va de Deba a Zumaia. Aquí no hay paseo marítimo ni bloques de apartamentos a pie de playa: hay pinos, un camping en la ladera, las dos rocas y un mar que decide, más que ningún otro factor, cómo va a ser tu día. Porque en Saturrarán el protagonista no es la arena. Es la marea.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Saturrarán pertenece al término de <strong>Mutriku (Gipuzkoa)</strong>, ya pegada a Ondarroa, dentro del entorno del <strong>Geoparque de la Costa Vasca</strong>. Y el dato que decide tu visita no es el color del agua ni la anchura del arenal: es el <strong>reloj de las mareas</strong>. Con <strong>marea alta el mar se come casi toda la playa</strong> y deja una franja de arena mínima al pie de la roca, apenas para tender la toalla; con <strong>bajamar</strong>, en cambio, se destapa un arenal amplio y de arena compacta entre los dos farallones. Ir sin mirar la tabla de mareas es la forma más segura de encontrarte una playa que casi no está.' },
      { t: 'p', html: 'El resto de la letra pequeña acompaña. El agua es <strong>Cantábrico abierto y frío</strong>: en pleno agosto rara vez pasa de los 19-20°C, y como mira al mar abierto, con <strong>mar de fondo del noroeste</strong> entra oleaje y se forman corrientes junto a las rocas, así que no es un baño para confiarse los días de mala mar. De servicios, lo justo: un <strong>bar de temporada</strong> ligado al camping, <strong>socorrista solo en temporada alta</strong> y un <strong>aparcamiento escaso</strong> que un día grande de verano se llena a media mañana —y entonces toca dejar el coche lejos, en Mutriku o en Ondarroa, y bajar andando—. Un apunte para quien llegue sin contexto: Saturrarán tiene, además, un <strong>tramo de tradición naturista</strong>.' },
      { t: 'p', html: 'Y hay una capa que no se ve desde la arena pero que conviene conocer. Detrás de esta playa, en un antiguo edificio de la ladera, funcionó en los primeros años cuarenta una de las <strong>mayores cárceles de mujeres del franquismo</strong>, la Prisión Central de Mujeres de Saturrarán. Por ella pasaron miles de presas en condiciones durísimas y se calcula que cientos murieron allí, muchas de ellas y sus bebés. Hoy un <strong>monumento en recuerdo de aquellas reclusas</strong> se levanta junto al acceso a la playa. No es un dato de folleto, pero explica por qué mucha gente de la zona no mira este sitio solo como un arenal bonito.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> Con la <strong>marea saliendo o baja</strong> y a primera hora, y mejor fuera del corazón de agosto. Consulta antes la <strong>tabla de mareas</strong> (Euskalmet, Puertos del Estado o cualquier app): bajas cuando el mar se retira, pillas arena de sobra entre las dos rocas, y evitas el doble problema de la pleamar de un domingo de verano —poca arena y aparcamiento lleno—. En junio, la primera mitad de julio y sobre todo en <strong>septiembre</strong> tienes el arenal medio vacío, el agua aún templada del verano y sitio para aparcar sin dramas.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Un mediodía de agosto con <strong>marea alta</strong>: te vas a encontrar cuatro metros de arena, gente amontonada contra la roca y el coche a un kilómetro. Tampoco con <strong>galerna</strong> o nortada apretada del noroeste, que revuelve el Cantábrico y levanta oleaje contra los farallones. El viento a vigilar es precisamente ese, el del norte-noroeste; con sur flojo, en cambio, el mar suele quedar más manso. ¿La alternativa si llegas y está en pleamar? A un paso tienes las playas de <strong>Ondarbeltz y Mutriku</strong> pueblo, y algo más allá el arenal de <strong>Deba</strong>, con más servicios y menos dependencia de la hora de la marea.' },
      { t: 'quote', text: 'No es una cala secreta que descubriste tú: es una playa que aparece y desaparece dos veces al día. Quien viene a mediodía en pleamar buscando tumbarse a lo ancho se ha equivocado de hora, no de sitio.' },
      { t: 'p', html: 'Al final de la tarde, cuando la marea se retira otra vez y deja la arena lisa y brillante entre las dos rocas, Saturrarán se entiende mejor. El Cantábrico va y viene sobre el mismo arenal que vio pasar tanto, borrando las huellas del día contra el pie del monte, indiferente a la hora y a la memoria. Mira la tabla de mareas, baja cuando el mar se aparta y quédate a ver cómo vuelve: entenderás por qué esta playa, más que verse, hay que saber cuándo pisarla.' },
    ],
    faq: [
      { q: '¿Por qué desaparece la playa de Saturrarán con la marea alta?', a: 'Porque es una playa estrecha encajada entre dos grandes farallones de roca y el pie del monte, sin apenas arena en la parte alta. Con pleamar el mar cubre casi todo el arenal y deja una franja mínima; con bajamar se abre una playa amplia y compacta. Por eso hay que consultar la tabla de mareas antes de ir: la diferencia entre una hora y otra es enorme.' },
      { q: '¿Qué servicios y aparcamiento tiene?', a: 'Los justos: un bar de temporada asociado al camping de la ladera y socorrista solo en temporada alta. El aparcamiento junto a la playa es escaso y se llena pronto los días grandes de verano; cuando se llena, toca aparcar en Mutriku o en Ondarroa y bajar andando. No esperes grandes servicios ni acceso cómodo.' },
      { q: '¿Es verdad que hubo una cárcel de mujeres en Saturrarán?', a: 'Sí. En un antiguo edificio de la ladera, tras la playa, funcionó en los primeros años cuarenta la Prisión Central de Mujeres de Saturrarán, una de las mayores cárceles femeninas del franquismo. Por ella pasaron miles de presas en condiciones durísimas y cientos murieron allí. Hoy hay un monumento junto al acceso a la playa en su memoria.' },
    ],
    en: {
      title: 'At high tide Saturrarán (Mutriku) all but vanishes — go on a falling sea',
      excerpt:
        'Two rock stacks guard a strip of dark sand on the border between Gipuzkoa and Bizkaia. The small print at Saturrarán: at high tide the sea swallows most of the beach, the Cantabrian hovers around 20°C, parking is scarce, and behind it stood one of the largest women’s prisons of the Franco era.',
      related: [
        { href: '/en/crystal-clear-water-beaches', label: 'Crystal-clear water beaches' },
        { href: '/en/magazine', label: 'More from the Magazine' },
      ],
      body: [
        { t: 'p', html: 'You come in on the road linking Mutriku with Ondarroa, a stretch of bends slung between green hillsides and the open sea, and on one turn the view opens up: below, two big rock stacks driven into the water, and between them and the foot of the hill a tongue of dark sand. This isn’t just another northern beach; it’s those twin rocks, planted in front of the shore like two sentinels, that give it the outline anyone who has ever walked down to Saturrarán will recognise.' },
        { t: 'p', html: 'We’re on the <strong>exact border between Gipuzkoa and Bizkaia</strong>, at the edge of the Basque flysch coast — that run of cliffs layered like sheets of rock stretching from Deba to Zumaia. There’s no promenade here, no blocks of flats at the water’s edge: there are pines, a campsite on the slope, the two rocks and a sea that decides, more than anything else, how your day will go. Because at Saturrarán the star isn’t the sand. It’s the tide.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'Saturrarán lies within <strong>Mutriku (Gipuzkoa)</strong>, right up against Ondarroa, within the setting of the <strong>Basque Coast Geopark</strong>. And the fact that decides your visit isn’t the colour of the water or the width of the sand: it’s the <strong>tide clock</strong>. At <strong>high tide the sea swallows almost the whole beach</strong>, leaving a minimal strip of sand at the foot of the rock, barely enough to lay a towel; at <strong>low tide</strong>, by contrast, a broad, firm expanse of sand opens up between the two stacks. Turning up without checking the tide table is the surest way to find a beach that’s barely there.' },
        { t: 'p', html: 'The rest of the small print follows. The water is <strong>open, cold Atlantic Cantabrian</strong>: even in high August it rarely tops 19-20°C, and because it faces the open sea, a <strong>north-westerly ground swell</strong> brings waves and sets up currents by the rocks, so it’s no swim to take lightly on a rough day. Services are minimal: a <strong>seasonal bar</strong> tied to the campsite, a <strong>lifeguard only in the high season</strong>, and <strong>scarce parking</strong> that fills by mid-morning on a big summer day — after which you leave the car far off, in Mutriku or Ondarroa, and walk down. One note for anyone arriving without context: Saturrarán also has a <strong>traditionally naturist stretch</strong>.' },
        { t: 'p', html: 'And there’s a layer you can’t see from the sand but ought to know. Behind this beach, in an old building on the hillside, one of the <strong>largest women’s prisons of the Franco dictatorship</strong> operated in the early 1940s — the Central Women’s Prison of Saturrarán. Thousands of women passed through it in brutal conditions, and it’s reckoned hundreds died there, many of them and their babies. Today a <strong>monument in memory of those prisoners</strong> stands by the beach access. It’s not a brochure fact, but it explains why many locals don’t see this place merely as a pretty stretch of sand.' },
        { t: 'h2', text: 'The local’s take', id: 'local' },
        { t: 'p', html: '<strong>When to go?</strong> With the <strong>tide falling or low</strong> and first thing, and ideally outside the heart of August. Check the <strong>tide table</strong> beforehand (Euskalmet, Puertos del Estado or any app): go down when the sea pulls back, get plenty of sand between the two rocks, and dodge the double trouble of a summer Sunday’s high tide — little sand and a full car park. In June, the first half of July and above all <strong>September</strong>, the beach is half-empty, the water still warm from summer and there’s room to park without a fuss.' },
        { t: 'p', html: '<strong>When not to?</strong> An August midday at <strong>high tide</strong>: you’ll find four metres of sand, people crammed against the rock and the car a kilometre away. Nor in a <strong>galerna</strong> (the Basque squall) or a stiff north-westerly, which churns the Cantabrian and throws swell against the stacks. That north-to-north-westerly is exactly the wind to watch; with a light southerly, by contrast, the sea tends to lie calmer. The alternative if you arrive at high water? A step away are the beaches of <strong>Ondarbeltz and Mutriku</strong> town, and a little further the sands of <strong>Deba</strong>, with more services and far less dependence on the hour of the tide.' },
        { t: 'quote', text: 'It isn’t a secret cove you discovered yourself: it’s a beach that appears and disappears twice a day. Anyone turning up at midday on a high tide hoping to stretch out has got the hour wrong, not the place.' },
        { t: 'p', html: 'Late in the afternoon, when the tide draws back again and leaves the sand smooth and gleaming between the two rocks, Saturrarán makes more sense. The Cantabrian comes and goes over the same stretch that has seen so much, wiping the day’s footprints away against the foot of the hill, indifferent to the hour and to memory. Check the tide table, go down when the sea steps aside and stay to watch it return: you’ll understand why this beach is less about seeing it than about knowing when to set foot on it.' },
      ],
      faq: [
        { q: 'Why does Saturrarán beach disappear at high tide?', a: 'Because it’s a narrow beach hemmed between two large rock stacks and the foot of the hill, with barely any sand higher up. At high tide the sea covers almost the whole beach, leaving a minimal strip; at low tide a broad, firm expanse opens up. That’s why you should check the tide table before going: the difference from one hour to the next is huge.' },
        { q: 'What services and parking does it have?', a: 'Minimal: a seasonal bar linked to the hillside campsite, and a lifeguard only in the high season. Parking beside the beach is scarce and fills early on big summer days; once it’s full you park in Mutriku or Ondarroa and walk down. Don’t expect full services or easy access.' },
        { q: 'Is it true there was a women’s prison at Saturrarán?', a: 'Yes. In an old building on the hillside behind the beach, the Central Women’s Prison of Saturrarán operated in the early 1940s, one of the largest women’s prisons of the Franco era. Thousands of women passed through it in brutal conditions and hundreds died there. Today a monument by the beach access stands in their memory.' },
      ],
    },
  },
  ...
  // ───── Diario de playas · Cuesta Maneli (voz bicéfala) ─────
  {
    ...
    category: 'rutas',
    title: 'Cuesta Maneli (Doñana): un kilómetro de pasarela hasta una playa sin sombra ni bar',
    excerpt:
      'A Cuesta Maneli no se baja en coche: se aparca en la A-494 y se cruza algo más de un kilómetro de pasarela de madera por las dunas de Doñana hasta la arena, al pie del acantilado naranja del Asperillo. La letra pequeña: ni un chiringuito, ni una sombra, socorrista contado y un Atlántico de resacas y viento que hay que respetar.',
    heroAlt:
      'Playa de Cuesta Maneli, en el Parque Natural de Doñana (Huelva): arenal ancho y abierto al Atlántico al pie del acantilado móvil del Asperillo, de arena ocre, con la pasarela de madera bajando entre dunas y enebros',
    heroQuery: 'cuesta maneli,asperillo,donana,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-23T14:23:35Z',
    readingMin: 5,
    related: [
      { href: '/comunidad/andalucia', label: 'Playas de Andalucía' },
      { href: '/playas-secretas', label: 'Playas y calas poco masificadas' },
    ...
    body: [
      { t: 'p', html: 'La carretera va recta entre pinos, sin mar a la vista. En algún punto de la A-494 entre Matalascañas y Mazagón hay un aparcamiento de tierra, un cartel de madera y el arranque de una pasarela que se mete hacia dentro, hacia arriba, entre enebros y sabinas. Se camina sin ver el agua un buen rato: primero el bosque bajo, después las dunas, y de pronto el suelo se abre y aparece de golpe un acantilado de arena color miel cayendo sobre una playa larga que no se acaba en ninguno de los dos lados. Ese instante —el mar apareciendo entero después del kilómetro andando— es lo que hace especial a Cuesta Maneli, y también lo que la filtra.' },
      { t: 'p', html: 'Es el borde de Doñana asomado al Atlántico. No hay edificios, ni paseo, ni una raya de asfalto: solo el acantilado ocre del Asperillo a la espalda, la arena batida por el viento y las series de olas llegando largas desde el océano abierto. A media mañana de agosto se ven bañistas repartidos en kilómetros, la toalla clavada con piedras contra la brisa, y arriba, recortada contra la duna, la pasarela por la que todos han bajado y por la que todos tendrán que volver a subir con lo que hayan traído.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Cuesta Maneli está en el término de <strong>Almonte (Huelva)</strong>, dentro del <strong>Parque Natural de Doñana</strong> y al pie del <strong>Acantilado del Asperillo</strong>, declarado <strong>Monumento Natural</strong> de Andalucía. No es un acantilado de roca: es un <strong>paleoacantilado de arena</strong>, una duna fósil de tonos ocre y naranja considerada <strong>de las más altas de su tipo en Europa</strong>, que la propia costa modela con el viento. El acceso, precisamente por esa protección, no es rodado: se deja el coche arriba y se baja por una <strong>pasarela de madera de algo más de un kilómetro</strong> —unos quince o veinte minutos a paso normal— que atraviesa el enebral y las dunas hasta la orilla.' },
      { t: 'p', html: 'El agua acompaña: las playas de esta parte de la <strong>Costa de la Luz onubense</strong> figuran, temporada tras temporada, con calidad <strong>"excelente" en los informes de la Agencia Europea de Medio Ambiente</strong>, la nota más alta de la escala. Pero la calidad del baño no es solo el agua, y aquí empieza el contra: en Cuesta Maneli <strong>no hay nada montado</strong>. Ni chiringuito, ni duchas, ni tienda, ni sombra natural en la arena; la vigilancia es de temporada alta y limitada, así que buena parte del año quien se mete se mete por su cuenta. Todo lo que bajes por la pasarela —agua, comida, sombrilla— lo vas a subir después cuesta arriba, con el sol de plomo del mediodía onubense cayéndote encima.' },
      { t: 'p', html: 'Y está el mar, que aquí es <strong>Atlántico abierto</strong>, no la balsa del Mediterráneo. La playa mira al suroeste, sin abrigo, así que entra oleaje de fondo, la marea tiene una carrera de varios metros —con <strong>bajamar</strong> se destapa un arenal enorme y compacto— y se forman <strong>corrientes de resaca</strong> los días de mar movida, sobre todo junto a las barras de arena. No es una playa peligrosa por definición, pero sí una que exige mirar la bandera y no meter a los niños pequeños cuando rompe fuerte. Un apunte más para quien llegue sin contexto: como buena parte del litoral salvaje de Doñana, <strong>tiene tramos de tradición nudista</strong>; conviene saberlo de antemano.' },
      { t: 'h2', text: 'El criterio del local', id: 'criterio' },
      { t: 'p', html: '<strong>¿Cuándo sí?</strong> A primera hora o a última, y mejor con la <strong>marea saliendo</strong>: se baja la pasarela con el sol aún blando, se pisa el arenal ancho que deja la bajamar y se evita el horno de las dos de la tarde, que en esta arena sin una sola sombra es el enemigo real. <strong>Junio, septiembre y el arranque de octubre</strong> son mejores que agosto: el agua sigue templada del verano, la luz se alarga y el aparcamiento de arriba no se llena a media mañana. Y el premio serio es el <strong>atardecer</strong>: mirando al oeste, el sol se hunde en el océano y enciende de naranja el acantilado entero. Vale la pena quedarse a verlo con la pasarela ya casi vacía.' },
      { t: 'p', html: '<strong>¿Cuándo no?</strong> Un mediodía de agosto con la marea alta y el <strong>parking lleno</strong> —se llena pronto los fines de semana y el resto queda aparcando en el arcén—, con <strong>poniente</strong> fuerte levantando la arena, o si buscas una playa con servicios, sombrilla de alquiler y acceso fácil para montar el día con carrito y nevera. Para eso, cerca: <strong>Matalascañas</strong> al este y <strong>Mazagón</strong> al oeste son playas urbanas de kilómetros de arena llana con chiringuitos, socorristas y aparcamiento de verdad. Menos escenografía y cero épica, pero se baja del coche a la orilla en cuatro pasos.' },
      { t: 'p', html: 'El viento a vigilar es el <strong>poniente</strong>, el del oeste, que muchas tardes de verano se levanta sobre el golfo de Cádiz: revuelve el mar, azota la arena contra las piernas y convierte una tarde tranquila en un sitio incómodo; con <strong>levante</strong> flojo, en cambio, el mar suele quedar más plano y el baño más amable. El truco del que va a menudo: calzado que sirva para la pasarela y para la arena caliente, agua de sobra, sombrilla propia bien anclada —o asumir que no habrá sombra—, y bajar mirando antes la tabla de mareas y el parte de viento. Con eso, Cuesta Maneli es de las mejores tardes del Atlántico andaluz; sin eso, es un kilómetro de vuelta cuesta arriba maldiciendo.' },
      { t: 'quote', text: 'No es un paraíso desierto que descubriste tú: es una playa exigente, sin sombra ni bar, a la que se llega andando y de la que se vuelve andando. Justo por eso, en pleno agosto, sigue teniendo sitio donde poner la toalla.' },
      { t: 'p', html: 'Al caer la tarde, cuando el poniente afloja y la luz se pone del mismo color que el acantilado, la playa se vacía por la pasarela en fila: arena en los pies, la sombrilla plegada al hombro, alguien que se para a mitad de la subida a mirar atrás una última vez. Abajo el Atlántico sigue entrando en líneas largas, ajeno a la hora y a los horarios de nadie, borrando las huellas del día contra el pie de la duna. Cuesta Maneli no te lo pone fácil —te hace andar, cargar y calcular—, y esa es exactamente la razón por la que, cuando por fin llegas abajo, se siente como algo que te has ganado.' },
    ],
    faq: [
      { q: '¿Cómo se llega a la playa de Cuesta Maneli?', a: 'A pie. Se aparca en un descampado de tierra junto a la carretera A-494, entre Matalascañas y Mazagón, y se baja por una pasarela de madera de algo más de un kilómetro que cruza el enebral y las dunas de Doñana hasta la arena. Son unos quince o veinte minutos andando, y no hay acceso rodado ni rampa: todo lo que bajes tendrás que volver a subirlo.' },
      { q: '¿Tiene chiringuito, socorrista o sombra?', a: 'No hay chiringuito, tienda ni duchas en la playa, y tampoco sombra natural: es un arenal abierto y salvaje dentro de Doñana. La vigilancia con socorrista es de temporada alta y limitada. Hay que bajar con agua, comida y sombrilla propia, y asumir que fuera de las semanas centrales del verano no habrá servicio de socorro.' },
      { q: '¿Es peligroso bañarse en Cuesta Maneli?', a: 'Es Atlántico abierto, no una playa cerrada. Entra oleaje de fondo, la marea tiene mucha carrera y con mar movida se forman corrientes de resaca, sobre todo junto a las barras de arena. No es peligrosa por definición, pero conviene respetar la bandera, no bañarse solo fuera de temporada y no meter a los niños pequeños cuando el mar rompe fuerte o sopla poniente.' },
    ],
    en: {
      title: 'Cuesta Maneli (Doñana): a kilometre of boardwalk to a beach with no shade and no bar',
      excerpt:
        'You don’t drive down to Cuesta Maneli: you park on the A-494 and cross more than a kilometre of wooden boardwalk through the Doñana dunes to reach the sand, at the foot of the ochre Asperillo cliff. The small print: no beach bar, no shade, a lifeguard only in peak weeks, and an open Atlantic of rip currents and wind that demands respect.',
      related: [
        { href: '/en/crystal-clear-water-beaches', label: 'Crystal-clear water beaches' },
        { href: '/en/magazine', label: 'Beach magazine' },
      ],
      body: [
        { t: 'p', html: 'The road runs straight through pines, with no sea in sight. Somewhere on the A-494 between Matalascañas and Mazagón there’s a dirt car park, a wooden sign and the start of a boardwalk that heads inland and uphill, through juniper and savin. You walk for a good while without seeing the water: first the low woodland, then the dunes, and then the ground opens and a honey-coloured sand cliff drops all at once onto a long beach that doesn’t end in either direction. That moment — the sea appearing whole after the kilometre on foot — is what makes Cuesta Maneli special, and it’s also what filters it.' },
        { t: 'p', html: 'This is the edge of Doñana looking out at the Atlantic. No buildings, no promenade, not a line of tarmac: just the ochre Asperillo cliff at your back, sand worked by the wind and sets of waves rolling in long from the open ocean. On an August mid-morning you can see bathers spread over miles, towels pinned down with stones against the breeze, and up above, cut against the dune, the boardwalk everyone came down and everyone will have to climb back up, carrying whatever they brought.' },
        { t: 'h2', text: 'The facts (and what they don’t tell you)', id: 'facts' },
        { t: 'p', html: 'Cuesta Maneli lies within <strong>Almonte (Huelva)</strong>, inside the <strong>Doñana Natural Park</strong> and at the foot of the <strong>Acantilado del Asperillo</strong>, designated a Natural Monument of Andalusia. It isn’t a rock cliff: it’s a <strong>sand palaeo-cliff</strong>, a fossil dune of ochre and orange tones reckoned to be <strong>among the tallest of its kind in Europe</strong>, still shaped by the coastal wind. Because of that protection, there’s no drive-down access: you leave the car up top and take a <strong>wooden boardwalk of just over a kilometre</strong> — some fifteen to twenty minutes at a normal pace — through the juniper scrub and dunes to the shore.' },
        { t: 'p', html: 'The water backs it up: the beaches of this stretch of Huelva’s <strong>Costa de la Luz</strong> are rated <strong>"excellent" year after year in European Environment Agency reports</strong>, the top mark on the scale. But bathing quality isn’t only the water, and here’s where the catch starts: at Cuesta Maneli <strong>nothing is set up</strong>. No beach bar, no showers, no shop, no natural shade on the sand; lifeguard cover is limited to the high season, so for much of the year anyone going in does so at their own risk. Everything you carry down the boardwalk — water, food, a parasol — you’ll carry back up afterwards, with the heavy midday Huelva sun on your neck.' },
        { t: 'p', html: 'And then the sea, which here is the <strong>open Atlantic</strong>, not the Mediterranean’s millpond. The beach faces south-west, unsheltered, so ground swell rolls in, the tidal range is several metres — <strong>low tide</strong> uncovers a huge, firm expanse of sand — and <strong>rip currents</strong> form on rougher days, especially by the sandbars. It isn’t a dangerous beach by definition, but it’s one that asks you to read the flag and keep small children out when it’s breaking hard. One more note for anyone arriving without context: like much of Doñana’s wild coast, <strong>parts of it are traditionally nudist</strong>; worth knowing in advance.' },
        { t: 'h2', text: 'The local’s verdict', id: 'verdict' },
        { t: 'p', html: '<strong>When to go?</strong> Early or late, and ideally with the <strong>tide going out</strong>: you take the boardwalk down while the sun’s still soft, walk the wide sand the ebb leaves behind and dodge the two-o’clock furnace, which on this shadeless sand is the real enemy. <strong>June, September and early October</strong> beat August: the water’s still warm from summer, the light stretches out and the car park up top doesn’t fill by mid-morning. The real prize is the <strong>sunset</strong>: facing west, the sun sinks into the ocean and sets the whole cliff glowing orange. It’s worth staying for, with the boardwalk almost empty.' },
        { t: 'p', html: '<strong>When not to?</strong> An August midday at high tide with the <strong>car park full</strong> — it fills early at weekends and the rest end up on the verge — with a stiff <strong>westerly</strong> lifting the sand, or if you want a beach with services, a hired parasol and easy access to set up the day with a pushchair and a cool box. For that, close by: <strong>Matalascañas</strong> to the east and <strong>Mazagón</strong> to the west are urban beaches with miles of flat sand, beach bars, lifeguards and proper parking. Less scenery and no drama, but you’re from the car to the water’s edge in four steps.' },
        { t: 'p', html: 'The wind to watch is the <strong>westerly</strong> (poniente), which gets up on many summer afternoons over the Gulf of Cádiz: it churns the sea, whips the sand against your legs and turns a calm afternoon into an uncomfortable spot; with a light <strong>easterly</strong> (levante), by contrast, the sea tends to flatten and the swim is kinder. The regular’s trick: footwear that works for both the boardwalk and the hot sand, plenty of water, your own parasol well anchored — or accept there’ll be no shade — and go down having checked the tide table and the wind forecast first. With that, Cuesta Maneli is one of the best afternoons on the Andalusian Atlantic; without it, it’s a kilometre back uphill, cursing.' },
        { t: 'quote', text: 'It isn’t a deserted paradise you discovered yourself: it’s a demanding beach, no shade and no bar, that you reach on foot and leave on foot. Which is exactly why, in high August, it still has room to lay down a towel.' },
        { t: 'p', html: 'As the afternoon fades, when the westerly eases and the light turns the colour of the cliff itself, the beach empties up the boardwalk in single file: sand on your feet, the folded parasol on your shoulder, someone stopping halfway up to look back one last time. Below, the Atlantic keeps rolling in in long lines, indifferent to the hour and to anyone’s schedule, wiping the day’s footprints away against the foot of the dune. Cuesta Maneli doesn’t make it easy — it makes you walk, carry and calculate — and that’s exactly why, when you finally reach the bottom, it feels like something you’ve earned.' },
      ],
      faq: [
        { q: 'How do you get to Cuesta Maneli beach?', a: 'On foot. You park on a dirt lot beside the A-494 road, between Matalascañas and Mazagón, and take a wooden boardwalk of just over a kilometre across the juniper scrub and dunes of Doñana down to the sand. It’s about fifteen to twenty minutes’ walk, and there’s no drive-down access or ramp: everything you take down you’ll have to carry back up.' },
        { q: 'Does it have a beach bar, lifeguard or shade?', a: 'There’s no beach bar, shop or showers on the beach, and no natural shade: it’s an open, wild stretch of sand inside Doñana. Lifeguard cover runs only in the high season and is limited. You need to bring water, food and your own parasol, and accept that outside the peak summer weeks there’ll be no rescue service.' },
        { q: 'Is it dangerous to swim at Cuesta Maneli?', a: 'It’s the open Atlantic, not a sheltered cove. Ground swell rolls in, the tidal range is large and on rough days rip currents form, especially by the sandbars. It isn’t dangerous by definition, but it pays to respect the flag, not to swim alone out of season and to keep small children out when the sea is breaking hard or a westerly is blowing.' },
      ],
    },
  },
  ...
  // ───── Diario de playas · Langre (voz bicéfala) ─────
  {
    ...
    category: 'rutas',
    title: 'Solo se baja por una escalera: Langre (Cantabria) pierde media arena con la marea alta',
    excerpt:
      'A Langre no llega ninguna carretera: se aparca arriba, en el acantilado, y se baja andando por una escalera de piedra. El aviso que casi nadie da: con la pleamar el arenal se encoge hasta desaparecer por tramos, y la de al lado se queda directamente sin playa.',
    heroAlt: 'Arenal de Langre visto desde lo alto del acantilado verde, con el espolón de roca que parte la playa en dos y la mar de fondo del Cantábrico entrando de frente',
    heroQuery: 'playa de langre,langre,cantabria,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-17T09:22:09Z',
    readingMin: 5,
    related: [
    ...
    body: [
      { t: 'p', html: 'La carretera muere en un prado. Se deja el coche entre vacas y muros de piedra, se cruza un portillo y de golpe el suelo desaparece: abajo, treinta metros más abajo, hay una lengua de arena rubia encajada entre paredes de roca oscura, y encima de ella la mar del Cantábrico llegando en líneas largas y ordenadas desde algún temporal que reventó a mil kilómetros de aquí. Desde el borde del acantilado se ve todo a la vez —la playa entera, las series entrando, los surfistas del tamaño de una uña— y esa es la primera trampa de Langre: es tan bonita desde arriba que mucha gente se queda ahí, hace la foto y se va sin bajar.' },
      { t: 'p', html: 'Los que bajan lo hacen por una escalera de piedra pegada a la pared, con la hierba a un lado y el vacío al otro. Se tarda cinco minutos, y en esos cinco minutos el ruido cambia: arriba solo se oye viento, abajo se oye el mar golpeando el espolón de roca que parte el arenal en dos. Un hombre sube con la tabla bajo el brazo y la respiración corta. Una familia baja con la nevera a pulso, turnándose. Nadie ha traído sombrilla, y no es casualidad.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Langre está en <strong>Ribamontán al Mar</strong>, el municipio cántabro que es la <strong>única Reserva Mundial de Surf de España</strong> y la primera de Europa: una figura internacional que protege el litoral entre Somo, Loredo y Langre precisamente por la calidad de sus olas y el estado de la costa. No es un eslogan de ayuntamiento; es la razón física de que el arenal esté como está: sin paseo marítimo, sin bloques, sin bar. En realidad son <strong>dos playas</strong> —<strong>Langre Grande</strong>, de medio kilómetro largo, y <strong>Langre Pequeña</strong>, la de poniente— separadas por un promontorio rocoso que se cruza andando cuando la mar lo permite. Y no lo permite siempre.' },
      { t: 'p', html: 'Aquí llega el dato que decide tu día y que los rankings no cuentan: <strong>la marea</strong>. Langre mira al norte, encajada bajo el acantilado, y el Cantábrico tiene una carrera de marea de varios metros. Con <strong>bajamar</strong> se abre un arenal ancho y compacto, se cruza a Langre Pequeña sin mojarse y hay sitio para todos. Con <strong>pleamar</strong>, sobre todo en mareas vivas, el agua llega hasta la pared de roca, la playa se estrecha hasta quedar en tramos casi nada y la playa pequeña se queda literalmente <strong>sin arena</strong>. Quien baje la escalera sin haber mirado la tabla de mareas se puede encontrar con que ha cargado la nevera treinta metros hacia abajo para sentarse en una piedra. Y el paso entre las dos playas, si te descuidas, se cierra por detrás.' },
      { t: 'p', html: 'Los otros contras, sin rodeos. <strong>No hay acceso rodado ni rampa</strong>: se baja y se sube por la escalera, así que Langre queda descartada con carrito, con problemas de movilidad o con demasiado equipaje. <strong>No hay chiringuito ni servicios</strong> en la arena; lo que lleves, lo bajas y lo subes. El <strong>aparcamiento</strong> es un descampado de tierra arriba, en el prado, con plazas contadas: un sábado de agosto se llena a media mañana y el resto queda aparcando en el arcén de una carretera rural estrecha. Y el <strong>agua está fría</strong> —esto es el Cantábrico, no el Mediterráneo—: incluso en pleno agosto, el baño largo sin neopreno no es para todo el mundo. La <strong>vigilancia</strong> es de temporada alta y limitada; fuera de esas semanas, quien se mete se mete solo.' },
      { t: 'h2', text: 'El criterio del local', id: 'local' },
      { t: 'p', html: 'Cuándo sí: <strong>con la marea bajando</strong>, ese es el truco entero. Se mira la tabla, se baja una o dos horas antes de la bajamar y se disfruta de un arenal que se va abriendo delante en vez de comerte contra la pared. <strong>Junio y septiembre</strong> son mejores que agosto: menos coches arriba, agua igual de fresca y luz mucho más larga. Cuándo no: un mediodía de agosto con <strong>pleamar de marea viva</strong> —te quedas sin playa—, con niños muy pequeños si el mar viene fuerte, o cuando hay <strong>bandera roja</strong>, que aquí se iza con motivo: al ser una playa abierta al norte y sin abrigo, la mar de fondo entra entera y se forman corrientes de retorno junto al espolón.' },
      { t: 'p', html: 'El viento a vigilar es la <strong>nortada</strong>, el noroeste que se levanta muchas tardes de verano en el Cantábrico: empuja la mar contra el acantilado, revuelve el agua y convierte una tarde plácida en un sitio incómodo para el baño; con <strong>viento sur</strong>, en cambio, el terral sopla desde tierra por encima del acantilado, alisa la superficie y deja la playa en calma —es el día bueno, y es cuando se llena de tablas—. La alternativa, cuando Langre no está: a pocos minutos, <strong>Somo</strong> y <strong>Loredo</strong> ofrecen kilómetros de arena llana con aparcamiento de verdad, escuelas de surf, socorristas y bares, y se llega incluso en <strong>lancha desde Santander</strong> cruzando la bahía. Menos escenografía y menos épica, pero se baja del coche a la arena en veinte pasos.' },
      { t: 'quote', text: 'La postal se hace desde arriba en diez segundos; la playa se gana bajando treinta metros de escalera y mirando antes la tabla de mareas. Langre no es difícil: es honesta con quien no hace los deberes.' },
      { t: 'p', html: 'A última hora, cuando el aparcamiento de arriba se queda en cuatro coches y la luz cae plana sobre el agua, la playa se vacía por la escalera en fila india: neoprenos a medio bajar, arena en las pantorrillas, alguien que se para a mitad de la subida a mirar atrás. Abajo el mar sigue entrando en líneas largas contra el espolón, ajeno a la hora y a los horarios de nadie, y en un rato habrá borrado todas las huellas del día. Baja con la marea a favor, sin sombrilla, con lo puesto y con las piernas frescas, y Langre te dará una de las mejores tardes del Cantábrico. Preséntate a las dos con pleamar y la nevera llena, y habrás cargado veinte kilos escalera abajo para descubrir que el mar ha llegado antes que tú.' },
    ],
    faq: [
      { q: '¿Cómo se baja a la playa de Langre?', a: 'Solo a pie. No llega ninguna carretera hasta la arena: se aparca arriba, en un descampado de tierra sobre el acantilado, y se baja por una escalera de piedra adosada a la pared, unos treinta metros de desnivel que se hacen en cinco minutos. No hay rampa ni acceso rodado, así que no es una playa practicable con carrito, con problemas de movilidad ni cargando mucho equipaje: todo lo que bajes tendrás que volver a subirlo.' },
      { q: '¿Por qué hay que mirar la marea antes de ir a Langre?', a: 'Porque el Cantábrico tiene varios metros de carrera de marea y Langre está encajada bajo el acantilado. Con bajamar se abre un arenal ancho y compacto y se puede cruzar al andar hasta Langre Pequeña; con pleamar, y especialmente en mareas vivas, el agua llega hasta la pared de roca, la playa grande se estrecha por tramos y la pequeña se queda prácticamente sin arena. Lo sensato es bajar una o dos horas antes de la bajamar, con la marea saliendo.' },
      { q: '¿Langre es buena playa para niños pequeños?', a: 'Depende del día, y con reservas. Está en Ribamontán al Mar, la única Reserva Mundial de Surf de España, y eso significa mar de fondo entrando de frente sin ningún abrigo: cuando hay olas se forman corrientes de retorno junto al espolón rocoso y se iza bandera roja con motivo. Además el agua está fría incluso en agosto, no hay chiringuito ni servicios en la arena, y la vigilancia se limita a la temporada alta. Con mar en calma y marea baja es una playa estupenda; con mar movida, Somo o Loredo son mucho más sensatas.' },
    ],
    en: {
      title: 'Steps down a cliff or nothing: Langre (Cantabria) loses half its sand at high tide',
      excerpt: 'No road reaches Langre: you park up on the cliff and walk down a flight of stone steps. The warning nobody gives: at high water the sand shrinks to almost nothing in places, and the smaller beach next door disappears altogether.',
      related: [
        { href: '/en/crystal-clear-water-beaches', label: 'Clear-water beaches' },
        { href: '/en/magazine', label: 'More from the Magazine' },
      ],
      body: [
        { t: 'p', html: 'The road dies in a meadow. You leave the car among cows and stone walls, go through a gate, and the ground simply drops away: thirty metres below there is a tongue of blond sand wedged between dark rock walls, and on top of it the Cantabrian sea arriving in long, ordered lines from some storm that broke a thousand kilometres away. From the cliff edge you can see the lot at once — the whole beach, the sets rolling in, surfers the size of a fingernail — and that is Langre’s first trap: it looks so good from above that plenty of people stop there, take the photograph and leave without going down.' },
        { t: 'p', html: 'Those who do go down use a stone staircase pinned to the wall, grass on one side and open air on the other. It takes five minutes, and in those five minutes the sound changes: up top all you hear is wind, at the bottom you hear the sea working against the rock spur that splits the sand in two. A man comes up with a board under his arm and no breath left. A family carries the cool box down by hand, taking turns. Nobody has brought a parasol, and that is not an accident.' },
        { t: 'h2', text: 'The facts (and what they leave out)', id: 'facts' },
        { t: 'p', html: 'Langre sits in <strong>Ribamontán al Mar</strong>, the Cantabrian municipality that holds <strong>Spain’s only World Surfing Reserve</strong> and the first in Europe: an international designation protecting the coast between Somo, Loredo and Langre precisely because of the quality of its waves and the state of the shoreline. It is not council marketing; it is the physical reason the beach is as it is — no promenade, no blocks of flats, no bar. There are in fact <strong>two beaches</strong>: <strong>Langre Grande</strong>, a good half-kilometre of it, and <strong>Langre Pequeña</strong> to the west, split by a rocky headland you can walk around when the sea allows. It does not always allow.' },
        { t: 'p', html: 'Here comes the fact that decides your day and that the rankings skip: <strong>the tide</strong>. Langre faces north, boxed in under the cliff, and the Cantabrian coast has a tidal range of several metres. At <strong>low water</strong> a wide, firm strand opens up, you can walk round to Langre Pequeña dry-shod and there is room for everyone. At <strong>high water</strong>, particularly on spring tides, the sea reaches the rock wall, the beach narrows to almost nothing in stretches and the smaller beach is left with <strong>no sand at all</strong>. Go down those steps without checking the tide table and you may have carried the cool box thirty metres down in order to sit on a rock. And the passage between the two beaches, if you are careless, closes behind you.' },
        { t: 'p', html: 'The other drawbacks, plainly. <strong>There is no vehicle access and no ramp</strong>: it is the staircase down and the staircase up, which rules Langre out with a pushchair, with limited mobility or with too much kit. <strong>There is no beach bar and no facilities</strong> on the sand; whatever you bring down, you carry back up. <strong>Parking</strong> is a dirt clearing in the meadow above with a limited number of spaces: on an August Saturday it fills by mid-morning and everyone else ends up on the verge of a narrow country lane. And the <strong>water is cold</strong> — this is the Cantabrian sea, not the Mediterranean — so even in August a long swim without a wetsuit is not for everybody. <strong>Lifeguard cover</strong> runs in high season only, and is limited; outside those weeks, anyone going in goes in alone.' },
        { t: 'h2', text: 'The local’s verdict', id: 'verdict' },
        { t: 'p', html: 'When to go: <strong>on a falling tide</strong> — that is the whole trick. Check the table, go down an hour or two before low water and enjoy a beach that opens out in front of you rather than pinning you against the wall. <strong>June and September</strong> beat August: fewer cars up top, water just as fresh, and far longer light. When not: an August midday on a <strong>spring high tide</strong>, when you are left with no beach at all; with very small children if the sea is up; or when the <strong>red flag</strong> is flying, which here it is for good reason — an open north-facing beach with no shelter takes the whole swell, and rip currents form alongside the rock spur.' },
        { t: 'p', html: 'The wind to watch is the <strong>nortada</strong>, the north-westerly that gets up on many summer afternoons along this coast: it pushes the sea against the cliff, churns the water and turns a placid afternoon into an uncomfortable place to swim. A <strong>southerly</strong>, by contrast, blows offshore over the cliff top, irons the surface flat and leaves the beach calm — that is the good day, and that is when it fills with boards. The alternative, when Langre is not on: minutes away, <strong>Somo</strong> and <strong>Loredo</strong> offer kilometres of flat sand with real parking, surf schools, lifeguards and bars, and you can even get there by <strong>ferry from Santander</strong> across the bay. Less drama and less scenery, but you step out of the car onto the sand.' },
        { t: 'quote', text: 'The postcard takes ten seconds from the cliff top; the beach is earned thirty metres down a staircase, having checked the tide first. Langre is not hard — it is simply honest with anyone who has not done the homework.' },
        { t: 'p', html: 'Late on, when the car park up top is down to four cars and the light lies flat on the water, the beach empties back up the staircase in single file: wetsuits half-peeled, sand up the calves, someone stopping halfway to look back. Below, the sea keeps arriving in long lines against the spur, indifferent to the hour and to anybody’s plans, and before long it will have wiped every footprint of the day. Go down with the tide in your favour, without a parasol, carrying next to nothing and with fresh legs, and Langre will hand you one of the best afternoons on the north coast. Turn up at two on a high spring tide with a full cool box and you will have hauled twenty kilos down a staircase to find the sea got there first.' },
      ],
      faq: [
        { q: 'How do you get down to Langre beach?', a: 'On foot only. No road reaches the sand: you park above, on a dirt clearing on the cliff top, and walk down a stone staircase fixed to the wall — around thirty metres of descent, five minutes’ walk. There is no ramp and no vehicle access, so it is not a practical beach with a pushchair, with limited mobility, or carrying much kit: everything you take down has to come back up.' },
        { q: 'Why should you check the tide before going to Langre?', a: 'Because the Cantabrian coast has a tidal range of several metres and Langre is boxed in under the cliff. At low water a wide, firm strand opens up and you can walk round to Langre Pequeña; at high water, especially on spring tides, the sea reaches the rock wall, the main beach narrows to almost nothing in places and the smaller one is left with virtually no sand. The sensible move is to go down an hour or two before low water, with the tide falling.' },
        { q: 'Is Langre a good beach for small children?', a: 'It depends on the day, and with caveats. It sits in Ribamontán al Mar, Spain’s only World Surfing Reserve, which means Atlantic swell arriving head-on with no shelter: when there are waves, rip currents form alongside the rock spur and the red flag goes up for good reason. The water is cold even in August, there is no beach bar or facilities on the sand, and lifeguard cover is limited to high season. On a calm day at low tide it is a fine beach; with any sea running, Somo or Loredo are far more sensible.' },
      ],
    },
  },
