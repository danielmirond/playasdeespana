...
export const ARTICLES: Article[] = [
  // ───── Diario de playas · Dénia (voz bicéfala) ─────
  {
    slug: 'les-rotes-denia-alicante-reserva-marina-sin-arena',
    category: 'rutas',
    title: 'Sin arena y con escarpines: Les Rotes (Dénia) protege una reserva marina desde 1993',
    excerpt:
      'La costa al sur de Dénia es el mejor snorkel de la Costa Blanca porque el mar lleva más de tres décadas protegido como reserva. La letra pequeña: aquí no hay arena, sino losa y canto rodado, la entrada al agua se hace con escarpines y el aparcamiento es una fila de coches en una carretera estrecha.',
    heroAlt: 'Costa rocosa de losas y cantos al sur de Dénia, con el agua muy transparente sobre fondo de posidonia y el cabo de San Antonio cerrando la bahía al fondo',
    heroQuery: 'les rotes,denia,alicante,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-16T13:40:22Z',
    readingMin: 5,
    related: [
      { href: '/comunidad/comunitat-valenciana', label: 'Playas de la Comunitat Valenciana' },
      { href: '/playas-aguas-cristalinas', label: 'Playas de agua transparente' },
      { href: '/alquiler-barco/costas/costa-blanca/provincias/alicante/denia', label: 'Alquiler de barco en Dénia' },
    ],
    body: [
      { t: 'p', html: 'La carretera sale de Dénia hacia el sur, deja atrás el puerto y los últimos bloques, y se convierte en una calle larga y estrecha que va pegada al mar entre pinos, chalés bajos y muros de piedra. No hay paseo marítimo ni hileras de sombrillas: hay escaleras de hormigón que bajan a plataformas de roca, algún trozo de canto rodado que hace las veces de playa y, enfrente, la mole del cabo de San Antonio cerrando la bahía. El agua tiene un color verde profundo que no viene de un filtro, sino de lo que hay debajo: praderas de posidonia que se ven desde la orilla como manchas oscuras sobre el fondo claro.' },
      { t: 'p', html: 'Es media mañana de junio y en la plataforma de losa hay media docena de tubos de snorkel avanzando despacio, cabeza abajo. Una pareja se calza los escarpines sentada en el escalón, con esa torpeza de quien ya sabe que descalzo no se llega. Debajo pasan salpas en banco, algún sargo, y de vez en cuando la sombra larga de un mero cebado a estar tranquilo. Les Rotes no se parece a la Costa Blanca de los folletos y no lo pretende: aquí el espectáculo está bajo la superficie, y para verlo hay que meter la cara.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'El dato que lo explica todo: el mar que tienes delante está protegido. La <strong>Reserva Marina del Cabo de San Antonio</strong> se declaró en <strong>1993</strong> y cubre la franja entre Dénia y Xàbia, gestionada por la <strong>Generalitat Valenciana</strong> como reserva marina de interés pesquero. Dentro está <strong>prohibida la pesca deportiva y la submarina</strong>, y el buceo con botella se hace con <strong>autorización previa</strong> y cupo. Más de tres décadas sin sacar peces se notan en cuanto te asomas: aquí el pescado no huye. Ese es el motivo real de que Les Rotes tenga fama de mejor snorkel del norte de Alicante, y no ningún adjetivo de folleto. El otro activo es la <strong>posidonia</strong>: una planta marina protegida que oxigena el agua y la mantiene limpia. La transparencia no es cosmética; es la pradera funcionando.' },
      { t: 'p', html: 'Ahora la letra pequeña, y en Les Rotes empieza por lo más básico: <strong>no hay playa de arena</strong>. Lo que hay es <em>tosca</em> —la losa de roca plana que forma la orilla—, cantos rodados y calas mínimas como <strong>Les Arenetes</strong>, <strong>Punta Negra</strong> o <strong>el Trampolí</strong>, casi todas de piedra. Quien llegue con la toalla y la idea de tumbarse en la arena se va a llevar un chasco: aquí se viene a nadar, no a echar el día en la orilla. La entrada al agua es <strong>incómoda y resbaladiza</strong>, y con la roca húmeda cubierta de algas se cae más gente de la que se cuenta. <strong>Los escarpines no son un capricho</strong>: son la diferencia entre bañarte o salir cojeando. Y una vez dentro, ojo con salir por donde entraste, porque las plataformas tienen bordes vivos.' },
      { t: 'p', html: 'Dos avisos más, honestos. El primero es el <strong>aparcamiento</strong>: no existe uno de verdad. Se aparca en línea, en el arcén de una carretera estrecha de sentido único en la que hay casas, y en julio y agosto la fila se estira cientos de metros; el que llega a mediodía deja el coche lejos y camina con la nevera a cuestas. El segundo es la <strong>sombra</strong>: los pinos quedan del lado de las casas, no sobre la roca, así que la losa se convierte en una sartén desde media mañana y clavar sombrilla en piedra es sencillamente imposible. Añade que los <strong>servicios son mínimos</strong> —esto es una costa residencial, no un arenal equipado— y que la vigilancia no es la de una playa urbana. Se viene con agua, con sombra propia si se puede, y con la idea clara de que el atractivo está en el agua, no en tierra.' },
      { t: 'h2', text: 'El criterio del local', id: 'local' },
      { t: 'p', html: 'Cuándo sí: de <strong>mayo a octubre</strong> con el mar plano y a <strong>primera hora</strong>, cuando la luz entra en vertical y el fondo se ve con todo detalle antes de que llegue la gente y remueva la orilla. Es un sitio para quien <strong>nada, bucea a pulmón o va con tubo</strong>, y funciona incluso mejor en <strong>septiembre y octubre</strong>, con el agua todavía templada y la carretera despejada. Cuándo no: un fin de semana de agosto a mediodía, sin escarpines, con niños pequeños que aún no nadan y buscando arena donde no la hay. Para eso, a diez minutos, Dénia tiene sus arenales del norte —<strong>Les Marines</strong>, <strong>Els Molins</strong>—, planos, de arena fina y con todos los servicios: es la alternativa sensata si el plan es toalla y castillo, no máscara y tubo.' },
      { t: 'p', html: 'El viento a vigilar es el <strong>levante</strong>, el del este. Esta costa mira al este y al sureste, así que con levante entra la ola de frente, se enturbia el agua, se pierde la visibilidad del snorkel —que es exactamente el motivo por el que has venido— y arrastra a la orilla lo que flota. Con <strong>poniente</strong>, en cambio, el Montgó hace de pantalla y el mar se queda como un plato. El truco del que va a menudo: mirar el parte de viento antes de salir y, si sopla del este, cambiar de plan sin discutir. Y el aviso que más gente se salta: la <strong>Cova Tallada</strong>, la cueva excavada en la roca que muchos vienen a ver desde aquí, tiene el <strong>acceso regulado con reserva previa y cupo</strong> en los meses de verano dentro del <strong>Parc Natural del Montgó</strong>. Presentarse sin reserva en agosto es quedarse fuera. Si el plan es verla por mar, se llega <a href="/alquiler-barco/costas/costa-blanca/provincias/alicante/denia">en barco desde Dénia</a>, fondeando fuera de las manchas de posidonia, que están protegidas y no se anclan.' },
      { t: 'quote', text: 'No es una playa fallida por no tener arena: es una reserva marina con treinta años de ventaja. El precio de entrada son unos escarpines y renunciar a la toalla en la orilla.' },
      { t: 'p', html: 'A última hora, cuando los coches se van vaciando de la carretera y el cabo de San Antonio se queda a contraluz, Les Rotes recupera lo suyo: el chapoteo de alguien que sigue nadando, el crujido de los cantos y un agua que a esa hora se pone casi negra sobre la posidonia. Ve en septiembre, ve temprano, baja con escarpines y con un tubo, y deja la sombrilla en el maletero porque aquí no hay dónde clavarla. Preséntate un domingo de agosto a las dos buscando un arenal con chiringuito, y entenderás por qué Les Rotes lleva décadas sin salir en los folletos: no es para tumbarse, es para mirar debajo.' },
    ],
    faq: [
      { q: '¿Les Rotes es una playa de arena?', a: 'No. Les Rotes es una costa rocosa al sur de Dénia formada por losa plana (la tosca), cantos rodados y calas muy pequeñas como Les Arenetes, Punta Negra o el Trampolí, casi todas de piedra. No hay arenal donde tumbarse ni sitio donde clavar una sombrilla, y la entrada al agua es resbaladiza, así que conviene llevar escarpines. Si buscas arena, los arenales del norte de Dénia (Les Marines, Els Molins) están a diez minutos.' },
      { q: '¿Por qué se ve tanto pescado haciendo snorkel en Les Rotes?', a: 'Porque el mar está protegido desde 1993 como Reserva Marina del Cabo de San Antonio, gestionada por la Generalitat Valenciana entre Dénia y Xàbia. Dentro están prohibidas la pesca deportiva y la submarina, y el buceo con botella requiere autorización previa. Más de tres décadas sin presión pesquera hacen que el pescado no huya, y las praderas de posidonia mantienen el agua transparente.' },
      { q: '¿Hace falta reserva para visitar la Cova Tallada desde Les Rotes?', a: 'En los meses de verano, sí. El acceso a la Cova Tallada está regulado con reserva previa y cupo dentro del Parc Natural del Montgó, así que presentarse sin reserva en temporada alta suele significar quedarse fuera. La otra vía es llegar por mar en barco desde Dénia, fondeando siempre fuera de las praderas de posidonia, que están protegidas.' },
    ],
    en: {
      title: 'No sand, just rock: Les Rotes (Dénia) has guarded a marine reserve since 1993',
      excerpt: 'The coast south of Dénia offers the best snorkelling on the Costa Blanca because the sea has been protected for over three decades. The small print: no sand at all, just flat rock and pebbles, water shoes are essential, and parking means a long line of cars on a narrow lane.',
      related: [
        { href: '/en/crystal-clear-water-beaches', label: 'Clear-water beaches' },
        { href: '/en/boat-rental/coasts/costa-blanca/provinces/alicante/denia', label: 'Boat rental in Dénia' },
        { href: '/en/magazine', label: 'More from the Magazine' },
      ],
      body: [
        { t: 'p', html: 'The road leaves Dénia heading south, puts the harbour and the last apartment blocks behind it and turns into a long, narrow lane that runs tight against the sea between pines, low villas and stone walls. There is no promenade and no rank of umbrellas: there are concrete steps down to rock platforms, the odd patch of pebbles standing in for a beach and, opposite, the bulk of the Cabo de San Antonio closing off the bay. The water is a deep green that owes nothing to a filter and everything to what lies beneath it: posidonia meadows, visible from the shore as dark patches on a pale bottom.' },
        { t: 'p', html: 'It is mid-morning in June and half a dozen snorkels are moving slowly across the rock shelf, faces down. A couple sit on the step pulling on water shoes with the awkwardness of people who have learned that barefoot does not work here. Below them salema pass in a shoal, the odd sea bream, and now and then the long shadow of a grouper grown used to being left alone. Les Rotes looks nothing like the Costa Blanca of the brochures and does not try to: the show here is under the surface, and to see it you have to put your face in.' },
        { t: 'h2', text: 'The facts (and what they leave out)', id: 'facts' },
        { t: 'p', html: 'The fact that explains everything: the sea in front of you is protected. The <strong>Cabo de San Antonio marine reserve</strong> was declared in <strong>1993</strong> and covers the strip between Dénia and Xàbia, run by the <strong>Valencian government</strong> as a marine reserve of fishing interest. Inside it, <strong>recreational and spear fishing are banned</strong>, and scuba diving runs on <strong>prior authorisation</strong> and a quota. Three decades of taking no fish out show the moment you look in: nothing bolts. That is the real reason Les Rotes has a reputation for the best snorkelling in northern Alicante — not any brochure adjective. The other asset is the <strong>posidonia</strong>: a protected sea plant that oxygenates the water and keeps it clean. The clarity is not cosmetic; it is the meadow doing its job.' },
        { t: 'p', html: 'Now the small print, and at Les Rotes it starts with the basics: <strong>there is no sand</strong>. What there is: <em>tosca</em>, the flat rock shelf that forms the shore, pebbles, and tiny coves such as <strong>Les Arenetes</strong>, <strong>Punta Negra</strong> or <strong>el Trampolí</strong>, nearly all of them stone. Anyone arriving with a towel and plans to stretch out on sand will be disappointed: you come here to swim, not to spend the day on the shore. Getting in is <strong>awkward and slippery</strong>, and more people go over on the wet, weed-covered rock than ever gets mentioned. <strong>Water shoes are not a nicety</strong>: they are the difference between a swim and a limp back to the car. Once in, mind where you climb out — the platforms have sharp edges.' },
        { t: 'p', html: 'Two more honest warnings. The first is <strong>parking</strong>: there isn’t any, not properly. You park on the verge of a narrow one-way lane lined with houses, and in July and August the queue of cars stretches for hundreds of metres; turn up at midday and you will leave the car far off and carry the cool box. The second is <strong>shade</strong>: the pines are on the house side, not over the rock, so the shelf turns into a frying pan from mid-morning and driving an umbrella into stone is simply not possible. Add that <strong>facilities are minimal</strong> — this is a residential coast, not a serviced strand — and that supervision is not what you would get on a town beach. Bring water, bring your own shade if you can, and come clear that the appeal is in the water, not on land.' },
        { t: 'h2', text: 'The local’s verdict', id: 'verdict' },
        { t: 'p', html: 'When to go: <strong>May to October</strong> with a flat sea, and <strong>first thing</strong>, when the light drops in vertically and the bottom shows in full detail before people arrive and stir up the shallows. This is a place for people who <strong>swim, freedive or snorkel</strong>, and it works even better in <strong>September and October</strong>, with the water still warm and the lane clear. When not: an August weekend at midday, without water shoes, with small children who cannot yet swim, hunting for sand that does not exist. For that, ten minutes away, Dénia has its northern strands — <strong>Les Marines</strong>, <strong>Els Molins</strong> — flat, fine-sanded and fully serviced. That is the sensible alternative if the plan is towels and sandcastles rather than mask and snorkel.' },
        { t: 'p', html: 'The wind to watch is the <strong>levante</strong>, out of the east. This coast faces east and south-east, so an easterly puts the swell straight in, clouds the water, kills the snorkelling visibility you came for and pushes whatever is floating onto the shore. With a <strong>westerly</strong>, by contrast, the Montgó acts as a screen and the sea lies like a plate. The regular’s trick: check the wind forecast before leaving and, if it is easterly, change the plan without arguing. And the warning most people miss: the <strong>Cova Tallada</strong>, the cave cut into the rock that many come here to see, has <strong>regulated access with prior booking and a quota</strong> through the summer months, inside the <strong>Montgó natural park</strong>. Turning up in August without a booking means staying out. If the plan is to see it from the water, you can get there <a href="/en/boat-rental/coasts/costa-blanca/provinces/alicante/denia">by boat from Dénia</a>, anchoring clear of the posidonia patches, which are protected and not to be anchored on.' },
        { t: 'quote', text: 'It is not a failed beach for lacking sand: it is a marine reserve with a thirty-year head start. The entry price is a pair of water shoes and giving up the towel on the shore.' },
        { t: 'p', html: 'Late in the day, when the cars thin out along the lane and the Cabo de San Antonio goes back-lit, Les Rotes gets itself back: someone still swimming, the crunch of pebbles, and water that turns almost black over the posidonia. Go in September, go early, take water shoes and a snorkel, and leave the umbrella in the boot because there is nowhere to plant it. Turn up at two on an August Sunday looking for a serviced strand, and you will understand why Les Rotes has stayed out of the brochures for decades: it is not for lying on, it is for looking under.' },
      ],
      faq: [
        { q: 'Is Les Rotes a sandy beach?', a: 'No. Les Rotes is a rocky stretch of coast south of Dénia made up of flat rock shelf (the tosca), pebbles and very small coves such as Les Arenetes, Punta Negra and el Trampolí, nearly all of them stone. There is nowhere to stretch out on sand and nowhere to plant an umbrella, and getting into the water is slippery, so water shoes are worth bringing. If you want sand, the northern strands of Dénia — Les Marines, Els Molins — are ten minutes away.' },
        { q: 'Why is there so much fish when snorkelling at Les Rotes?', a: 'Because the sea has been protected since 1993 as the Cabo de San Antonio marine reserve, run by the Valencian government between Dénia and Xàbia. Recreational and spear fishing are banned inside it, and scuba diving needs prior authorisation. Three decades without fishing pressure mean the fish do not bolt, and the posidonia meadows keep the water clear.' },
        { q: 'Do you need to book to visit the Cova Tallada from Les Rotes?', a: 'In the summer months, yes. Access to the Cova Tallada is regulated with prior booking and a quota inside the Montgó natural park, so turning up without a booking in high season usually means being turned away. The other route is to arrive by sea from Dénia, always anchoring clear of the posidonia meadows, which are protected.' },
      ],
    },
  },
  // ───── Diario de playas · Mallorca (voz bicéfala) ─────
  {
    slug: 'playa-es-trenc-mallorca-sin-urbanizar-embat-aparcamiento',
    category: 'rutas',
    title: 'Es Trenc (Mallorca): 2 km sin un edificio detrás y el parking lleno a media mañana',
    excerpt:
      'Una de las últimas playas grandes de Mallorca sin urbanizar, protegida y con agua somera y clara en el sur de la isla. La letra pequeña: cero sombra en la orilla, el embat de la tarde que pica el mar y un aparcamiento de pago que se llena pronto.',
    heroAlt: 'Larga playa de arena blanca y fina en el sur de Mallorca, con agua somera turquesa, un cordón de dunas y pinar bajo detrás y las salinas al fondo',
    heroQuery: 'es trenc,mallorca,campos,beach',
    author: 'Equipo Playas de España',
    datePublished: '2026-07-16T11:46:12Z',
    readingMin: 5,
    related: [
      { href: '/comunidad/islas-baleares', label: 'Playas de Baleares' },
      { href: '/islas', label: 'Playas de islas' },
      { href: '/alquiler-barco/costas/islas-baleares/provincias/baleares/mallorca', label: 'Alquiler de barco en Mallorca' },
    ],
    body: [
      { t: 'p', html: 'Al sur de Mallorca, entre la Colònia de Sant Jordi y el caserío de Ses Covetes, la carretera se aparta del mar y lo esconde detrás de un cordón de dunas y pinos bajos. Se deja el coche en un descampado, se cruza una pasarela de madera que serpentea entre la arena y el matorral y, al coronar la última duna, aparece de golpe una raya de arena blanca de dos kilómetros con el agua tan somera y clara que el turquesa empieza casi en la orilla. Detrás no hay bloques ni paseo marítimo: solo el pinar, y más allá el brillo blanco de unas salinas. En una isla construida casi de punta a punta, Es Trenc enseña cómo era casi todo esto antes del hormigón.' },
      { t: 'p', html: 'Es media mañana de junio y el mar todavía está plano. Una familia camina mar adentro treinta metros sin que el agua les pase de la cintura; en el tramo del centro, donde el naturismo es costumbre desde hace décadas, un par de bañistas sin ropa toman el sol. Huele a pino y a sal. A esta hora, Es Trenc todavía es la playa ancha y callada de la foto. Cuando el sol suba, se llene el aparcamiento y el embat empiece a entrar de la mar, será otra cosa.' },
      { t: 'h2', text: 'Los datos (y lo que no te cuentan)', id: 'datos' },
      { t: 'p', html: 'Lo primero, lo grande y lo verdadero: Es Trenc es de las <strong>últimas playas grandes de Mallorca sin urbanizar detrás</strong>. Son unos dos kilómetros de arena fina y clara en el sur de la isla, entre los términos de <strong>Campos y Ses Salines</strong>, respaldados por un sistema de dunas, pinar y, tierra adentro, la marisma y las salinas del <strong>Salobrar de Campos</strong>. Todo el conjunto está protegido: el <strong>Parc Natural Marítimo-Terrestre Es Trenc-Salobrar de Campos</strong>, declarado por el Govern balear en 2017, es lo que ha frenado aquí los hoteles que cubren casi el resto del litoral. El agua es de las más someras y transparentes de la isla —se hace pie a decenas de metros de la orilla— y en pleno verano la temperatura del mar ronda los <strong>26°C</strong> (climatología de temperatura del mar de Open-Meteo para el sur de Mallorca). Eso es cierto y no necesita adjetivos prestados.' },
      { t: 'p', html: 'Ahora la letra pequeña, que empieza por donde más aprieta a mediodía: <strong>en la orilla no hay una sola sombra</strong>. Los pinos quedan detrás de la duna, no sobre la arena, así que quien no baje con sombrilla se cuece, y clavarla firme no siempre es fácil en arena tan fina. El segundo aviso es el <strong>viento</strong>. A primera hora el mar suele estar en calma, pero casi cada tarde entra el <strong>embat</strong>, la brisa marina que en verano se levanta del mar hacia la tierra recalentada; y con componente sur o suroeste —el <em>migjorn</em>, el <em>llebeig</em>— el agua somera se pica enseguida en olas cortas y la arena empieza a volar a ras de suelo. No es un mar bravo de Atlántico, pero sí una playa donde la tarde suele estropear la mañana.' },
      { t: 'p', html: 'Dos avisos honestos más. Uno: en la orilla es normal encontrar <strong>arribazones de posidonia</strong>, esas bermas de restos secos de la planta marina. No es suciedad: la <em>Posidonia oceanica</em> es una pradera protegida que amortigua el oleaje y sujeta la arena, y sin ella no habría playa; pero a quien busca la estampa impecable le chirría. Dos: lo de "playa salvaje" tiene matices en agosto. Al no haber urbanización tampoco hay grandes aparcamientos: se llega por <strong>descampados de pago</strong> en Ses Covetes, en el acceso central o desde la Colònia de Sant Jordi, y el del centro <strong>se llena a media mañana</strong>; quien aparezca a mediodía dará vueltas o caminará un buen rato. Los servicios son contados y estacionales —algún quiosco tras las dunas—, así que conviene bajar con agua y comida. La sensación de arenal desierto es de primera hora y de temporada baja; en pleno verano, a la playa protegida le sobra gente.' },
      { t: 'h2', text: 'El criterio del local', id: 'local' },
      { t: 'p', html: 'Cuándo sí: <strong>junio y septiembre</strong>, y en verano a <strong>primera hora</strong>, antes de que aprieten el sol, el embat y los coches. Con el mar plano de la mañana, Es Trenc es una piscina larguísima de agua clara ideal para <strong>niños que aún no nadan</strong>, precisamente por lo somera que es. Cuándo no: un mediodía de agosto sin sombrilla ni agua, o una tarde de sur con el mar picado y la arena volando. El truco del que va a menudo: <strong>madrugar</strong> para pillar sitio en el aparcamiento central y coger la orilla con el agua todavía como un espejo, y llevarlo todo resuelto de casa —sombrilla, agua de sobra, calzado para la pasarela—, porque abajo no hay dónde comprar gran cosa.' },
      { t: 'p', html: 'El viento a vigilar es el del <strong>sur y suroeste</strong>: es el que levanta ola corta sobre el fondo somero y enturbia el agua; con tramontana del norte, en cambio, la costa sur queda a resguardo y el mar se planta. ¿La alternativa si el aparcamiento está imposible o el sur sopla fuerte? A un paso, desde la <strong>Colònia de Sant Jordi</strong> salen los barcos al archipiélago de <strong>Cabrera</strong> —parque nacional, con permiso— y muy cerca quedan playas más recogidas como <strong>Es Carbó</strong> o <strong>Es Caragol</strong>, a las que también se baja a pie. Y si lo que buscas es fondear frente a la arena en vez de pelear por sitio en tierra, este tramo del sur es de los clásicos para <a href="/alquiler-barco/costas/islas-baleares/provincias/baleares/mallorca">llegar en barco</a> y echar el ancla sobre fondo de arena, lejos de las manchas de posidonia.' },
      { t: 'quote', text: 'No es el "Caribe balear" de los reels: es una playa protegida, sin una sombra, con posidonia en la orilla y el aparcamiento lleno antes de comer. Justo por eso, porque nadie la maquilló, sigue en pie.' },
      { t: 'p', html: 'A última hora, cuando el embat afloja y la gente empieza a plegar sombrillas, Es Trenc recupera su tamaño verdadero: dos kilómetros de arena entre el pinar y el mar, con las salinas encendidas de rosa al fondo y algún flamenco cruzando hacia el Salobrar. Ve en junio o en septiembre, madruga, carga sombra y agua, y pisa solo la pasarela para no cargarte la duna. Llega un sábado de agosto a las dos, sin sombrilla y buscando el turquesa de la foto, y entenderás por qué la mejor versión de Es Trenc es la que casi nunca se fotografía: la de las ocho de la mañana, con el mar todavía quieto.' },
    ],
    faq: [
      { q: '¿Por qué Es Trenc no está urbanizada como el resto de Mallorca?', a: 'Porque está protegida. La playa, sus dunas y la marisma y salinas del Salobrar de Campos que tiene detrás forman el Parc Natural Marítimo-Terrestre Es Trenc-Salobrar de Campos, declarado por el Govern balear en 2017. Esa figura de protección es la que ha frenado aquí los hoteles y bloques que cubren casi todo el resto del litoral mallorquín, y por eso conserva dos kilómetros de arena sin edificar detrás.' },
      { q: '¿Es Es Trenc una buena playa para ir con niños?', a: 'Para bañarse es de las mejores de Mallorca con niños pequeños, porque el agua es muy somera y clara y se hace pie a decenas de metros de la orilla. La pega es que en la orilla no hay sombra natural —los pinos quedan tras la duna—, así que hay que bajar con sombrilla y agua, e ir a primera hora: casi cada tarde entra el embat, la brisa marina que pica el mar y levanta la arena.' },
      { q: '¿Dónde se aparca en Es Trenc y se llena mucho?', a: 'Se llega por aparcamientos de pago en Ses Covetes, en el acceso central de Es Trenc y desde la Colònia de Sant Jordi, y desde ahí se camina por pasarelas de madera entre las dunas. El del centro se llena a media mañana en temporada alta, así que conviene madrugar; quien llega a mediodía en agosto suele dar vueltas o acabar caminando un buen rato hasta la arena.' },
    ],
    en: {
      title: 'Es Trenc (Mallorca): 2 km with no building behind and a car park full by mid-morning',
      excerpt: 'One of the last big undeveloped beaches in Mallorca — protected, with shallow, clear water on the south coast. The small print: no shade at the shore, the afternoon embat that ruffles the sea, and a paid car park that fills early.',
      related: [
      ...
      body: [
        { t: 'p', html: 'On the south coast of Mallorca, between the Colònia de Sant Jordi and the hamlet of Ses Covetes, the road pulls away from the sea and hides it behind a belt of dunes and low pines. You leave the car in a patch of bare ground, cross a wooden boardwalk that threads through sand and scrub and, cresting the last dune, come upon it all at once: a two-kilometre line of white sand with water so shallow and clear the turquoise begins almost at the shore. Behind it there are no blocks and no promenade — only the pinewood, and beyond that the white glare of saltpans. On an island built up almost end to end, Es Trenc shows what nearly all of this looked like before the concrete.' },
        { t: 'p', html: 'It is mid-morning in June and the sea is still flat. A family walks thirty metres out without the water rising above the waist; on the central stretch, where nudism has been the custom for decades, a couple of bathers sunbathe without clothes. It smells of pine and salt. At this hour Es Trenc is still the wide, quiet beach of the photograph. Once the sun climbs, the car park fills and the embat starts to blow in off the sea, it will be another thing.' },
        { t: 'h2', text: 'The facts (and what they leave out)', id: 'facts' },
        { t: 'p', html: 'Start with the big, true thing: Es Trenc is one of the <strong>last large beaches in Mallorca with nothing built behind it</strong>. Some two kilometres of fine, pale sand on the south of the island, between the municipalities of <strong>Campos and Ses Salines</strong>, backed by dunes, pinewood and, inland, the marsh and saltpans of the <strong>Salobrar de Campos</strong>. The whole thing is protected: the <strong>Es Trenc-Salobrar de Campos natural park</strong>, declared by the Balearic government in 2017, is what has held off here the hotels that cover almost the rest of the coast. The water is among the shallowest and clearest on the island — you keep your footing tens of metres out — and in high summer the sea temperature runs around <strong>26°C</strong> (Open-Meteo sea-temperature climatology for southern Mallorca). That is true, and it needs no borrowed adjective.' },
        { t: 'p', html: 'Now the small print, starting where it bites hardest at midday: <strong>there is not a scrap of shade at the shore</strong>. The pines sit behind the dune, not on the sand, so anyone who comes down without an umbrella will cook — and driving one in firmly is not always easy in sand this fine. The second warning is the <strong>wind</strong>. Early on the sea tends to be calm, but almost every afternoon the <strong>embat</strong> comes in — the sea breeze that in summer rises off the water towards the overheated land — and with anything from the south or south-west (the <em>migjorn</em>, the <em>llebeig</em>) the shallow water chops up into short waves and the sand begins to stream at ground level. It is not a wild Atlantic sea, but it is a beach where the afternoon tends to spoil the morning.' },
        { t: 'p', html: 'Two more honest warnings. One: at the water line it is normal to find <strong>banks of posidonia</strong>, those berms of dried remains of the sea plant. It is not dirt — <em>Posidonia oceanica</em> is a protected meadow that cushions the swell and holds the sand in place, and without it there would be no beach; but it grates on anyone after the flawless picture. Two: the "wild beach" label has caveats in August. With no development there are also no big car parks: you reach it by <strong>paid patches of ground</strong> at Ses Covetes, at the central access or from the Colònia de Sant Jordi, and the central one <strong>fills by mid-morning</strong>; turn up at noon and you will circle or walk a good way. Services are few and seasonal — the odd kiosk behind the dunes — so bring water and food. The empty-strand feeling belongs to early mornings and the low season; in high summer the protected beach has too many people on it.' },
        { t: 'h2', text: 'The local’s verdict', id: 'verdict' },
        { t: 'p', html: 'When to go: <strong>June and September</strong>, and in summer <strong>first thing</strong>, before the sun, the embat and the cars arrive. With the flat morning sea, Es Trenc is an enormously long pool of clear water, ideal for <strong>children who cannot yet swim</strong>, precisely because it is so shallow. When not: a midday in August with no umbrella and no water, or a southerly afternoon with the sea chopped up and the sand flying. The regular’s trick: <strong>get there early</strong> to grab a space in the central car park and take the shoreline while the water is still a mirror, and bring everything sorted from home — umbrella, plenty of water, footwear for the boardwalk — because there is little to buy down there.' },
        { t: 'p', html: 'The wind to watch is the <strong>southerly and south-westerly</strong>: it is what raises short waves over the shallow bottom and clouds the water; with a northerly tramontana, by contrast, the south coast is sheltered and the sea lies flat. The alternative if the car park is hopeless or the south is blowing hard? A step away, boats leave the <strong>Colònia de Sant Jordi</strong> for the <strong>Cabrera</strong> archipelago — a national park, with a permit — and close by are more tucked-away beaches such as <strong>Es Carbó</strong> or <strong>Es Caragol</strong>, both reached on foot. And if what you want is to anchor off the sand rather than fight for a spot ashore, this southern stretch is a classic to <a href="/en/boat-rental/coasts/islas-baleares/provinces/baleares/mallorca">reach by boat</a> and drop anchor over a sandy bottom, clear of the posidonia patches.' },
        { t: 'quote', text: 'It is not the "Balearic Caribbean" of the reels: it is a protected beach with no shade, posidonia on the shore and the car park full before lunch. And that is exactly why — because no one dressed it up — it is still standing.' },
        { t: 'p', html: 'Late in the day, when the embat eases and people start folding umbrellas, Es Trenc returns to its true size: two kilometres of sand between the pinewood and the sea, the saltpans glowing pink at the back and the odd flamingo crossing towards the Salobrar. Go in June or September, get there early, carry shade and water, and keep to the boardwalk so you do not wreck the dune. Arrive at two on an August Saturday with no umbrella, chasing the turquoise of the photo, and you will understand why the best version of Es Trenc is the one that is almost never photographed: eight in the morning, with the sea still.' },
      ],
      faq: [
        { q: 'Why isn’t Es Trenc built up like the rest of Mallorca?', a: 'Because it is protected. The beach, its dunes and the marsh and saltpans of the Salobrar de Campos behind it make up the Es Trenc-Salobrar de Campos natural park, declared by the Balearic government in 2017. That protection is what has held off the hotels and apartment blocks that cover almost all the rest of the Mallorcan coast, which is why it keeps two kilometres of sand with nothing built behind it.' },
        { q: 'Is Es Trenc a good beach for children?', a: 'For bathing it is one of the best on Mallorca with small children, because the water is very shallow and clear and you keep your footing tens of metres out. The catch is that there is no natural shade at the shore — the pines are behind the dune — so you need to bring an umbrella and water, and go first thing: almost every afternoon the embat sea breeze comes in, ruffling the sea and lifting the sand.' },
        { q: 'Where do you park at Es Trenc, and does it get full?', a: 'You reach it by paid car parks at Ses Covetes, at the central Es Trenc access and from the Colònia de Sant Jordi, and from there you walk on wooden boardwalks through the dunes. The central one fills by mid-morning in high season, so it pays to arrive early; anyone turning up at midday in August tends to circle or end up walking a good way to the sand.' },
      ],
    },
  },
